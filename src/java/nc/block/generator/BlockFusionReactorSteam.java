...
public class BlockFusionReactorSteam extends BlockContainer {
	
	private Random rand = new Random();
	
	private static boolean keepInventory;

	public BlockFusionReactorSteam(Material material) {
		super(material);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileFusionReactorSteam();
	}
	...
	{
	this.blockIcon = iconRegister.registerIcon("nc:generator/fusionReactorSteam/" + "dummy");
	}
	
	public boolean onBlockActivated (World world, int x, int y, int z, EntityPlayer player, int q, float a, float b, float c) {
		if (!player.isSneaking()) {
			player.openGui(NuclearCraft.instance, NuclearCraft.guiIdFusionReactorSteam, world, x, y, z);
			return true;
		} else {
			return false;
		}
	...
	public void onBlockAdded(World world, int x, int y, int z) {
		...
		world.setBlock(x+1, y, z, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x+1, y, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x, y, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y, z, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y, z-1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x, y, z-1, NCBlocks.fusionReactorSteamBlock);
		...
		world.setBlock(x, y+1, z, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x+1, y+1, z, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x+1, y+1, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x, y+1, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y+1, z+1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y+1, z, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x-1, y+1, z-1, NCBlocks.fusionReactorSteamBlock);
		world.setBlock(x, y+1, z-1, NCBlocks.fusionReactorSteamBlock);
		...
		world.setBlock(x, y+2, z, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x+1, y+2, z, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x+1, y+2, z+1, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x, y+2, z+1, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x-1, y+2, z+1, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x-1, y+2, z, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x-1, y+2, z-1, NCBlocks.fusionReactorSteamBlockTop);
		world.setBlock(x, y+2, z-1, NCBlocks.fusionReactorSteamBlockTop);
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack) {
		...
		if (itemstack.hasDisplayName()) {
			((TileFusionReactorSteam)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	{
		return Item.getItemFromBlock(NCBlocks.fusionReactorSteam);
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblockID, int oldMetadata) {
		...
		if(!keepInventory)
		{
			TileFusionReactorSteam tileentity = (TileFusionReactorSteam) world.getTileEntity(x, y, z);
	...
	{
		return NCBlocks.fusionReactorSteam;
	}
}
