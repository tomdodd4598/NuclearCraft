...
public class BlockSteam extends BlockFluidClassic {
	...
	public BlockSteam(Fluid f, Material m, DamageSource damage) {
		super(f, m);
		damageSource = damage;
		setQuantaPerBlock(12);
    ...
    public void registerBlockIcons(IIconRegister register) {
            stillIcon = register.registerIcon("nc:fluid/steamStill");
            flowingIcon = register.registerIcon("nc:fluid/steamFlowing");
    }
