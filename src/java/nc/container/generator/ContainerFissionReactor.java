...
public class ContainerFissionReactor extends Container {
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); ++i) {
            ...
            icrafting.sendProgressBarUpdate(this, 15, this.entity.EReal);
            icrafting.sendProgressBarUpdate(this, 16, this.entity.EReal >> 16);
    ...
    public void updateProgressBar(int slot, int value) {
        ...
        if (slot == 15){ this.lastEReal = this.upcastShort(value); }
        if (slot == 16){ this.entity.EReal = this.lastEReal | value << 16; }
