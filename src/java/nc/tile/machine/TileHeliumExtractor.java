...
public class TileHeliumExtractor extends TileMachineFluidOut {
	...
	public TileHeliumExtractor() {
		super("Helium Extractor", 250000, 16000, 1, 1, false, true, 400, 16000, NuclearCraft.liquidHelium, 1000, NuclearCraft.heliumExtractorSpeed, NuclearCraft.heliumExtractorEfficiency, HeliumExtractorRecipes.instance());
	}
