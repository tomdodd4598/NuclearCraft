...
public class TileNuclearFurnace extends TileEntity implements ISidedInventory {
		...
		if(!this.worldObj.isRemote)
		{
			...
			if(this.burnTime == 0 && this.canSmelt())
			{
				...
				if(this.isBurning() && this.canSmelt())
				{
					...
					if(this.cookTime == TileNuclearFurnace.furnaceSpeed)
					{
						this.cookTime = 0;
						this.smeltItem();
						flag1 = true;
	...
	public static int getItemBurnTime(ItemStack itemstack)
	   {
        ...
        {   
		   ...
		   {
				return (int) Math.ceil((((double) NuclearCraft.nuclearFurnaceCookSpeed*64)/(double) NuclearCraft.nuclearFurnaceCookEfficiency)*furnaceSpeed);
		   }
