...
public final class ModRecipes {
	...
	public static void addIC2Recipes() {
		...
		// Compressor
		try {RecipesHelp.addCompressorRecipe(new ItemStack(NCItems.parts, 1, 0), 4, new ItemStack(NCItems.parts, 1, 3));} catch(Exception e) {}
		try {RecipesHelp.addCompressorRecipe("ingotTough", 1, new ItemStack(NCItems.parts, 3, 0));} catch(Exception e) {}
