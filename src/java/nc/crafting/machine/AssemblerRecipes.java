...
public class AssemblerRecipes extends NCRecipeHelper {
	...
	public void addRecipes() {
		...
		addRecipe(oreStack("plateBasic", NuclearCraft.workspace ? 3 : 1), oreStack("oreObsidian", NuclearCraft.workspace ? 2 : 1), new ItemStack(Items.stick, 0), new ItemStack(Items.stick, 0), new ItemStack(NCBlocks.blastBlock, NuclearCraft.workspace ? 4 : 1));
		...
		addRecipe(oreStack("plateReinforced", 1), oreStack("dustRedstone", 8), new ItemStack(Items.stick, 0), new ItemStack(Items.stick, 0), new ItemStack(NCItems.upgrade, 1));
