...
public class AssemblerRecipes extends NCRecipeHelper {
	...
	public void addRecipes() {
		...
		addRecipe(oreStack("plateReinforced", 4), NuclearCraft.workspace ? oreStack("plateBasic", 12) : oreStack("Pu241", 5), NuclearCraft.workspace ? oreStack("Pu241", 5) : new ItemStack(Items.stick, 0), NuclearCraft.workspace ? new ItemStack(Items.gunpowder, 4) : new ItemStack(Items.stick, 0), new ItemStack(NCBlocks.nuke, 1));
		addRecipe(new ItemStack(NCBlocks.nuke, 1), NuclearCraft.workspace ? oreStack("ingotTough", 4) : new ItemStack(Items.string, 2), NuclearCraft.workspace ? new ItemStack(Items.gunpowder, 4) : new ItemStack(Items.stick, 0), NuclearCraft.workspace ? new ItemStack(Items.string, 2) : new ItemStack(Items.stick, 0), new ItemStack(NCItems.nuclearGrenade, 3));
		...
		addRecipe(oreStack("plateBasic", NuclearCraft.workspace ? 5 : 1), oreStack("universalReactant", NuclearCraft.workspace ? 2 : 1), new ItemStack(Items.stick, 0), new ItemStack(Items.stick, 0), new ItemStack(NCItems.parts, NuclearCraft.workspace ? 2 : 1, 5));
		...
		addRecipe(oreStack("plateBasic", 1), oreStack("ingotTough", NuclearCraft.workspace ? 2 : 4), new ItemStack(Items.stick, 0), new ItemStack(Items.stick, 0), new ItemStack(NCItems.parts, 1, 3));
		...
		addRecipe(new ItemStack(NCBlocks.superElectromagnetIdle, 1), new ItemStack(NCItems.antimatter, 8), NuclearCraft.workspace ? oreStack("plateAdvanced", 16) : new ItemStack(Items.stick, 0), new ItemStack(Items.stick, 0), new ItemStack(NCBlocks.antimatterBomb, 1));
		...
		addRecipe(oreStack("ingotLithiumManganeseDioxide", 4), oreStack("dustLithium", 4), oreStack("ingotHardCarbon", 4), oreStack("plateAdvanced", 4), new ItemStack(NCItems.lithiumIonBattery, 1));
	}
}