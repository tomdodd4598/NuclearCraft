...
public class HeliumExtractorRecipeHandler extends TemplateRecipeHandler {
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("heliumExtracting"))	&& (getClass() == HeliumExtractorRecipeHandler.class)) {
			Map<Object[], Object[]> recipes = HeliumExtractorRecipes.instance().getRecipes();
	...
	public void loadCraftingRecipes(ItemStack result) {
		Map<Object[], Object[]> recipes = HeliumExtractorRecipes.instance().getRecipes();
		for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
			int pos = HeliumExtractorRecipes.instance().containsStack(result, recipe.getValue(), false);
			if (pos!=-1) {
			this.arecipes.add(new SmeltingPair(recipe.getKey()[0], recipe.getValue()[0]));				
			}
		}
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		Map<Object[], Object[]> recipes = HeliumExtractorRecipes.instance().getRecipes();
		for (Map.Entry<Object[], Object[]> recipe : recipes.entrySet()) {
			int pos = HeliumExtractorRecipes.instance().containsStack(ingredient, recipe.getKey(), false);
			if (pos!=-1) {
			this.arecipes.add(new SmeltingPair(recipe.getKey()[0], recipe.getValue()[0]));				
			}
		}
