...
{
    public static final ResourceLocation bground = new ResourceLocation("nc:textures/gui/fusionReactor.png");
    
    public TileFusionReactor entity;

    public GuiFusionReactor(InventoryPlayer inventoryPlayer, TileFusionReactor entity)
    {
