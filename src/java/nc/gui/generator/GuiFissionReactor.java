...
public class GuiFissionReactor extends GuiContainer {
    ...
    public void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(fueltype, 67, 49, (this.entity.complete == 1 ? -1 : 15597568));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		drawTexturedModalRect(guiLeft + 86, guiTop + 54, 3 + (this.entity.complete == 1 ? 0 : 56), 166, k4, 27);
    }
}
