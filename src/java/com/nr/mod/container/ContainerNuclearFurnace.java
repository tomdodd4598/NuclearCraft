...
public class ContainerNuclearFurnace extends Container {
	...
	private TileEntityNuclearFurnace entity;
	...
	public ContainerNuclearFurnace(InventoryPlayer inventory, TileEntityNuclearFurnace tileentity)
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
	{
		...
		if(slot != null && slot.getHasStack())
		{
			...
			else if(clickedSlotNumber != 1 && clickedSlotNumber != 0)
			{
				...
				else if(TileEntityNuclearFurnace.isItemFuel(itemstack1))
				{
