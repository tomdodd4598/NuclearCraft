...
{
    private TileEntityReactionGenerator entity;
    public int lastEnergy;
    public int lastReactant;
    public int lastFuel;

    public ContainerReactionGenerator(InventoryPlayer inventory, TileEntityReactionGenerator entity)
    {
        this.entity = entity;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TileEntityReactionGenerator.isFuel(itemstack1))
                {
                ...
                else if (TileEntityReactionGenerator.isReactant(itemstack1))
                {
