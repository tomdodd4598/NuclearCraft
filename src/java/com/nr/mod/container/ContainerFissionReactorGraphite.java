...
public class ContainerFissionReactorGraphite extends Container {
    private TileEntityFissionReactorGraphite entity;
    ...
    public ContainerFissionReactorGraphite(InventoryPlayer inventory, TileEntityFissionReactorGraphite entity)
    {
        ...
        this.addSlotToContainer(new SlotBlockedInventory(entity, 1, 148, 60));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TileEntityFissionReactorGraphite.isFuel(itemstack1))
                {
                ...
                else if (TileEntityFissionReactorGraphite.isUpgrade(itemstack1))
                {
