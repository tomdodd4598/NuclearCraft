...
public class ContainerElectricFurnace extends Container {
	...
	public TileEntityElectricFurnace entity;
	...
	public ContainerElectricFurnace(InventoryPlayer inventory, TileEntityElectricFurnace tileentity)
	{
...
return input;
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
	{
		...
		if(slot != null && slot.getHasStack())
		{
			...
			{
				if (TileEntityElectricFurnace.isSpeedUpgrade(itemstack1))
                {
                ...
                else if (TileEntityElectricFurnace.isEnergyUpgrade(itemstack1))
                {
