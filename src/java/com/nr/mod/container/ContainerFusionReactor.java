...
public class ContainerFusionReactor extends Container {
    private TileEntityFusionReactor entity;
    ...
    public ContainerFusionReactor(InventoryPlayer inventory, TileEntityFusionReactor entity) {
        this.entity = entity;
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); ++i) {
            ...
            icrafting.sendProgressBarUpdate(this, 31, this.entity.EShown);
    ...
    public void updateProgressBar(int slot, int value) {
        ...
        if (slot == 31){ this.lastEShown = this.upcastShort(value); }
        if (slot == 32){ this.entity.EShown = this.lastEShown | value << 16; }
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (clickedSlotNumber > 8) {
                ...
                } else if (TileEntityFusionReactor.isCapsule(itemstack1)) {
