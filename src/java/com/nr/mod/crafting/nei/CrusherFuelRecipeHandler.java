...
import com.nr.mod.crafting.XCrusherRecipes;
...
public class CrusherFuelRecipeHandler extends CrusherRecipeHandler
{
    ...
    private void loadAllCrushing() {
        Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) XCrusherRecipes.smelting().getSmeltingList();
    ...
    public List<String> handleItemTooltip(GuiRecipe gui, ItemStack stack, List<String> currenttip, int recipe) {
        ...
        float burnTime = (float) (fuel.burnTime / Math.ceil((150/(double) NuclearRelativistics.crusherCrushSpeed)*100));
