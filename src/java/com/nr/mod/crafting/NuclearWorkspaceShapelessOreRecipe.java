...
public class NuclearWorkspaceShapelessOreRecipe implements IRecipe
{
    ...
    public NuclearWorkspaceShapelessOreRecipe(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public NuclearWorkspaceShapelessOreRecipe(Item  result, Object... recipe){ this(new ItemStack(result), recipe); }
