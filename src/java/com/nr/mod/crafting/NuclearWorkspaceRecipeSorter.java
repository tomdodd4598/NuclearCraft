...
import com.nr.mod.crafting.NuclearWorkspaceShapelessRecipes;

import static com.nr.mod.crafting.NuclearWorkspaceRecipeSorter.Category.*;
...
public class NuclearWorkspaceRecipeSorter implements Comparator<IRecipe>
{
    ...
    {
        register("nr:shaped",       NuclearWorkspaceShapedRecipes.class,       SHAPED,    "before:nr:shapeless");
        register("nr:shapeless",    NuclearWorkspaceShapelessRecipes.class,    SHAPELESS, "after:nr:shaped");

        register("nr:shapedore",     NuclearWorkspaceShapedOreRecipe.class,    SHAPED,    "after:nr:shaped before:nr:shapeless");
        register("nr:shapelessore",  NuclearWorkspaceShapelessOreRecipe.class, SHAPELESS, "after:nr:shapeless");
    }
