...
public class CrusherRecipes extends NRRecipeHelper {
	...
	public void addRecipes() {
    	...
    	oreDust("Thorium", 2);
    	addRecipe(oreStack("orePlutonium", 1), new ItemStack(NRItems.material, 2, 33));
    	oreDust("Lithium", 2);
    	oreDust("Boron", 2);
    	oreDust("Aluminium", 2);
    	oreDust("Aluminum", 2);
    	...
    	addRecipe(new ItemStack(Items.skull, 1, 3), new ItemStack(NRItems.dominoes, 1));
    	...
    	addRecipe(new ItemStack(NRBlocks.graphiteBlock), new ItemStack(NRItems.material, 9, 14));
    	
    	//Lithium and Boron Cells
    	addRecipe(new ItemStack(NRItems.fuel, 1, 41), new ItemStack(NRItems.material, 1, 46));
    	addRecipe(new ItemStack(NRItems.fuel, 1, 42), new ItemStack(NRItems.material, 1, 47));
    	addRecipe(new ItemStack(NRItems.fuel, 1, 43), new ItemStack(NRItems.material, 1, 48));
    	addRecipe(new ItemStack(NRItems.fuel, 1, 44), new ItemStack(NRItems.material, 1, 49));
    }
