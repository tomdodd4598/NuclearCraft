...
public class EntityHandler {
	...
	public static void registerMonsters(Class entityClass, String name) {
		...
		if(NuclearRelativistics.enableNuclearMonster) {
		EntityRegistry.addSpawn(entityClass, 15, 1, 1, EnumCreatureType.monster, BiomeGenBase.beach, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.desert, BiomeGenBase.desertHills, BiomeGenBase.extremeHills, BiomeGenBase.forestHills, BiomeGenBase.mesa, BiomeGenBase.mesaPlateau, BiomeGenBase.plains, BiomeGenBase.river, BiomeGenBase.roofedForest, BiomeGenBase.savanna, BiomeGenBase.swampland, BiomeGenBase.taiga); }
	...
	public static void registerPaul(Class entityClass, String name) {
		...
		EntityRegistry.registerGlobalEntityID(entityClass, name, entityId);
		if(NuclearRelativistics.enablePaul) {
		EntityRegistry.addSpawn(entityClass, 2, 1, 1, EnumCreatureType.monster, BiomeGenBase.beach, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.desert, BiomeGenBase.desertHills, BiomeGenBase.extremeHills, BiomeGenBase.forestHills, BiomeGenBase.mesa, BiomeGenBase.mesaPlateau, BiomeGenBase.plains, BiomeGenBase.river, BiomeGenBase.roofedForest, BiomeGenBase.savanna, BiomeGenBase.swampland, BiomeGenBase.taiga, BiomeGenBase.sky); }
		else { EntityRegistry.addSpawn(entityClass, 0, 1, 1, EnumCreatureType.monster, BiomeGenBase.beach, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.desert, BiomeGenBase.desertHills, BiomeGenBase.extremeHills, BiomeGenBase.forestHills, BiomeGenBase.mesa, BiomeGenBase.mesaPlateau, BiomeGenBase.plains, BiomeGenBase.river, BiomeGenBase.roofedForest, BiomeGenBase.savanna, BiomeGenBase.swampland, BiomeGenBase.taiga, BiomeGenBase.sky); }
		EntityRegistry.registerModEntity(entityClass, name, entityId, NuclearRelativistics.instance, 64, 1, true);
		EntityList.entityEggs.put(Integer.valueOf(entityId), new EntityList.EntityEggInfo(entityId, mainColor, subColor));
	}
