...
public class BlockCrusher extends BlockContainer {
	...
	this.iconFront = iconRegister.registerIcon("nr:machines/" + "crusher" + "Front" + (this.isActive ? "Active" : "Idle"));
	}

	public Item getItemDropped(int par1, Random random, int par3)
	{
		return Item.getItemFromBlock(NRBlocks.crusherIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		 ...
		 {
			 FMLNetworkHandler.openGui(player, NuclearRelativistics.instance, NuclearRelativistics.guiIdCrusher, world, x, y, z);
		 }
		 return true;
	 }
	...
	public static void updateCrusherBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord)
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, NRBlocks.crusherActive);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, NRBlocks.crusherIdle);
		}
