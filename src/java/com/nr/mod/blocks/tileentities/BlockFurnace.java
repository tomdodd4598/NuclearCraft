...
public class BlockFurnace extends BlockContainer {
	...
	{
	this.blockIcon = iconRegister.registerIcon("nr:machines/" + "machine" + "Side");
	this.iconFront = iconRegister.registerIcon("nr:machines/" + "furnace" + "Front" + (this.isActive ? "Active" : "Idle"));
	}

	public Item getItemDropped(int par1, Random random, int par3)
	{
		return Item.getItemFromBlock(NRBlocks.furnaceIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		 ...
		 {
			 FMLNetworkHandler.openGui(player, NuclearRelativistics.instance, NuclearRelativistics.guiIdFurnace, world, x, y, z);
		 }
		 return true;
	 }
	...
	public static void updateFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord)
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, NRBlocks.furnaceActive);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, NRBlocks.furnaceIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldBlockID, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityFurnace tileentity = (TileEntityFurnace) world.getTileEntity(x, y, z);
