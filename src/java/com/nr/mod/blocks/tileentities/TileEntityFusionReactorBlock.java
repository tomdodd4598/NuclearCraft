...
public class TileEntityFusionReactorBlock extends TileEntity implements IEnergyHandler, IEnergyConnection, IEnergyReceiver, ISidedInventory {
	...
	{
		if (worldObj.getBlock(x, y-1, z) == NRBlocks.fusionReactor) {xOffset=0;yOffset=-1;zOffset=0;}
		else if (worldObj.getBlock(x+1, y, z) == NRBlocks.fusionReactor) {xOffset=1;yOffset=0;zOffset=0;}
		else if (worldObj.getBlock(x+1, y, z+1) == NRBlocks.fusionReactor) {xOffset=1;yOffset=0;zOffset=1;}
		else if (worldObj.getBlock(x, y, z+1) == NRBlocks.fusionReactor) {xOffset=0;yOffset=0;zOffset=1;}
		else if (worldObj.getBlock(x-1, y, z+1) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=0;zOffset=1;}
		else if (worldObj.getBlock(x-1, y, z) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=0;zOffset=0;}
		else if (worldObj.getBlock(x-1, y, z-1) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=0;zOffset=-1;}
		else if (worldObj.getBlock(x, y, z-1) == NRBlocks.fusionReactor) {xOffset=0;yOffset=0;zOffset=-1;}
		...
		else if (worldObj.getBlock(x+1, y-1, z) == NRBlocks.fusionReactor) {xOffset=1;yOffset=-1;zOffset=0;}
		else if (worldObj.getBlock(x+1, y-1, z+1) == NRBlocks.fusionReactor) {xOffset=1;yOffset=-1;zOffset=1;}
		else if (worldObj.getBlock(x, y-1, z+1) == NRBlocks.fusionReactor) {xOffset=0;yOffset=-1;zOffset=1;}
		else if (worldObj.getBlock(x-1, y-1, z+1) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=-1;zOffset=1;}
		else if (worldObj.getBlock(x-1, y-1, z) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=-1;zOffset=0;}
		else if (worldObj.getBlock(x-1, y-1, z-1) == NRBlocks.fusionReactor) {xOffset=-1;yOffset=-1;zOffset=-1;}
		else if (worldObj.getBlock(x, y-1, z-1) == NRBlocks.fusionReactor) {xOffset=0;yOffset=-1;zOffset=-1;}
	...
	public void getBelow() {
		...
		if (block == NRBlocks.fusionReactor) {
