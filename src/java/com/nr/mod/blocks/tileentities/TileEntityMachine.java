...
public abstract class TileEntityMachine extends TileEntity implements IEnergyHandler, ISidedInventory {
	...
	public TileEntityMachine(String localName, int energyMax, int inSize, int outSize, boolean usesUpgrades, boolean usesEnergy, double som, double tom, int smod, NRRecipeHelper nrrecipes) {
	...
	public static boolean isSpeedUpgrade(ItemStack stack) {
		return stack.getItem() == NRItems.upgradeSpeed;
	}
	...
	public static boolean isEnergyUpgrade(ItemStack stack) {
		return stack.getItem() == NRItems.upgradeEnergy;
	}
	...
	public String getInventoryName() {
        return this.isInventoryNameLocalized() ? this.localizedName : "NR TileEntity";
    }
