...
import com.nr.mod.model.ModelNuclearWorkspace;

public class RenderNuclearWorkspace extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation("nr:textures/model/NuclearWorkspace.png");
