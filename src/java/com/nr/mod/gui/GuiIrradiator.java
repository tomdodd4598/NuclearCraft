...
public class GuiIrradiator extends GuiContainer {
	public static final ResourceLocation bground = new ResourceLocation("nr:textures/gui/irradiator.png");
	public TileEntityIrradiator irradiator;
   
	public GuiIrradiator(InventoryPlayer inventoryPlayer, TileEntityIrradiator entity) {
