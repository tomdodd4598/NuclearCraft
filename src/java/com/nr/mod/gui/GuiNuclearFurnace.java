...
public class GuiNuclearFurnace extends GuiContainer {
	...
	public static final ResourceLocation texture = new ResourceLocation("nr:textures/gui/nuclearFurnace.png");
	
	public TileEntityNuclearFurnace nuclearFurnace;

	public GuiNuclearFurnace(InventoryPlayer inventoryPlayer, TileEntityNuclearFurnace entity) {
