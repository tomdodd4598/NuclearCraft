...
public class GuiSeparator extends GuiContainer {
	public static final ResourceLocation bground = new ResourceLocation("nr:textures/gui/separator.png");
	public TileEntitySeparator separator;
   
	public GuiSeparator(InventoryPlayer inventoryPlayer, TileEntitySeparator entity) {
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		int e = separator.energy * 82 / 25000;
