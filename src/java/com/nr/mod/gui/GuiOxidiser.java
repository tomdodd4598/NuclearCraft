...
public class GuiOxidiser extends GuiContainer {
	public static final ResourceLocation bground = new ResourceLocation("nr:textures/gui/oxidiser.png");
	public TileEntityOxidiser oxidiser;
   
	public GuiOxidiser(InventoryPlayer inventoryPlayer, TileEntityOxidiser entity) {
