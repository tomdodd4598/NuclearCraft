...
public class GuiCooler extends GuiContainer {
	...
	public static final ResourceLocation texture = new ResourceLocation("nr:textures/gui/cooler.png");
	
	public TileEntityCooler cooler;

	public GuiCooler(InventoryPlayer inventoryPlayer, TileEntityCooler entity) {
