...
public class GuiHastener extends GuiContainer {
	...
	public static final ResourceLocation texture = new ResourceLocation("nr:textures/gui/hastener.png");
	
	public TileEntityHastener hastener;

	public GuiHastener(InventoryPlayer inventoryPlayer, TileEntityHastener entity) {
