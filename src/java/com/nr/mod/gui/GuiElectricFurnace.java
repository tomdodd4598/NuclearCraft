...
public class GuiElectricFurnace extends GuiContainer {
	...
	public static final ResourceLocation texture = new ResourceLocation("nr:textures/gui/electricFurnace.png");
	
	public TileEntityElectricFurnace electricFurnace;

	public GuiElectricFurnace(InventoryPlayer inventoryPlayer, TileEntityElectricFurnace entity) {
