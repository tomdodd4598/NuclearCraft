...
public class NCCriterions {
	...
	public static final NCCriterionTrigger DECAY_POOL_ASSEMBLED = new NCCriterionTrigger("decay_pool_assembled");
	...
	public static final List<NCCriterionTrigger> CRITERION_TRIGGERS = Arrays.asList(ELECTROLYZER_ASSEMBLED, DISTILLER_ASSEMBLED, INFILTRATOR_ASSEMBLED, DECAY_POOL_ASSEMBLED, PEBBLE_FISSION_ASSEMBLED, SOLID_FISSION_ASSEMBLED, SALT_FISSION_ASSEMBLED, HEAT_EXCHANGER_ASSEMBLED, CONDENSER_ASSEMBLED, TURBINE_ASSEMBLED);
}
