...
public class GuiSaltFissionController extends GuiLogicMultiblockController<FissionReactor, MoltenSaltFissionLogic> {
	...
	public void renderTooltips(int mouseX, int mouseY) {
		if (NCUtil.isModifierKeyDown()) drawTooltip(clearAllInfo(), mouseX, mouseY, 153, 71, 18, 18);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		if (!NCUtil.isModifierKeyDown()) {
			String netClusterHeating = Lang.localise("gui.nc.container.fission_controller.net_cluster_heating") + " " + UnitHelper.prefix(logic.getNetClusterHeating(), 6, "H");
