...
public class ContainerFissionIrradiatorPort extends ContainerTile<TileFissionIrradiatorPort> {
	
	protected final TileFissionIrradiatorPort port;
	
	public ContainerFissionIrradiatorPort(EntityPlayer player, TileFissionIrradiatorPort port) {
		super(port);
		this.port = port;
