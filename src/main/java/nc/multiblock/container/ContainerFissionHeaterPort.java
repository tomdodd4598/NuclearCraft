...
public class ContainerFissionHeaterPort extends ContainerTile<TileFissionHeaterPort> {
	
	protected final TileFissionHeaterPort port;
	
	public ContainerFissionHeaterPort(EntityPlayer player, TileFissionHeaterPort port) {
		super(port);
		this.port = port;
