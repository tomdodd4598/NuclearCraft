 ...
 */
public abstract class TileMultiblockPart<T extends Multiblock> extends TileBeefBase implements ITileMultiblockPart<T> {
	...
	public ITileMultiblockPart<T>[] getNeighboringParts() {
		...
		TileEntity te;
		List<ITileMultiblockPart<T>> neighborParts = new ArrayList<ITileMultiblockPart<T>>();
