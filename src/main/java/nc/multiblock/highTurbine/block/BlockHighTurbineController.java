...
public class BlockHighTurbineController extends BlockHighTurbinePartBase {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!world.isRemote) {
			if (world.getTileEntity(pos) instanceof TileHighTurbineController) {
				TileHighTurbineController controller = (TileHighTurbineController) world.getTileEntity(pos);
