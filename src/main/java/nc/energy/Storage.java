...
public class Storage implements cofh.api.energy.IEnergyStorage, IEnergyStorage, ITeslaConsumer, ITeslaProducer, ITeslaHolder, INBTSerializable<NBTTagCompound> {
