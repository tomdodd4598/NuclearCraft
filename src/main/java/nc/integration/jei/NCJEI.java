...
public class NCJEI implements IModPlugin {
	...
	/* private static <T extends Enum<T>> void blacklistAll(IJeiHelpers jeiHelpers, Class<T> enumm, Block block) { if (block == null) return; for (int i = 0; i < enumm.getEnumConstants().length; i++) blacklist(jeiHelpers, new ItemStack(block, 1, i)); } */
	...
	public enum JEIHandler implements IJEIHandler {
		MANUFACTORY(manufactory, NCBlocks.manufactory, "manufactory", JEIRecipeWrapper.Manufactory.class, 1),
		SEPARATOR(separator, NCBlocks.separator, "separator", JEIRecipeWrapper.Separator.class, 2),
		DECAY_HASTENER(decay_hastener, NCBlocks.decay_hastener, "decay_hastener", JEIRecipeWrapper.DecayHastener.class, 3),
		FUEL_REPROCESSOR(fuel_reprocessor, NCBlocks.fuel_reprocessor, "fuel_reprocessor", JEIRecipeWrapper.FuelReprocessor.class, 4),
		ALLOY_FURNACE(alloy_furnace, NCBlocks.alloy_furnace, "alloy_furnace", JEIRecipeWrapper.AlloyFurnace.class, 5),
		INFUSER(infuser, NCBlocks.infuser, "infuser", JEIRecipeWrapper.Infuser.class, 6),
		MELTER(melter, NCBlocks.melter, "melter", JEIRecipeWrapper.Melter.class, 7),
		SUPERCOOLER(supercooler, NCBlocks.supercooler, "supercooler", JEIRecipeWrapper.Supercooler.class, 8),
		ELECTROLYZER(electrolyzer, NCBlocks.electrolyzer, "electrolyzer", JEIRecipeWrapper.Electrolyzer.class, 9),
		ASSEMBLER(assembler, NCBlocks.assembler, "assembler", JEIRecipeWrapper.Assembler.class, 10),
		INGOT_FORMER(ingot_former, NCBlocks.ingot_former, "ingot_former", JEIRecipeWrapper.IngotFormer.class, 11),
		PRESSURIZER(pressurizer, NCBlocks.pressurizer, "pressurizer", JEIRecipeWrapper.Pressurizer.class, 12),
		CHEMICAL_REACTOR(chemical_reactor, NCBlocks.chemical_reactor, "chemical_reactor", JEIRecipeWrapper.ChemicalReactor.class, 13),
		SALT_MIXER(salt_mixer, NCBlocks.salt_mixer, "salt_mixer", JEIRecipeWrapper.SaltMixer.class, 14),
		CRYSTALLIZER(crystallizer, NCBlocks.crystallizer, "crystallizer", JEIRecipeWrapper.Crystallizer.class, 15),
		ENRICHER(enricher, NCBlocks.enricher, "enricher", JEIRecipeWrapper.Enricher.class, 16),
		EXTRACTOR(extractor, NCBlocks.extractor, "extractor", JEIRecipeWrapper.Extractor.class, 17),
		CENTRIFUGE(centrifuge, NCBlocks.centrifuge, "centrifuge", JEIRecipeWrapper.Centrifuge.class, 18),
		ROCK_CRUSHER(rock_crusher, NCBlocks.rock_crusher, "rock_crusher", JEIRecipeWrapper.RockCrusher.class, 19),
		COLLECTOR(collector, registeredCollectors(), "collector", JEIRecipeWrapper.Collector.class),
		DECAY_GENERATOR(decay_generator, NCBlocks.decay_generator, "decay_generator", JEIRecipeWrapper.DecayGenerator.class),
		FISSION_MODERATOR(fission_moderator, NCBlocks.heavy_water_moderator, "fission_moderator", JEIRecipeWrapper.FissionModerator.class),
		FISSION_REFLECTOR(fission_reflector, NCBlocks.fission_reflector, "fission_reflector", JEIRecipeWrapper.FissionReflector.class),
		FISSION_IRRADIATOR(fission_irradiator, NCBlocks.fission_irradiator, "fission_irradiator", JEIRecipeWrapper.FissionIrradiator.class),
		PEBBLE_FISSION(pebble_fission, Lists.newArrayList(), "pebble_fission", JEIRecipeWrapper.PebbleFission.class),
		...
		RADIATION_SCRUBBER(radiation_scrubber, NCBlocks.radiation_scrubber, "radiation_scrubber", JEIRecipeWrapper.RadiationScrubber.class);
