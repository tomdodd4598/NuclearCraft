...
public class AlloyFurnaceCategory extends JEIMachineCategory<JEIRecipeWrapperImpl.AlloyFurnace> {
	
	public AlloyFurnaceCategory(IGuiHelper guiHelper, IJEIHandler<JEIRecipeWrapperImpl.AlloyFurnace> handler) {
		super(guiHelper, handler, "alloy_furnace", 45, 30, 102, 26);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperImpl.AlloyFurnace recipeWrapper, IIngredients ingredients) {
