...
public class SteamCrusherCategory extends JEIMachineCategory<JEIRecipeWrapper.SteamCrusher> {

	public SteamCrusherCategory(IGuiHelper guiHelper, IJEIHandler handler) {
		super(guiHelper, handler, "steam_crusher", 45, 30, 102, 26);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapper.SteamCrusher recipeWrapper, IIngredients ingredients) {
