...
public class SteamTransformerCategory extends JEIMachineCategory<JEIRecipeWrapper.SteamTransformer> {

	public SteamTransformerCategory(IGuiHelper guiHelper, IJEIHandler handler) {
		super(guiHelper, handler, "steam_transformer", 45, 30, 102, 26);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapper.SteamTransformer recipeWrapper, IIngredients ingredients) {
