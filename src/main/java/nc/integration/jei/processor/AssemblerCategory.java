...
public class AssemblerCategory extends JEIMachineCategory<JEIRecipeWrapperImpl.Assembler> {
	
	public AssemblerCategory(IGuiHelper guiHelper, IJEIHandler<JEIRecipeWrapperImpl.Assembler> handler) {
		super(guiHelper, handler, "assembler", 45, 30, 102, 38);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperImpl.Assembler recipeWrapper, IIngredients ingredients) {
