...
public class DecayHastenerCategory extends BaseCategory {
	
	public DecayHastenerCategory(IGuiHelper guiHelper, IJEIHandler handler) {
		super(guiHelper, handler, "decay_hastener_idle", NCConfig.processor_time[2], 47, 30, 90, 26, 176, 3, 37, 16, 74, 35);
	}
