...
public class IsotopeSeparatorCategory extends JEICategoryAbstract<JEIRecipeWrapper.IsotopeSeparator> {
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapper.IsotopeSeparator recipeWrapper, IIngredients ingredients) {
