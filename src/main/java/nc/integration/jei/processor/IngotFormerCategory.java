...
public class IngotFormerCategory extends BaseCategory {
	
	public IngotFormerCategory(IGuiHelper guiHelper, IJEIHandler handler) {
		super(guiHelper, handler, "ingot_former_idle", NCConfig.processor_time[10], 47, 30, 90, 26, 176, 3, 37, 16, 74, 35);
	}
