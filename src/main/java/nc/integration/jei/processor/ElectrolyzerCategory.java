...
public class ElectrolyzerCategory extends JEIMachineCategory<JEIRecipeWrapperImpl.Electrolyzer> {
	
	public ElectrolyzerCategory(IGuiHelper guiHelper, IJEIHandler<JEIRecipeWrapperImpl.Electrolyzer> handler) {
		super(guiHelper, handler, "electrolyzer", 49, 30, 94, 38);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperImpl.Electrolyzer recipeWrapper, IIngredients ingredients) {
