...
public class RockCrusherCategory extends JEIMachineCategory<JEIRecipeWrapperImpl.RockCrusher> {
	
	public RockCrusherCategory(IGuiHelper guiHelper, IJEIHandler<JEIRecipeWrapperImpl.RockCrusher> handler) {
		super(guiHelper, handler, "rock_crusher", 29, 30, 122, 26);
	}
	
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperImpl.RockCrusher recipeWrapper, IIngredients ingredients) {
