...
public class IrradiatorCategory extends JEICategoryAbstract<JEIRecipeWrapper.Irradiator> {
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapper.Irradiator recipeWrapper, IIngredients ingredients) {
