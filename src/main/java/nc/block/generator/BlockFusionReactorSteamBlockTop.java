			...
			public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
				if (!player.isSneaking()) {
					if ((player != null) && (!world.isRemote)) {
						if (world.getBlock(x, y-2, z) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y-2, z);
						else if (world.getBlock(x+1, y-2, z) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x+1, y-2, z);
						else if (world.getBlock(x+1, y-2, z+1) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x+1, y-2, z+1);
						else if (world.getBlock(x, y-2, z+1) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y-2, z+1);
						else if (world.getBlock(x-1, y-2, z+1) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x-1, y-2, z+1);
						else if (world.getBlock(x-1, y-2, z) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x-1, y-2, z);
						else if (world.getBlock(x-1, y-2, z-1) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x-1, y-2, z-1);
						else if (world.getBlock(x, y-2, z-1) == NCBlocks.fusionReactorSteam) FMLNetworkHandler.openGui(player, NuclearCraft.instance, 22, world, x, y-2, z-1);
