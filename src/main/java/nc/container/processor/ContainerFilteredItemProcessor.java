...
public abstract class ContainerFilteredItemProcessor<PROCESSOR extends IItemProcessor & ITileFilteredInventory & ITileGui<?>> extends ContainerTile<PROCESSOR> {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int index) {
		...
		final boolean hasUpgrades = tile instanceof IUpgradableProcessor && ((IUpgradableProcessor) tile).hasUpgrades();
		int upgrades = hasUpgrades ? ((IUpgradableProcessor) tile).getNumberOfUpgrades() : 0;
