...
public class ContainerSteamFurnace extends ContainerItemFluidProcessor {

	public ContainerSteamFurnace(EntityPlayer player, TileItemFluidProcessor tileEntity) {
		super(player, tileEntity, NCRecipes.steam_furnace);
