...
public class FusionRecipeHandler extends TemplateRecipeHandler {
	public class SmeltingPair extends TemplateRecipeHandler.CachedRecipe {
		...
		public List<PositionedStack> getIngredients() {
			return getCycledIngredients(
					FusionRecipeHandler.this.cycleticks / 24,
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if ((outputId.equals("fusing"))	&& (getClass() == FusionRecipeHandler.class)) {
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if ((inputId.equals("fusing"))&& (getClass() == FusionRecipeHandler.class)) {
