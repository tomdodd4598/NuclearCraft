...
public class FusionRecipes extends ProcessorRecipeHandler {
	...
	public void addRecipes() {
		...
		fusion("hydrogen", 1000, "lithium6", 72, "tritium", 500, "tritium", 500, "helium", 500, "helium", 500, 4);
		fusion("hydrogen", 1000, "lithium7", 72, "helium", 500, "helium", 500, "helium", 500, "helium", 500, 5);
		fusion("hydrogen", 1000, "boron11", 72, "helium", 750, "helium", 750, "helium", 750, "helium", 750, 6);
		...
		fusion("deuterium", 1000, "lithium6", 72, "helium", 500, "helium", 500, "helium", 500, "helium", 500, 10);
		fusion("deuterium", 1000, "lithium7", 72, "helium", 1000, "helium", 1000, "neutron", 50, "neutron", 50, 11);
		fusion("deuterium", 1000, "boron11", 72, "helium", 1500, "helium", 1500, "neutron", 50, "neutron", 50, 12);
		...
		fusion("tritium", 1000, "lithium6", 72, "helium", 1000, "helium", 1000, "neutron", 50, "neutron", 50, 15);
		fusion("tritium", 1000, "lithium7", 72, "helium", 1000, "helium", 1000, "neutron", 100, "neutron", 100, 16);
		fusion("tritium", 1000, "boron11", 72, "helium", 1500, "helium", 1500, "neutron", 100, "neutron", 100, 17);
		
		fusion("helium3", 1000, "helium3", 1000, "hydrogen", 1000, "hydrogen", 1000, "helium", 500, "helium", 500, 18);
		fusion("helium3", 1000, "lithium6", 72, "hydrogen", 500, "hydrogen", 500, "helium", 1000, "helium", 1000, 19);
		fusion("helium3", 1000, "lithium7", 72, "deuterium", 500, "deuterium", 500, "helium", 1000, "helium", 1000, 20);
		fusion("helium3", 1000, "boron11", 72, "deuterium", 500, "deuterium", 500, "helium", 1500, "helium", 1500, 21);
		
		fusion("lithium6", 72, "lithium6", 72, "helium", 750, "helium", 750, "helium", 750, "helium", 750, 22);
		fusion("lithium6", 72, "lithium7", 72, "helium", 1500, "helium", 1500, "neutron", 50, "neutron", 50, 23);
		fusion("lithium6", 72, "boron11", 72, "helium", 2000, "helium", 2000, "neutron", 50, "neutron", 50, 24);
		
		fusion("lithium7", 72, "lithium7", 72, "helium", 1500, "helium", 1500, "neutron", 100, "neutron", 100, 25);
		fusion("lithium7", 72, "boron11", 72, "helium", 2000, "helium", 2000, "neutron", 100, "neutron", 100, 26);
		
		fusion("boron11", 72, "boron11", 72, "helium", 2500, "helium", 2500, "neutron", 100, "neutron", 100, 27);
	}
