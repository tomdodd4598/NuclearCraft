...
public class MetaEnums {
	...
	public static enum ThoriumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		TBU("tbu", 0),
		TBU_OXIDE("tbu_oxide", 1);
		...
		private ThoriumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_thorium_fuel_time[id];
			power = NCConfig.fission_thorium_power[id];
	...
	public static enum UraniumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEU_233("leu_233", 0),
		LEU_233_OXIDE("leu_233_oxide", 1),
		HEU_233("heu_233", 2),
		HEU_233_OXIDE("heu_233_oxide", 3),
		...
		private UraniumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_uranium_fuel_time[id];
			power = NCConfig.fission_uranium_power[id];
	...
	public static enum NeptuniumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEN_236("len_236", 0),
		LEN_236_OXIDE("len_236_oxide", 1),
		HEN_236("hen_236", 2),
		HEN_236_OXIDE("hen_236_oxide", 3);
		...
		private NeptuniumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_neptunium_fuel_time[id];
			power = NCConfig.fission_neptunium_power[id];
	...
	public static enum PlutoniumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEP_239("lep_239", 0),
		LEP_239_OXIDE("lep_239_oxide", 1),
		HEP_239("hep_239", 2),
		HEP_239_OXIDE("hep_239_oxide", 3),
		...
		private PlutoniumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_plutonium_fuel_time[id];
			power = NCConfig.fission_plutonium_power[id];
	...
	public static enum MixedOxideFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		MOX_239("mox_239", 0),
		MOX_241("mox_241", 1);
		...
		private MixedOxideFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_mox_fuel_time[id];
			power = NCConfig.fission_mox_power[id];
	...
	public static enum AmericiumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEA_242("lea_242", 0),
		LEA_242_OXIDE("lea_242_oxide", 1),
		HEA_242("hea_242", 2),
		HEA_242_OXIDE("hea_242_oxide", 3);
		...
		private AmericiumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_americium_fuel_time[id];
			power = NCConfig.fission_americium_power[id];
	...
	public static enum CuriumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEC_243("lec_243", 0),
		LEC_243_OXIDE("lec_243_oxide", 1),
		HEC_243("hec_243", 2),
		HEC_243_OXIDE("hec_243_oxide", 3),
		...
		private CuriumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_curium_fuel_time[id];
			power = NCConfig.fission_curium_power[id];
	...
	public static enum BerkeliumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEB_248("leb_248", 0),
		LEB_248_OXIDE("leb_248_oxide", 1),
		HEB_248("heb_248", 2),
		HEB_248_OXIDE("heb_248_oxide", 3);
		...
		private BerkeliumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_berkelium_fuel_time[id];
			power = NCConfig.fission_berkelium_power[id];
	...
	public static enum CaliforniumFuelRodType implements IStringSerializable, IItemMeta, IFissionStats {
		LEC_249("lec_249", 0),
		LEC_249_OXIDE("lec_249_oxide", 1),
		HEC_249("hec_249", 2),
		HEC_249_OXIDE("hec_249_oxide", 3),
		...
		private CaliforniumFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
			fuelTime = NCConfig.fission_californium_fuel_time[id];
			power = NCConfig.fission_californium_power[id];
	...
	public static enum ThoriumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		TBU("tbu", 0),
		TBU_OXIDE("tbu_oxide", 1);
		...
		private ThoriumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum UraniumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEU_233("leu_233", 0),
		LEU_233_OXIDE("leu_233_oxide", 1),
		HEU_233("heu_233", 2),
		HEU_233_OXIDE("heu_233_oxide", 3),
		...
		private UraniumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum NeptuniumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEN_236("len_236", 0),
		LEN_236_OXIDE("len_236_oxide", 1),
		HEN_236("hen_236", 2),
		HEN_236_OXIDE("hen_236_oxide", 3);
		...
		private NeptuniumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum PlutoniumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEP_239("lep_239", 0),
		LEP_239_OXIDE("lep_239_oxide", 1),
		HEP_239("hep_239", 2),
		HEP_239_OXIDE("hep_239_oxide", 3),
		...
		private PlutoniumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum MixedOxideDepletedFuelRodType implements IStringSerializable, IItemMeta {
		MOX_239("mox_239", 0),
		MOX_241("mox_241", 1);
		...
		private MixedOxideDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum AmericiumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEA_242("lea_242", 0),
		LEA_242_OXIDE("lea_242_oxide", 1),
		HEA_242("hea_242", 2),
		HEA_242_OXIDE("hea_242_oxide", 3);
		...
		private AmericiumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum CuriumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEC_243("lec_243", 0),
		LEC_243_OXIDE("lec_243_oxide", 1),
		HEC_243("hec_243", 2),
		HEC_243_OXIDE("hec_243_oxide", 3),
		...
		private CuriumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum BerkeliumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEB_248("leb_248", 0),
		LEB_248_OXIDE("leb_248_oxide", 1),
		HEB_248("heb_248", 2),
		HEB_248_OXIDE("heb_248_oxide", 3);
		...
		private BerkeliumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
	...
	public static enum CaliforniumDepletedFuelRodType implements IStringSerializable, IItemMeta {
		LEC_249("lec_249", 0),
		LEC_249_OXIDE("lec_249_oxide", 1),
		HEC_249("hec_249", 2),
		HEC_249_OXIDE("hec_249_oxide", 3),
		...
		private CaliforniumDepletedFuelRodType(String name, int id) {
			this.name = name;
			this.id = id;
		}
