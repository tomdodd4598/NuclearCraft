...
public class TileInfoHandler {
	...
	public static void preInit() {
		...
		registerContainerInfo(new TileContainerInfo<>(Global.MOD_ID, "decay_pool_controller", TileDecayPoolController.class, ContainerDecayPoolController::new, clientGetGuiInfoTileFunction(() -> GuiDecayPoolController::new)));
		registerContainerInfo(new TileContainerInfo<>(Global.MOD_ID, "pebble_fission_controller", TilePebbleFissionController.class, ContainerPebbleFissionController::new, clientGetGuiInfoTileFunction(() -> GuiPebbleFissionController::new)));
		...
		registerContainerInfo(new BasicProcessorContainerInfoBuilder<>(Global.MOD_ID, "fission_irradiator", TileFissionIrradiator.class, TileFissionIrradiator::new, ContainerFissionIrradiator.class, ContainerFissionIrradiator::new, proxy.clientGet(() -> GuiFissionIrradiator.class), proxy.clientGet(() -> GuiFissionIrradiator::new)).setItemInputSlots(standardSlot(56, 35)).setItemOutputSlots(bigSlot(112, 31)).setStandardJeiAlternateTitle().setStandardJeiAlternateTexture().buildContainerInfo());
		registerContainerInfo(new BasicProcessorContainerInfoBuilder<>(Global.MOD_ID, "pebble_fission_chamber", TilePebbleFissionChamber.class, TilePebbleFissionChamber::new, ContainerPebbleFissionChamber.class, ContainerPebbleFissionChamber::new, proxy.clientGet(() -> GuiPebbleFissionChamber.class), proxy.clientGet(() -> GuiPebbleFissionChamber::new)).setRecipeHandlerName("pebble_fission").setConsumesInputs(true).setItemInputSlots(standardSlot(56, 35)).setItemOutputSlots(bigSlot(112, 31)).setStandardJeiAlternateTitle().buildContainerInfo());
		registerContainerInfo(new BasicProcessorContainerInfoBuilder<>(Global.MOD_ID, "pebble_fission_cooler", TilePebbleFissionCooler.class, TilePebbleFissionCooler::new, ContainerPebbleFissionCooler.class, ContainerPebbleFissionCooler::new, proxy.clientGet(() -> GuiPebbleFissionCooler.class), proxy.clientGet(() -> GuiPebbleFissionCooler::new)).setRecipeHandlerName("gas_cooler").setFluidInputSlots(standardSlot(56, 35)).setFluidOutputSlots(bigSlot(112, 31)).setStandardJeiAlternateTitle().buildContainerInfo());
		...
		registerContainerInfo(new TileContainerInfo<>(Global.MOD_ID, "fission_chamber_port", TileFissionChamberPort.class, ContainerFissionChamberPort::new, clientGetGuiInfoTileFunction(() -> GuiFissionChamberPort::new)));
		registerContainerInfo(new TileContainerInfo<>(Global.MOD_ID, "fission_cooler_port", TileFissionCoolerPort.class, ContainerFissionCoolerPort::new, clientGetGuiInfoTileFunction(() -> GuiFissionCoolerPort::new)));
	...
	public static void init() {
		if (ModCheck.jeiLoaded()) {
			...
			registerJEICategoryInfo(new JEISimpleCategoryInfoBuilder<>(Global.MOD_ID, "multiblock_decay_pool", MultiblockDecayPoolRecipeWrapper.class, MultiblockDecayPoolRecipeWrapper::new, Lists.newArrayList(NCBlocks.decay_pool_controller), Lists.newArrayList()).setFluidInputSlots(standardSlot(56, 35)).setFluidOutputSlots(bigSlot(112, 31)).setStandardJeiAlternateTitle().setStandardJeiAlternateTexture());
			registerJEICategoryInfo(new JEISimpleCategoryInfoBuilder<>(Global.MOD_ID, "decay_pool_heat_source", DecayPoolHeatSourceRecipeWrapper.class, DecayPoolHeatSourceRecipeWrapper::new, Lists.newArrayList(NCBlocks.decay_pool_container), Lists.newArrayList()).setItemInputSlots(standardSlot(32, 35)).setFluidInputSlots(standardSlot(52, 35)).setItemOutputSlots(bigSlot(108, 31)).setFluidOutputSlots(bigSlot(136, 31)).setProgressBarGuiXYWHUV(70, 35, 37, 16, 176, 3).setStandardJeiAlternateTitle());
			...
			registerJEICategoryInfo(new JEIProcessorCategoryInfo<>("pebble_fission_chamber", PebbleFissionRecipeWrapper.class, PebbleFissionRecipeWrapper::new, Lists.newArrayList(NCBlocks.pebble_fission_controller, NCBlocks.pebble_fission_chamber)));
			...
			registerJEICategoryInfo(new JEISimpleCategoryInfoBuilder<>(Global.MOD_ID, "gas_cooler", GasCoolerRecipeWrapper.class, GasCoolerRecipeWrapper::new, NCJEI.getGasCoolerCrafters(), Lists.newArrayList(getProcessorJEIContainerConnection("pebble_fission_cooler"))).setItemInputSlots(standardSlot(46, 35)).setFluidInputSlots(standardSlot(66, 35)).setFluidOutputSlots(bigSlot(122, 31)).setProgressBarGuiXYWHUV(84, 35, 37, 16, 176, 3).setStandardJeiAlternateTitle());
