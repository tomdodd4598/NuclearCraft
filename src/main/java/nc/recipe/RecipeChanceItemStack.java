...
public class RecipeChanceItemStack implements IItemIngredient {
	...
	public RecipeChanceItemStack(IItemIngredient ingredient, int chancePercent) {
		this(ingredient, chancePercent, 0);
	}
	
	public RecipeChanceItemStack(IItemIngredient ingredient, int chancePercent, int minStackSize) {
