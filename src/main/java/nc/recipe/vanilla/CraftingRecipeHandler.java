...
public class CraftingRecipeHandler {
	...
	public static void registerCraftingRecipes() {
		...
		addShapedOreRecipe(NCBlocks.lithium_ion_battery_basic, new Object[] {"PCP", "CSC", "PCP", 'C', NCItems.lithium_ion_cell, 'P', "plateBasic", 'S', "solenoidMagnesiumDiboride"});
		...
		addShapedOreRecipe(NCBlocks.heat_exchanger_vent, new Object[] {"SNS", "VFV", "SNS", 'S', "ingotSteel", 'N', "stone", 'V', "servo", 'F', "steelFrame"});
