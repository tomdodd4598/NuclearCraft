...
public class FurnaceRecipeHandler {
	...
	public static void registerFurnaceRecipes() {
		...
		oxideFuelRecipes(NCItems.fuel_thorium, NCItems.fuel_rod_thorium, NCItems.depleted_fuel_rod_thorium, 1);
		oxideFuelRecipes(NCItems.fuel_uranium, NCItems.fuel_rod_uranium, NCItems.depleted_fuel_rod_uranium, 4);
		oxideFuelRecipes(NCItems.fuel_neptunium, NCItems.fuel_rod_neptunium, NCItems.depleted_fuel_rod_neptunium, 2);
		oxideFuelRecipes(NCItems.fuel_plutonium, NCItems.fuel_rod_plutonium, NCItems.depleted_fuel_rod_plutonium, 4);
		oxideFuelRecipes(NCItems.fuel_americium, NCItems.fuel_rod_americium, NCItems.depleted_fuel_rod_americium, 2);
		oxideFuelRecipes(NCItems.fuel_curium, NCItems.fuel_rod_curium, NCItems.depleted_fuel_rod_curium, 6);
		oxideFuelRecipes(NCItems.fuel_berkelium, NCItems.fuel_rod_berkelium, NCItems.depleted_fuel_rod_berkelium, 2);
		oxideFuelRecipes(NCItems.fuel_californium, NCItems.fuel_rod_californium, NCItems.depleted_fuel_rod_californium, 4);
	}
	
	public static void oxideFuelRecipes(Item fuelType, Item rodType, Item depletedRodType, int noFuelTypes) {
