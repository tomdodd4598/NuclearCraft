...
public class Global {
	...
	public static final String VERSION = "2.19c";
	public static final String DEPENDENCIES = "required-after:forge;" + "after:tconstruct;after:conarm;after:openterraingenerator;after:alchemistry";
