...
import nc.Global;
import nc.container.multiblock.ContainerFissionVesselPort;
import nc.gui.NCGui;
...
public class GuiFissionVesselPort extends NCGui {
	...
	public GuiFissionVesselPort(EntityPlayer player, TileFissionVesselPort port) {
		...
		this.port = port;
		gui_textures = new ResourceLocation(Global.MOD_ID + ":textures/gui/container/" + "fission_vessel_port" + ".png");
	}
