...
public class GuiPebbleFissionController extends GuiLogicMultiblockController<FissionReactor, FissionReactorLogic, IFissionPart, FissionUpdatePacket, TilePebbleFissionController, TileContainerInfo<TilePebbleFissionController>, PebbleBedFissionLogic> {
	
	protected final ResourceLocation gui_texture;
	
	public GuiPebbleFissionController(Container inventory, EntityPlayer player, TilePebbleFissionController controller, String textureLocation) {
		super(inventory, player, controller, textureLocation);
		gui_texture = new ResourceLocation(Global.MOD_ID + ":textures/gui/container/" + "pebble_fission_controller" + ".png");
		xSize = 176;
		ySize = 114;
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		// String outputRate = Lang.localize("gui.nc.container.pebble_fission_controller.output_rate") + " " + UnitHelper.prefix(getLogic().heatingOutputRateFP, 5, "B/t", -1);
