...
public class GuiPebbleFissionChamber extends GuiProcessorImpl.GuiBasicFilteredProcessor<TilePebbleFissionChamber, PebbleFissionChamberUpdatePacket> {
	
	public GuiPebbleFissionChamber(Container inventory, EntityPlayer player, TilePebbleFissionChamber tile, String textureLocation) {
