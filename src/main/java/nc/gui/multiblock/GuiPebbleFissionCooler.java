...
public class GuiPebbleFissionCooler extends GuiProcessorImpl.GuiBasicFilteredProcessor<TilePebbleFissionCooler, PebbleFissionCoolerUpdatePacket> {
	
	public GuiPebbleFissionCooler(Container inventory, EntityPlayer player, TilePebbleFissionCooler tile, String textureLocation) {
