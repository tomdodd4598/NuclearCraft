...
import nc.container.processor.ContainerSteamCrusher;
...
public class GuiSteamCrusher extends GuiItemFluidProcessor {

	public GuiSteamCrusher(EntityPlayer player, TileItemFluidProcessor tile) {
		this(player, tile, new ContainerSteamCrusher(player, tile));
	}

	private GuiSteamCrusher(EntityPlayer player, TileItemFluidProcessor tile, ContainerTile container) {
		super("steam_crusher", player, tile, container);
		xSize = 176;
		ySize = 166;
	}
	...
	public static class SideConfig extends GuiSteamCrusher {
