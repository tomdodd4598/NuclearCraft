...
public class GuiAlloyFurnace extends GuiItemProcessor {
	...
	private GuiAlloyFurnace(EntityPlayer player, TileItemProcessor tile, ContainerTile container) {
	...
	public static class SideConfig extends GuiAlloyFurnace {
		...
		public void renderButtonTooltips(int mouseX, int mouseY) {
			...
			drawTooltip(TextFormatting.BLUE + Lang.localise("gui.container.input_item_config"), mouseX, mouseY, 65, 34, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.container.output_item_config"), mouseX, mouseY, 121, 30, 26, 26);
