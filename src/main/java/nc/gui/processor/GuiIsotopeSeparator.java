...
public class GuiIsotopeSeparator extends GuiItemProcessor {
	...
	public GuiIsotopeSeparator(EntityPlayer player, TileItemProcessor tile) {
		this(player, tile, new ContainerIsotopeSeparator(player, tile));
	}
	
	private GuiIsotopeSeparator(EntityPlayer player, TileItemProcessor tile, ContainerTile container) {
		super("isotope_separator", player, tile, container);
		xSize = 176;
		ySize = 166;
	}
	...
	public static class SideConfig extends GuiIsotopeSeparator {
