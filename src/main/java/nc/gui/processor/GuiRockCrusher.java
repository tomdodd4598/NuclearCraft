...
public class GuiRockCrusher extends GuiItemProcessor {
	...
	protected GuiRockCrusher(EntityPlayer player, TileItemProcessor tile, ContainerTile<TileItemProcessor> container) {
	...
	public static class SideConfig extends GuiRockCrusher {
		...
		@Override
		public void renderButtonTooltips(int mouseX, int mouseY) {
			drawTooltip(TextFormatting.BLUE + Lang.localise("gui.nc.container.input_item_config"), mouseX, mouseY, 37, 34, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 93, 34, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 113, 34, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 133, 34, 18, 18);
