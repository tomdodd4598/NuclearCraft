...
public class GuiPressurizer extends GuiItemProcessor {
	...
	public GuiPressurizer(EntityPlayer player, TileItemProcessor tile) {
		this(player, tile, new ContainerPressurizer(player, tile));
	}
	
	private GuiPressurizer(EntityPlayer player, TileItemProcessor tile, ContainerTile container) {
		super("pressurizer", player, tile, container);
		xSize = 176;
		ySize = 166;
	}
	...
	public static class SideConfig extends GuiPressurizer {
