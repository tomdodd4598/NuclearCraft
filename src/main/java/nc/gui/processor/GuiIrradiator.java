...
public class GuiIrradiator extends GuiFluidProcessor {
	...
	private GuiIrradiator(EntityPlayer player, TileFluidProcessor tile, ContainerTile container) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		drawTexturedModalRect(guiLeft + 70, guiTop + 35, 176, 3, getCookProgressScaled(37), 18);
