...
public class GuiFuelReprocessor extends GuiItemProcessor {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		drawTexturedModalRect(guiLeft + 48, guiTop + 30, 176, 3, getCookProgressScaled(37), 38);
	...
	public static class SideConfig extends GuiFuelReprocessor {
		...
		@Override
		public void renderButtonTooltips(int mouseX, int mouseY) {
			drawTooltip(TextFormatting.BLUE + Lang.localise("gui.nc.container.input_item_config"), mouseX, mouseY, 29, 40, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 85, 30, 18, 18);
			...
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 145, 30, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.nc.container.output_item_config"), mouseX, mouseY, 85, 50, 18, 18);
		...
		@Override
		public void initButtons() {
			buttonList.add(new NCButton.SorptionConfig.ItemInput(0, guiLeft + 29, guiTop + 40));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(1, guiLeft + 85, guiTop + 30));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(2, guiLeft + 105, guiTop + 30));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(3, guiLeft + 125, guiTop + 30));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(4, guiLeft + 145, guiTop + 30));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(5, guiLeft + 85, guiTop + 50));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(6, guiLeft + 105, guiTop + 50));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(7, guiLeft + 125, guiTop + 50));
			buttonList.add(new NCButton.SorptionConfig.ItemOutputSmall(8, guiLeft + 145, guiTop + 50));
