...
public class GuiFuelReprocessor extends GuiItemProcessor {
	...
	public static class SideConfig extends GuiFuelReprocessor {
		...
		@Override
		public void renderButtonTooltips(int mouseX, int mouseY) {
			drawTooltip(TextFormatting.BLUE + Lang.localise("gui.container.input_item_config"), mouseX, mouseY, 49, 40, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.container.output_item_config"), mouseX, mouseY, 105, 30, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.container.output_item_config"), mouseX, mouseY, 125, 30, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.container.output_item_config"), mouseX, mouseY, 105, 50, 18, 18);
			drawTooltip(TextFormatting.GOLD + Lang.localise("gui.container.output_item_config"), mouseX, mouseY, 125, 50, 18, 18);
