...
public class GuiIngotFormer extends GuiProcessor {
	...
	protected GuiIngotFormer(EntityPlayer player, TileItemFluidProcessor tile, ContainerTile<TileItemFluidProcessor> container) {
