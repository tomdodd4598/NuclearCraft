...
public class GuiExtractor extends GuiProcessor {
	...
	protected GuiExtractor(EntityPlayer player, TileItemFluidProcessor tile, ContainerTile<TileItemFluidProcessor> container) {
		super("extractor", player, tile, container);
		xSize = 176;
		ySize = 166;
	}
	...
	public void initButtons() {
		buttonList.add(new NCButton.EmptyTank(0, guiLeft + 126, guiTop + 31, 24, 24));
	...
	public static class SideConfig extends GuiExtractor {
		...
		public void initButtons() {
			...
			buttonList.add(new NCButton.SorptionConfig.FluidOutput(2, guiLeft + 125, guiTop + 30));
