...
import nc.container.processor.ContainerSteamFurnace;
...
public class GuiSteamFurnace extends GuiItemFluidProcessor {

	public GuiSteamFurnace(EntityPlayer player, TileItemFluidProcessor tile) {
		this(player, tile, new ContainerSteamFurnace(player, tile));
	}

	private GuiSteamFurnace(EntityPlayer player, TileItemFluidProcessor tile, ContainerTile container) {
		super("steam_furnace", player, tile, container);
		xSize = 176;
		ySize = 166;
	}
	...
	public static class SideConfig extends GuiSteamFurnace {
