...
public class NCBlocks {
	...
	public static void init() {
		...
		if (NCConfig.register_processor[9]) electrolyser = withName(new BlockProcessor(ProcessorType.ELECTROLYSER));
		...
		if (NCConfig.register_processor[16]) dissolver = withName(new BlockProcessor(ProcessorType.DISSOLVER));
	...
	public static void register() {
		...
		if (NCConfig.register_processor[9]) registerBlock(electrolyser);
		...
		if (NCConfig.register_processor[16]) registerBlock(dissolver);
	...
	public static void registerRenders() {
		...
		if (NCConfig.register_processor[9]) registerRender(electrolyser);
		...
		if (NCConfig.register_processor[16]) registerRender(dissolver);
