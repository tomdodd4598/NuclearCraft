...
public class EnumHandler {
	...
	public static enum OreTypes implements IStringSerializable, IIdentification {
		COPPER("copper", 0),
		TIN("tin", 1),
		LEAD("lead", 2),
		THORIUM("thorium", 3),
	...
	public static enum FissionBlockTypes implements IStringSerializable, IIdentification {
	...
	public static enum CoolerTypes implements IStringSerializable, IIdentification {
		EMPTY("empty", 0, 0, 0.0D),
		WATER("water", 1, 0, NCConfig.fission_cooling_rate[0]),
		QUARTZ("quartz", 2, 0, NCConfig.fission_cooling_rate[1]),
		HELIUM("helium", 3, 0, NCConfig.fission_cooling_rate[2]),
		REDSTONE("redstone", 4, 7, NCConfig.fission_cooling_rate[3]),
		GLOWSTONE("glowstone", 5, 15, NCConfig.fission_cooling_rate[4]),
		ENDERIUM("enderium", 6, 7, NCConfig.fission_cooling_rate[5]),
		CRYOTHEUM("cryotheum", 7, 7, NCConfig.fission_cooling_rate[6]);
	...
	public static enum IngotTypes implements IStringSerializable, IIdentification {
		COPPER("copper", 0),
		TIN("tin", 1),
		LEAD("lead", 2),
		THORIUM("thorium", 3),
	...
	public static enum IngotOxideTypes implements IStringSerializable, IIdentification {
		THORIUM("thorium", 0),
		URANIUM("uranium", 1),
	...
	public static enum DustTypes implements IStringSerializable, IIdentification {
		COPPER("copper", 0),
		TIN("tin", 1),
		LEAD("lead", 2),
		THORIUM("thorium", 3),
	...
	public static enum DustOxideTypes implements IStringSerializable, IIdentification {
		THORIUM("thorium", 0),
		URANIUM("uranium", 1),
		MANGANESE("manganese", 2),
		MANGANESE2("manganese2", 3);
	...
	public static enum GemTypes implements IStringSerializable, IIdentification {
	...
	public static enum GemDustTypes implements IStringSerializable, IIdentification {
		DIAMOND("diamond", 0),
	...
	public static enum AlloyTypes implements IStringSerializable, IIdentification {
		BRONZE("bronze", 0),
		TOUGH("tough", 1),
	...
	public static enum PartTypes implements IStringSerializable, IIdentification {
	...
	public static enum UpgradeTypes implements IStringSerializable, IIdentification {
		SPEED("speed", 0);
	...
	public static enum ThoriumTypes implements IStringSerializable, IIdentification {
		_230("_230", 0),
	...
	public static enum UraniumTypes implements IStringSerializable, IIdentification {
		_233("_233", 0),
	...
	public static enum NeptuniumTypes implements IStringSerializable, IIdentification {
		_236("_236", 0),
	...
	public static enum PlutoniumTypes implements IStringSerializable, IIdentification {
		_238("_238", 0),
	...
	public static enum AmericiumTypes implements IStringSerializable, IIdentification {
		_241("_241", 0),
	...
	public static enum CuriumTypes implements IStringSerializable, IIdentification {
		_243("_243", 0),
	...
	public static enum BerkeliumTypes implements IStringSerializable, IIdentification {
		_247("_247", 0),
	...
	public static enum CaliforniumTypes implements IStringSerializable, IIdentification {
		_249("_249", 0),
	...
	public static enum ThoriumFuelTypes implements IStringSerializable, IIdentification {
		TBU("tbu", 0),
	...
	public static enum UraniumFuelTypes implements IStringSerializable, IIdentification {
		LEU_233("leu_233", 0),
	...
	public static enum NeptuniumFuelTypes implements IStringSerializable, IIdentification {
		LEN_236("len_236", 0),
	...
	public static enum PlutoniumFuelTypes implements IStringSerializable, IIdentification {
		LEP_239("lep_239", 0),
	...
	public static enum MixedOxideFuelTypes implements IStringSerializable, IIdentification {
		MOX_239("mox_239", 0),
		MOX_241("mox_241", 1);
	...
	public static enum AmericiumFuelTypes implements IStringSerializable, IIdentification {
		LEA_242("lea_242", 0),
	...
	public static enum CuriumFuelTypes implements IStringSerializable, IIdentification {
		LEC_243("lec_243", 0),
	...
	public static enum BerkeliumFuelTypes implements IStringSerializable, IIdentification {
		LEB_248("leb_248", 0),
	...
	public static enum CaliforniumFuelTypes implements IStringSerializable, IIdentification {
		LEC_249("lec_249", 0),
	...
	public static enum ThoriumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum UraniumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum NeptuniumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum PlutoniumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum MixedOxideFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum AmericiumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum CuriumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum BerkeliumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum CaliforniumFuelRodTypes implements IStringSerializable, IIdentification, IFissionable {
	...
	public static enum ThoriumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		TBU("tbu", 0),
		TBU_OXIDE("tbu_oxide", 1);
	...
	public static enum UraniumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEU_233("leu_233", 0),
		LEU_233_OXIDE("leu_233_oxide", 1),
		HEU_233("heu_233", 2),
		HEU_233_OXIDE("heu_233_oxide", 3),
	...
	public static enum NeptuniumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEN_236("len_236", 0),
		LEN_236_OXIDE("len_236_oxide", 1),
		HEN_236("hen_236", 2),
		HEN_236_OXIDE("hen_236_oxide", 3);
	...
	public static enum PlutoniumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEP_239("lep_239", 0),
		LEP_239_OXIDE("lep_239_oxide", 1),
		HEP_239("hep_239", 2),
		HEP_239_OXIDE("hep_239_oxide", 3),
	...
	public static enum MixedOxideDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		MOX_239("mox_239", 0),
		MOX_241("mox_241", 1);
	...
	public static enum AmericiumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEA_242("lea_242", 0),
		LEA_242_OXIDE("lea_242_oxide", 1),
		HEA_242("hea_242", 2),
		HEA_242_OXIDE("hea_242_oxide", 3);
	...
	public static enum CuriumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEC_243("lec_243", 0),
		LEC_243_OXIDE("lec_243_oxide", 1),
		HEC_243("hec_243", 2),
		HEC_243_OXIDE("hec_243_oxide", 3),
	...
	public static enum BerkeliumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEB_248("leb_248", 0),
		LEB_248_OXIDE("leb_248_oxide", 1),
		HEB_248("heb_248", 2),
		HEB_248_OXIDE("heb_248_oxide", 3);
	...
	public static enum CaliforniumDepletedFuelRodTypes implements IStringSerializable, IIdentification {
		LEC_249("lec_249", 0),
		LEC_249_OXIDE("lec_249_oxide", 1),
		HEC_249("hec_249", 2),
		HEC_249_OXIDE("hec_249_oxide", 3),
