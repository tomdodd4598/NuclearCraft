...
public class RecipeHandler {
	...
	public static void registerCraftingRecipes() {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 2), new Object[] {"DDD", "QCQ", "DDD", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'Q', "blockQuartz", 'D', "dustQuartz"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 4), new Object[] {"R", "C", "R", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'R', "blockRedstone"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 4), new Object[] {"RCR", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'R', "blockRedstone"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 5), new Object[] {" G ", "GCG", " G ", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'G', "blockGlowstone"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 6), new Object[] {" E ", "ECE", " E ", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'E', "ingotEnderium"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(NCBlocks.cooler, 1, 7), new Object[] {" D ", "DCD", " D ", 'C', new ItemStack(NCBlocks.cooler, 1, 0), 'D', "dustCryotheum"}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.manufactory_idle, new Object[] {"PWP", "WSW", "PWP", 'W', new ItemStack(NCItems.part, 1, 4), 'P', "plateBasic", 'S', Blocks.PISTON}));
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.isotope_separator_idle, new Object[] {"PRP", "RMR", "PRP", 'R', "dustRedstone", 'P', "plateAdvanced", 'M', NCBlocks.manufactory_idle}));
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.decay_hastener_idle, new Object[] {"PGP", "GMG", "PGP", 'G', "ingotMagnesium", 'P', "plateAdvanced", 'M', NCBlocks.manufactory_idle}));
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.fuel_reprocessor_idle, new Object[] {"PGP", "GMG", "PGP", 'G', "ingotGold", 'P', "plateAdvanced", 'M', NCBlocks.manufactory_idle}));
		
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.fission_controller_idle, new Object[] {"PBP", "BMB", "PBP", 'B', "ingotBronze", 'P', "plateDU", 'M', NCBlocks.decay_hastener_idle}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.rtg_plutonium, new Object[] {"PGP", "GUG", "PGP", 'G', "ingotGraphite", 'P', "plateBasic", 'U', "ingotPlutonium238"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.rtg_americium, new Object[] {"PGP", "GAG", "PGP", 'G', "ingotGraphite", 'P', "plateBasic", 'A', "ingotAmericium241"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(NCBlocks.rtg_californium, new Object[] {"PGP", "GCG", "PGP", 'G', "ingotGraphite", 'P', "plateBasic", 'C', "ingotCalifornium250"}));
