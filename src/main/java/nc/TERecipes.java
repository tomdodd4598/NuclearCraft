...
public final class TERecipes {
	...
	public void hook() {
		...
		if(!TELoaded || NuclearCraft.nonTECoolerRecipes) addTESubstitutes();
	}
	...
	public static void addTERecipes() {
		...
		try {ThermalExpansionHelper.addTransposerFill(1000, new ItemStack(NCBlocks.emptyCoolerBlock, 1), new ItemStack(NCBlocks.heliumCoolerBlock, 1), new FluidStack(NuclearCraft.liquidHelium, 4000), true);} catch(Exception e) {}
