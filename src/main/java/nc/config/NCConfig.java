...
public class NCConfig {
	...
	public static double salt_fission_vessel_spread_ratio;
	public static double salt_fission_heater_spread_ratio;
	...
	private static void syncConfig(boolean loadFromFile, boolean setFromConfig) {
		...
		Property propertySaltFissionVesselSpreadRatio = config.get(CATEGORY_SALT_FISSION, "salt_fission_vessel_spread_ratio", 0.5D, Lang.localise("gui.config.salt_fission.salt_fission_vessel_spread_ratio.comment"), 0D, 1D);
		propertySaltFissionVesselSpreadRatio.setLanguageKey("gui.config.salt_fission.salt_fission_vessel_spread_ratio");
		Property propertySaltFissionHeaterSpreadRatio = config.get(CATEGORY_SALT_FISSION, "salt_fission_heater_spread_ratio", 0.5D, Lang.localise("gui.config.salt_fission.salt_fission_heater_spread_ratio.comment"), 0D, 1D);
		propertySaltFissionHeaterSpreadRatio.setLanguageKey("gui.config.salt_fission.salt_fission_heater_spread_ratio");
		...
		propertyHeatExchangerCondenserTubeSpreadRatio.setLanguageKey("gui.config.heat_exchanger.heat_exchanger_condenser_tube_spread_ratio");
		...
		Property propertyOreDictPriority = config.get(CATEGORY_OTHER, "ore_dict_priority", new String[] {"minecraft", "thermalfoundation", "techreborn", "nuclearcraft", "qmd", "trinity", "immersiveengineering", "mekanism", "ic2", "appliedenergistics2", "refinedstorage", "actuallyadditions", "advancedRocketry", "thaumcraft", "biomesoplenty"}, Lang.localise("gui.config.other.ore_dict_priority.comment"));
		...
		propertyOrderSaltFission.add(propertySaltFissionVesselSpreadRatio.getName());
		propertyOrderSaltFission.add(propertySaltFissionHeaterSpreadRatio.getName());
		...
		if (setFromConfig) {
			...
			salt_fission_vessel_spread_ratio = propertySaltFissionVesselSpreadRatio.getDouble();
			salt_fission_heater_spread_ratio = propertySaltFissionHeaterSpreadRatio.getDouble();
		...
		propertySaltFissionVesselSpreadRatio.set(salt_fission_vessel_spread_ratio);
		propertySaltFissionHeaterSpreadRatio.set(salt_fission_heater_spread_ratio);
