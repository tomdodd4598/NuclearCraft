...
//        ncpf.addMSRController("nuclearcraft:salt_fission_controller", "Molten Salt Fission Controller", "overhaul/msr/controller");
...
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:0", "Standard Coolant Heater", "overhaul/msr/standard", fission_heater_cooling_rate[0], fission_heater_rule[0], "nuclearcraft:fission_heater_port:0", "Standard Coolant Heater Port (Input)", "overhaul/msr/port/standard", "Standard Coolant Heater Port (Output)", "overhaul/msr/port/output/standard", "nak", "Eutectic NAK Alloy", "overhaul/msr/coolant/nak", "nak_hot", "Hot Eutectic NaK Alloy", "overhaul/msr/coolant/hot/nak");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:1", "Iron Coolant Heater", "overhaul/msr/iron", fission_heater_cooling_rate[1], fission_heater_rule[1], "nuclearcraft:fission_heater_port:1", "Iron Coolant Heater Port (Input)", "overhaul/msr/port/iron", "Iron Coolant Heater Port (Output)", "overhaul/msr/port/output/iron", "iron_nak", "Eutectic NaK-Iron Mixture", "overhaul/msr/coolant/iron", "iron_nak_hot", "Hot Eutectic NaK-Iron Mixture", "overhaul/msr/coolant/hot/iron");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:2", "Redstone Coolant Heater", "overhaul/msr/redstone", fission_heater_cooling_rate[2], fission_heater_rule[2], "nuclearcraft:fission_heater_port:2", "Redstone Coolant Heater Port (Input)", "overhaul/msr/port/redstone", "Redstone Coolant Heater Port (Output)", "overhaul/msr/port/output/redstone", "redstone_nak", "Eutectic NaK-Redstone Mixture", "overhaul/msr/coolant/redstone", "redstone_nak_hot", "Hot Eutectic NaK-Redstone Mixture", "overhaul/msr/coolant/hot/redstone");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:3", "Quartz Coolant Heater", "overhaul/msr/quartz", fission_heater_cooling_rate[3], fission_heater_rule[3], "nuclearcraft:fission_heater_port:3", "Quartz Coolant Heater Port (Input)", "overhaul/msr/port/quartz", "Quartz Coolant Heater Port (Output)", "overhaul/msr/port/output/quartz", "quartz_nak", "Eutectic NaK-Quartz Mixture", "overhaul/msr/coolant/quartz", "quartz_nak_hot", "Hot Eutectic NaK-Quartz Mixture", "overhaul/msr/coolant/hot/quartz");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:4", "Obsidian Coolant Heater", "overhaul/msr/obsidian", fission_heater_cooling_rate[4], fission_heater_rule[4], "nuclearcraft:fission_heater_port:4", "Obsidian Coolant Heater Port (Input)", "overhaul/msr/port/obsidian", "Obsidian Coolant Heater Port (Output)", "overhaul/msr/port/output/obsidian", "obsidian_nak", "Eutectic NaK-Obsidian Mixture", "overhaul/msr/coolant/obsidian", "obsidian_nak_hot", "Hot Eutectic NaK-Obsidian Mixture", "overhaul/msr/coolant/hot/obsidian");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:5", "Nether Brick Coolant Heater", "overhaul/msr/nether brick", fission_heater_cooling_rate[5], fission_heater_rule[5], "nuclearcraft:fission_heater_port:5", "Nether Brick Coolant Heater Port (Input)", "overhaul/msr/port/nether_brick", "Nether Brick Coolant Heater Port (Output)", "overhaul/msr/port/output/nether_brick", "nether_brick_nak", "Eutectic NaK-Nether Brick Mixture", "overhaul/msr/coolant/nether_brick", "nether_brick_nak_hot", "Hot Eutectic NaK-Nether Brick Mixture", "overhaul/msr/coolant/hot/nether_brick");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:6", "Glowstone Coolant Heater", "overhaul/msr/glowstone", fission_heater_cooling_rate[6], fission_heater_rule[6], "nuclearcraft:fission_heater_port:6", "Glowstone Coolant Heater Port (Input)", "overhaul/msr/port/glowstone", "Glowstone Coolant Heater Port (Output)", "overhaul/msr/port/output/glowstone", "glowstone_nak", "Eutectic NaK-Glowstone Mixture", "overhaul/msr/coolant/glowstone", "glowstone_nak_hot", "Hot Eutectic NaK-Glowstone Mixture", "overhaul/msr/coolant/hot/glowstone");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:7", "Lapis Coolant Heater", "overhaul/msr/lapis", fission_heater_cooling_rate[7], fission_heater_rule[7], "nuclearcraft:fission_heater_port:7", "Lapis Coolant Heater Port (Input)", "overhaul/msr/port/lapis", "Lapis Coolant Heater Port (Output)", "overhaul/msr/port/output/lapis", "lapis_nak", "Eutectic NaK-Lapis Mixture", "overhaul/msr/coolant/lapis", "lapis_nak_hot", "Hot Eutectic NaK-Lapis Mixture", "overhaul/msr/coolant/hot/lapis");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:8", "Gold Coolant Heater", "overhaul/msr/gold", fission_heater_cooling_rate[8], fission_heater_rule[8], "nuclearcraft:fission_heater_port:8", "Gold Coolant Heater Port (Input)", "overhaul/msr/port/gold", "Gold Coolant Heater Port (Output)", "overhaul/msr/port/output/gold", "gold_nak", "Eutectic NaK-Gold Mixture", "overhaul/msr/coolant/gold", "gold_nak_hot", "Hot Eutectic NaK-Gold Mixture", "overhaul/msr/coolant/hot/gold");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:9", "Prismarine Coolant Heater", "overhaul/msr/prismarine", fission_heater_cooling_rate[9], fission_heater_rule[9], "nuclearcraft:fission_heater_port:9", "Prismarine Coolant Heater Port (Input)", "overhaul/msr/port/prismarine", "Prismarine Coolant Heater Port (Output)", "overhaul/msr/port/output/prismarine", "prismarine_nak", "Eutectic NaK-Prismarine Mixture", "overhaul/msr/coolant/prismarine", "prismarine_nak_hot", "Hot Eutectic NaK-Prismarine Mixture", "overhaul/msr/coolant/hot/prismarine");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:10", "Slime Coolant Heater", "overhaul/msr/slime", fission_heater_cooling_rate[10], fission_heater_rule[10], "nuclearcraft:fission_heater_port:10", "Slime Coolant Heater Port (Input)", "overhaul/msr/port/slime", "Slime Coolant Heater Port (Output)", "overhaul/msr/port/output/slime", "slime_nak", "Eutectic NaK-Slime Mixture", "overhaul/msr/coolant/slime", "slime_nak_hot", "Hot Eutectic NaK-Slime Mixture", "overhaul/msr/coolant/hot/slime");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:11", "End Stone Coolant Heater", "overhaul/msr/end stone", fission_heater_cooling_rate[11], fission_heater_rule[11], "nuclearcraft:fission_heater_port:11", "End Stone Coolant Heater Port (Input)", "overhaul/msr/port/end_stone", "End Stone Coolant Heater Port (Output)", "overhaul/msr/port/output/end_stone", "end_stone_nak", "Eutectic NaK-End Stone Mixture", "overhaul/msr/coolant/end_stone", "end_stone_nak_hot", "Hot Eutectic NaK-End Stone Mixture", "overhaul/msr/coolant/hot/end_stone");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:12", "Purpur Coolant Heater", "overhaul/msr/purpur", fission_heater_cooling_rate[12], fission_heater_rule[12], "nuclearcraft:fission_heater_port:12", "Purpur Coolant Heater Port (Input)", "overhaul/msr/port/purpur", "Purpur Coolant Heater Port (Output)", "overhaul/msr/port/output/purpur", "purpur_nak", "Eutectic NaK-Purpur Mixture", "overhaul/msr/coolant/purpur", "purpur_nak_hot", "Hot Eutectic NaK-Purpur Mixture", "overhaul/msr/coolant/hot/purpur");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:13", "Diamond Coolant Heater", "overhaul/msr/diamond", fission_heater_cooling_rate[13], fission_heater_rule[13], "nuclearcraft:fission_heater_port:13", "Diamond Coolant Heater Port (Input)", "overhaul/msr/port/diamond", "Diamond Coolant Heater Port (Output)", "overhaul/msr/port/output/diamond", "diamond_nak", "Eutectic NaK-Diamond Mixture", "overhaul/msr/coolant/diamond", "diamond_nak_hot", "Hot Eutectic NaK-Diamond Mixture", "overhaul/msr/coolant/hot/diamond");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:14", "Emerald Coolant Heater", "overhaul/msr/emerald", fission_heater_cooling_rate[14], fission_heater_rule[14], "nuclearcraft:fission_heater_port:14", "Emerald Coolant Heater Port (Input)", "overhaul/msr/port/emerald", "Emerald Coolant Heater Port (Output)", "overhaul/msr/port/output/emerald", "emerald_nak", "Eutectic NaK-Emerald Mixture", "overhaul/msr/coolant/emerald", "emerald_nak_hot", "Hot Eutectic NaK-Emerald Mixture", "overhaul/msr/coolant/hot/emerald");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater:15", "Copper Coolant Heater", "overhaul/msr/copper", fission_heater_cooling_rate[15], fission_heater_rule[15], "nuclearcraft:fission_heater_port:15", "Copper Coolant Heater Port (Input)", "overhaul/msr/port/copper", "Copper Coolant Heater Port (Output)", "overhaul/msr/port/output/copper", "copper_nak", "Eutectic NaK-Copper Mixture", "overhaul/msr/coolant/copper", "copper_nak_hot", "Hot Eutectic NaK-Copper Mixture", "overhaul/msr/coolant/hot/copper");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:0", "Tin Coolant Heater", "overhaul/msr/tin", fission_heater_cooling_rate[16], fission_heater_rule[16], "nuclearcraft:fission_heater_port2:0", "Tin Coolant Heater Port (Input)", "overhaul/msr/port/tin", "Tin Coolant Heater Port (Output)", "overhaul/msr/port/output/tin", "tin_nak", "Eutectic NaK-Tin Mixture", "overhaul/msr/coolant/tin", "tin_nak_hot", "Hot Eutectic NaK-Tin Mixture", "overhaul/msr/coolant/hot/tin");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:1", "Lead Coolant Heater", "overhaul/msr/lead", fission_heater_cooling_rate[17], fission_heater_rule[17], "nuclearcraft:fission_heater_port2:1", "Lead Coolant Heater Port (Input)", "overhaul/msr/port/lead", "Lead Coolant Heater Port (Output)", "overhaul/msr/port/output/lead", "lead_nak", "Eutectic NaK-Lead Mixture", "overhaul/msr/coolant/lead", "lead_nak_hot", "Hot Eutectic NaK-Lead Mixture", "overhaul/msr/coolant/hot/lead");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:2", "Boron Coolant Heater", "overhaul/msr/boron", fission_heater_cooling_rate[18], fission_heater_rule[18], "nuclearcraft:fission_heater_port2:2", "Boron Coolant Heater Port (Input)", "overhaul/msr/port/boron", "Boron Coolant Heater Port (Output)", "overhaul/msr/port/output/boron", "boron_nak", "Eutectic NaK-Boron Mixture", "overhaul/msr/coolant/boron", "boron_nak_hot", "Hot Eutectic NaK-Boron Mixture", "overhaul/msr/coolant/hot/boron");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:3", "Lithium Coolant Heater", "overhaul/msr/lithium", fission_heater_cooling_rate[19], fission_heater_rule[19], "nuclearcraft:fission_heater_port2:3", "Lithium Coolant Heater Port (Input)", "overhaul/msr/port/lithium", "Lithium Coolant Heater Port (Output)", "overhaul/msr/port/output/lithium", "lithium_nak", "Eutectic NaK-Lithium Mixture", "overhaul/msr/coolant/lithium", "lithium_nak_hot", "Hot Eutectic NaK-Lithium Mixture", "overhaul/msr/coolant/hot/lithium");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:4", "Magnesium Coolant Heater", "overhaul/msr/magnesium", fission_heater_cooling_rate[20], fission_heater_rule[20], "nuclearcraft:fission_heater_port2:4", "Magnesium Coolant Heater Port (Input)", "overhaul/msr/port/magnesium", "Magnesium Coolant Heater Port (Output)", "overhaul/msr/port/output/magnesium", "magnesium_nak", "Eutectic NaK-Magnesium Mixture", "overhaul/msr/coolant/magnesium", "magnesium_nak_hot", "Hot Eutectic NaK-Magnesium Mixture", "overhaul/msr/coolant/hot/magnesium");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:5", "Manganese Coolant Heater", "overhaul/msr/manganese", fission_heater_cooling_rate[21], fission_heater_rule[21], "nuclearcraft:fission_heater_port2:5", "Manganese Coolant Heater Port (Input)", "overhaul/msr/port/manganese", "Manganese Coolant Heater Port (Output)", "overhaul/msr/port/output/manganese", "manganese_nak", "Eutectic NaK-Manganese Mixture", "overhaul/msr/coolant/manganese", "manganese_nak_hot", "Hot Eutectic NaK-Manganese Mixture", "overhaul/msr/coolant/hot/manganese");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:6", "Aluminum Coolant Heater", "overhaul/msr/aluminum", fission_heater_cooling_rate[22], fission_heater_rule[22], "nuclearcraft:fission_heater_port2:6", "Aluminum Coolant Heater Port (Input)", "overhaul/msr/port/aluminum", "Aluminum Coolant Heater Port (Output)", "overhaul/msr/port/output/aluminum", "aluminum_nak", "Eutectic NaK-Aluminum Mixture", "overhaul/msr/coolant/aluminum", "aluminum_nak_hot", "Hot Eutectic NaK-Aluminum Mixture", "overhaul/msr/coolant/hot/aluminum");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:7", "Silver Coolant Heater", "overhaul/msr/silver", fission_heater_cooling_rate[23], fission_heater_rule[23], "nuclearcraft:fission_heater_port2:7", "Silver Coolant Heater Port (Input)", "overhaul/msr/port/silver", "Silver Coolant Heater Port (Output)", "overhaul/msr/port/output/silver", "silver_nak", "Eutectic NaK-Silver Mixture", "overhaul/msr/coolant/silver", "silver_nak_hot", "Hot Eutectic NaK-Silver Mixture", "overhaul/msr/coolant/hot/silver");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:8", "Fluorite Coolant Heater", "overhaul/msr/fluorite", fission_heater_cooling_rate[24], fission_heater_rule[24], "nuclearcraft:fission_heater_port2:8", "Fluorite Coolant Heater Port (Input)", "overhaul/msr/port/fluorite", "Fluorite Coolant Heater Port (Output)", "overhaul/msr/port/output/fluorite", "fluorite_nak", "Eutectic NaK-Fluorite Mixture", "overhaul/msr/coolant/fluorite", "fluorite_nak_hot", "Hot Eutectic NaK-Fluorite Mixture", "overhaul/msr/coolant/hot/fluorite");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:9", "Villiaumite Coolant Heater", "overhaul/msr/villiaumite", fission_heater_cooling_rate[25], fission_heater_rule[25], "nuclearcraft:fission_heater_port2:9", "Villiaumite Coolant Heater Port (Input)", "overhaul/msr/port/villiaumite", "Villiaumite Coolant Heater Port (Output)", "overhaul/msr/port/output/villiaumite", "villiaumite_nak", "Eutectic NaK-Villiaumite Mixture", "overhaul/msr/coolant/villiaumite", "villiaumite_nak_hot", "Hot Eutectic NaK-Villiaumite Mixture", "overhaul/msr/coolant/hot/villiaumite");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:10", "Carobbiite Coolant Heater", "overhaul/msr/carobbiite", fission_heater_cooling_rate[26], fission_heater_rule[26], "nuclearcraft:fission_heater_port2:10", "Carobbiite Coolant Heater Port (Input)", "overhaul/msr/port/carobbiite", "Carobbiite Coolant Heater Port (Output)", "overhaul/msr/port/output/carobbiite", "carobbiite_nak", "Eutectic NaK-Carobbiite Mixture", "overhaul/msr/coolant/carobbiite", "carobbiite_nak_hot", "Hot Eutectic NaK-Carobbiite Mixture", "overhaul/msr/coolant/hot/carobbiite");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:11", "Arsenic Coolant Heater", "overhaul/msr/arsenic", fission_heater_cooling_rate[27], fission_heater_rule[27], "nuclearcraft:fission_heater_port2:11", "Arsenic Coolant Heater Port (Input)", "overhaul/msr/port/arsenic", "Arsenic Coolant Heater Port (Output)", "overhaul/msr/port/output/arsenic", "arsenic_nak", "Eutectic NaK-Arsenic Mixture", "overhaul/msr/coolant/arsenic", "arsenic_nak_hot", "Hot Eutectic NaK-Arsenic Mixture", "overhaul/msr/coolant/hot/arsenic");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:12", "Liquid Nitrogen Coolant Heater", "overhaul/msr/nitrogen", fission_heater_cooling_rate[28], fission_heater_rule[28], "nuclearcraft:fission_heater_port2:12", "Liquid Nitrogen Coolant Heater Port (Input)", "overhaul/msr/port/nitrogen", "Liquid Nitrogen Coolant Heater Port (Output)", "overhaul/msr/port/output/nitrogen", "liquid_nitrogen_nak", "Eutectic NaK-Nitrogen Mixture", "overhaul/msr/coolant/nitrogen", "liquid_nitrogen_nak_hot", "Hot Eutectic NaK-Nitrogen Mixture", "overhaul/msr/coolant/hot/nitrogen");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:13", "Liquid Helium Coolant Heater", "overhaul/msr/helium", fission_heater_cooling_rate[29], fission_heater_rule[29], "nuclearcraft:fission_heater_port2:13", "Liquid Helium Coolant Heater Port (Input)", "overhaul/msr/port/helium", "Liquid Helium Coolant Heater Port (Output)", "overhaul/msr/port/output/helium", "liquid_helium_nak", "Eutectic NaK-Helium Mixture", "overhaul/msr/coolant/helium", "liquid_helium_nak_hot", "Hot Eutectic NaK-Helium Mixture", "overhaul/msr/coolant/hot/helium");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:14", "Enderium Coolant Heater", "overhaul/msr/enderium", fission_heater_cooling_rate[30], fission_heater_rule[30], "nuclearcraft:fission_heater_port2:14", "Enderium Coolant Heater Port (Input)", "overhaul/msr/port/enderium", "Enderium Coolant Heater Port (Output)", "overhaul/msr/port/output/enderium", "enderium_nak", "Eutectic NaK-Enderium Mixture", "overhaul/msr/coolant/enderium", "enderium_nak_hot", "Hot Eutectic NaK-Enderium Mixture", "overhaul/msr/coolant/hot/enderium");
//        ncpf.addMSRHeater("nuclearcraft:salt_fission_heater2:15", "Cryotheum Coolant Heater", "overhaul/msr/cryotheum", fission_heater_cooling_rate[31], fission_heater_rule[31], "nuclearcraft:fission_heater_port2:15", "Cryotheum Coolant Heater Port (Input)", "overhaul/msr/port/cryotheum", "Cryotheum Coolant Heater Port (Output)", "overhaul/msr/port/output/cryotheum", "cryotheum_nak", "Eutectic NaK-Cryotheum Mixture", "overhaul/msr/coolant/cryotheum", "cryotheum_nak_hot", "Hot Eutectic NaK-Cryotheum Mixture", "overhaul/msr/coolant/hot/cryotheum");
//        ncpf.addMSRVessel("nuclearcraft:salt_fission_vessel", "Fuel Vessel", "overhaul/msr/vessel", "nuclearcraft:fission_vessel_port", "Fuel Vessel Port (Input)", "overhaul/msr/vessel_port_input", "Fuel Vessel Port (Output)", "overhaul/msr/vessel_port_output");
...
//        ncpf.addTurbineController("nuclearcraft:turbine_controller", "Turbine Controller", "overhaul/turbine/controller");
//        ncpf.addTurbineCasing("nuclearcraft:turbine_casing", "Turbine Casing", "overhaul/turbine/casing", true);
//        ncpf.addTurbineCasing("nuclearcraft:turbine_glass", "Turbine Glass", "overhaul/turbine/glass", false);
//        ncpf.addTurbineInlet("nuclearcraft:turbine_inlet", "Fluid Inlet", "overhaul/turbine/inlet");
//        ncpf.addTurbineOutlet("nuclearcraft:turbine_outlet", "Fluid Outlet", "overhaul/turbine/outlet");
...
//        ncpf.addTurbineBlade("nuclearcraft:turbine_rotor_blade_steel", "Steel Rotor Blade", "overhaul/turbine/steel", (float)turbine_blade_efficiency[0], (float)turbine_blade_expansion[0]);
//        ncpf.addTurbineBlade("nuclearcraft:turbine_rotor_blade_extreme", "Extreme Alloy Rotor Blade", "overhaul/turbine/extreme", (float)turbine_blade_efficiency[1], (float)turbine_blade_expansion[1]);
//        ncpf.addTurbineBlade("nuclearcraft:turbine_rotor_blade_sic_sic_cmc", "SiC-SiC CMC Rotor Blade", "overhaul/turbine/sic", (float)turbine_blade_efficiency[2], (float)turbine_blade_expansion[2]);
//        ncpf.addTurbineStator("nuclearcraft:turbine_rotor_stator", "Rotor Stator", "overhaul/turbine/stator", (float)turbine_stator_expansion);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:0", "Magnesium Dynamo Coil", "overhaul/turbine/magnesium", (float)turbine_coil_conductivity[0], turbine_coil_rule[0]);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:1", "Beryllium Dynamo Coil", "overhaul/turbine/beryllium", (float)turbine_coil_conductivity[1], turbine_coil_rule[1]);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:2", "Aluminum Dynamo Coil", "overhaul/turbine/aluminum", (float)turbine_coil_conductivity[2], turbine_coil_rule[2]);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:3", "Gold Dynamo Coil", "overhaul/turbine/gold", (float)turbine_coil_conductivity[3], turbine_coil_rule[3]);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:4", "Copper Dynamo Coil", "overhaul/turbine/copper", (float)turbine_coil_conductivity[4], turbine_coil_rule[4]);
//        ncpf.addTurbineCoil("nuclearcraft:turbine_dynamo_coil:5", "Silver Dynamo Coil", "overhaul/turbine/silver", (float)turbine_coil_conductivity[5], turbine_coil_rule[5]);
//        ncpf.addTurbineConnector("nuclearcraft:turbine_coil_connector", "Dynamo Coil Connector", "overhaul/turbine/connector", turbine_connector_rule[0]);
//        ncpf.addTurbineBearing("nuclearcraft:turbine_rotor_bearing", "Rotor Bearing", "overhaul/turbine/bearing");
//        ncpf.addTurbineShaft("nuclearcraft:turbine_rotor_shaft", "Rotor Shaft", "overhaul/turbine/shaft");
//        ncpf.addTurbineRecipe("high_pressure_steam", "High Pressure Steam", "fluids/hps", "exhaust_steam", "Exhaust Steam", "fluids/exhaust_steam", turbine_power_per_mb[0], turbine_expansion_level[0]);
//        ncpf.addTurbineRecipe("low_pressure_steam", "Low Pressure Steam", "fluids/lps", "low_quality_steam", "Low Quality Steam", "fluids/lqs", turbine_power_per_mb[1], turbine_expansion_level[1]);
//        ncpf.addTurbineRecipe("steam", "Steam", "fluids/steam", "low_quality_steam", "Low Quality Steam", "fluids/lqs", turbine_power_per_mb[2], turbine_expansion_level[2]);
//</editor-fold>
        for(CTRegistration.RegistrationInfo info : CTRegistration.INFO_LIST){
            throw new IllegalArgumentException("Unrecognized CT Registration info: "+info.getClass().getName());
        }
        ...
        try(FileOutputStream fos = new FileOutputStream(file)){
            ...
            //TODO properly handle the error without crashing
