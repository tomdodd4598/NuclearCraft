...
public class NCConfig {
	...
	private static void syncConfig(boolean loadFromFile, boolean setFromConfig) {
		...
		Property propertyOreDims = config.get(CATEGORY_ORES, "ore_dims", new int[] {0, 2, -6, -100, 4598, -9999, -11325}, Lang.localise("gui.nc.config.ores.ore_dims.comment"), Integer.MIN_VALUE, Integer.MAX_VALUE);
		propertyOreDims.setLanguageKey("gui.nc.config.ores.ore_dims");
		Property propertyOreDimsListType = config.get(CATEGORY_ORES, "ore_dims_list_type", false, Lang.localise("gui.nc.config.ores.ore_dims_list_type.comment"));
		...
		Property propertyOreMaxHeight = config.get(CATEGORY_ORES, "ore_max_height", new int[] {48, 40, 36, 32, 32, 28, 28, 24}, Lang.localise("gui.nc.config.ores.ore_max_height.comment"), 1, 255);
		propertyOreMaxHeight.setLanguageKey("gui.nc.config.ores.ore_max_height");
		Property propertyOreDrops = config.get(CATEGORY_ORES, "ore_drops", new boolean[] {false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.ores.ore_drops.comment"));
		propertyOreDrops.setLanguageKey("gui.nc.config.ores.ore_drops");
		Property propertyHideDisabledOres = config.get(CATEGORY_ORES, "hide_disabled_ores", false, Lang.localise("gui.nc.config.ores.hide_disabled_ores.comment"));
		propertyHideDisabledOres.setLanguageKey("gui.nc.config.ores.hide_disabled_ores");
		Property propertyOreHarvestLevels = config.get(CATEGORY_ORES, "ore_harvest_levels", new int[] {1, 1, 1, 2, 2, 2, 2, 2}, Lang.localise("gui.nc.config.ores.ore_harvest_levels.comment"), 0, 15);
		propertyOreHarvestLevels.setLanguageKey("gui.nc.config.ores.ore_harvest_levels");
		
		Property propertyProcessorTime = config.get(CATEGORY_PROCESSORS, "processor_time", new int[] {400, 800, 800, 400, 400, 600, 800, 600, 3200, 600, 400, 600, 800, 600, 1600, 600, 2400, 1200, 400}, Lang.localise("gui.nc.config.processors.processor_time.comment"), 1, 128000);
		propertyProcessorTime.setLanguageKey("gui.nc.config.processors.processor_time");
		Property propertyProcessorPower = config.get(CATEGORY_PROCESSORS, "processor_power", new int[] {20, 10, 10, 20, 10, 10, 40, 20, 40, 10, 0, 40, 10, 20, 10, 10, 10, 10, 20}, Lang.localise("gui.nc.config.processors.processor_power.comment"), 0, 16000);
		propertyProcessorPower.setLanguageKey("gui.nc.config.processors.processor_power");
		Property propertySpeedUpgradePowerLaws = config.get(CATEGORY_PROCESSORS, "speed_upgrade_power_laws_fp", new double[] {1D, 2D}, Lang.localise("gui.nc.config.processors.speed_upgrade_power_laws_fp.comment"), 1D, 15D);
		propertySpeedUpgradePowerLaws.setLanguageKey("gui.nc.config.processors.speed_upgrade_power_laws_fp");
		Property propertySpeedUpgradeMultipliers = config.get(CATEGORY_PROCESSORS, "speed_upgrade_multipliers_fp", new double[] {1D, 1D}, Lang.localise("gui.nc.config.processors.speed_upgrade_multipliers_fp.comment"), 0D, 15D);
		propertySpeedUpgradeMultipliers.setLanguageKey("gui.nc.config.processors.speed_upgrade_multipliers_fp");
		Property propertyEnergyUpgradePowerLaws = config.get(CATEGORY_PROCESSORS, "energy_upgrade_power_laws_fp", new double[] {1D}, Lang.localise("gui.nc.config.processors.energy_upgrade_power_laws_fp.comment"), 1D, 15D);
		propertyEnergyUpgradePowerLaws.setLanguageKey("gui.nc.config.processors.energy_upgrade_power_laws_fp");
		Property propertyEnergyUpgradeMultipliers = config.get(CATEGORY_PROCESSORS, "energy_upgrade_multipliers_fp", new double[] {1D}, Lang.localise("gui.nc.config.processors.energy_upgrade_multipliers_fp.comment"), 0D, 15D);
		propertyEnergyUpgradeMultipliers.setLanguageKey("gui.nc.config.processors.energy_upgrade_multipliers_fp");
		Property propertyRFPerEU = config.get(CATEGORY_PROCESSORS, "rf_per_eu", 16, Lang.localise("gui.nc.config.processors.rf_per_eu.comment"), 1, 2000);
		propertyRFPerEU.setLanguageKey("gui.nc.config.processors.rf_per_eu");
		Property propertyEnableGTCEEU = config.get(CATEGORY_PROCESSORS, "enable_gtce_eu", true, Lang.localise("gui.nc.config.processors.enable_gtce_eu.comment"));
		propertyEnableGTCEEU.setLanguageKey("gui.nc.config.processors.enable_gtce_eu");
		Property propertyEnableMekGas = config.get(CATEGORY_PROCESSORS, "enable_mek_gas", true, Lang.localise("gui.nc.config.processors.enable_mek_gas.comment"));
		...
		Property propertyManufactoryWood = config.get(CATEGORY_PROCESSORS, "manufactory_wood", new int[] {6, 4}, Lang.localise("gui.nc.config.processors.manufactory_wood.comment"), 1, 64);
		propertyManufactoryWood.setLanguageKey("gui.nc.config.processors.manufactory_wood");
		Property propertyRockCrusherAlternate = config.get(CATEGORY_PROCESSORS, "rock_crusher_alternate", false, Lang.localise("gui.nc.config.processors.rock_crusher_alternate.comment"));
		propertyRockCrusherAlternate.setLanguageKey("gui.nc.config.processors.rock_crusher_alternate");
		Property propertyGTCERecipes = config.get(CATEGORY_PROCESSORS, "gtce_recipe_integration", new boolean[] {true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}, Lang.localise("gui.nc.config.processors.gtce_recipe_integration.comment"));
		propertyGTCERecipes.setLanguageKey("gui.nc.config.processors.gtce_recipe_integration");
		Property propertyGTCERecipeLogging = config.get(CATEGORY_PROCESSORS, "gtce_recipe_logging", false, Lang.localise("gui.nc.config.processors.gtce_recipe_logging.comment"));
		propertyGTCERecipeLogging.setLanguageKey("gui.nc.config.processors.gtce_recipe_logging");
		Property propertySmartProcessorInput = config.get(CATEGORY_PROCESSORS, "smart_processor_input", true, Lang.localise("gui.nc.config.processors.smart_processor_input.comment"));
		...
		Property propertyRTGPower = config.get(CATEGORY_GENERATORS, "rtg_power", new int[] {4, 100, 50, 400}, Lang.localise("gui.nc.config.generators.rtg_power.comment"), 1, Integer.MAX_VALUE);
		propertyRTGPower.setLanguageKey("gui.nc.config.generators.rtg_power");
		Property propertySolarPower = config.get(CATEGORY_GENERATORS, "solar_power", new int[] {5, 20, 80, 320}, Lang.localise("gui.nc.config.generators.solar_power.comment"), 1, Integer.MAX_VALUE);
		...
		propertyFissionSparsityPenaltyParams.setLanguageKey("gui.nc.config.fission.fission_sparsity_penalty_params");
		Property propertyFissionOverheat = config.get(CATEGORY_FISSION, "fission_overheat", true, Lang.localise("gui.nc.config.fission.fission_overheat.comment"));
		propertyFissionOverheat.setLanguageKey("gui.nc.config.fission.fission_overheat");
		Property propertyFissionExplosions = config.get(CATEGORY_FISSION, "fission_explosions", false, Lang.localise("gui.nc.config.fission.fission_explosions.comment"));
		propertyFissionExplosions.setLanguageKey("gui.nc.config.fission.fission_explosions");
		Property propertyFissionMeltdownRadiationMultiplier = config.get(CATEGORY_FISSION, "fission_meltdown_radiation_multiplier", 1D, Lang.localise("gui.nc.config.fission.fission_meltdown_radiation_multiplier.comment"), 0D, 255D);
		propertyFissionMeltdownRadiationMultiplier.setLanguageKey("gui.nc.config.fission.fission_meltdown_radiation_multiplier");
		Property propertyFissionMinSize = config.get(CATEGORY_FISSION, "fission_min_size", 1, Lang.localise("gui.nc.config.fission.fission_min_size.comment"), 1, 255);
		propertyFissionMinSize.setLanguageKey("gui.nc.config.fission.fission_min_size");
		Property propertyFissionMaxSize = config.get(CATEGORY_FISSION, "fission_max_size", 24, Lang.localise("gui.nc.config.fission.fission_max_size.comment"), 1, 255);
		propertyFissionMaxSize.setLanguageKey("gui.nc.config.fission.fission_max_size");
		Property propertyFissionComparatorMaxTemp = config.get(CATEGORY_FISSION, "fission_comparator_max_temp", 1600, Lang.localise("gui.nc.config.fission.fission_comparator_max_temp.comment"), 20, 2400);
		...
		Property propertyFissionThoriumSelfPriming = config.get(CATEGORY_FISSION, "fission_thorium_self_priming", new boolean[] {false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_thorium_self_priming.comment"));
		propertyFissionThoriumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_thorium_self_priming");
		Property propertyFissionThoriumRadiation = config.get(CATEGORY_FISSION, "fission_thorium_radiation", new double[] {RadSources.TBU_FISSION, RadSources.TBU_FISSION, RadSources.TBU_FISSION, RadSources.TBU_FISSION, RadSources.TBU_FISSION}, Lang.localise("gui.nc.config.fission.fission_thorium_radiation.comment"), 0D, 1000D);
		propertyFissionThoriumRadiation.setLanguageKey("gui.nc.config.fission.fission_thorium_radiation");
		
		Property propertyFissionUraniumFuelTime = config.get(CATEGORY_FISSION, "fission_uranium_fuel_time", new int[] {2666, 2666, 3348, 2134, 3348, 2666, 2666, 3348, 2134, 3348, 4800, 4800, 6000, 3840, 6000, 4800, 4800, 6000, 3840, 6000}, Lang.localise("gui.nc.config.fission.fission_uranium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionUraniumSelfPriming = config.get(CATEGORY_FISSION, "fission_uranium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_uranium_self_priming.comment"));
		propertyFissionUraniumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_uranium_self_priming");
		Property propertyFissionUraniumRadiation = config.get(CATEGORY_FISSION, "fission_uranium_radiation", new double[] {RadSources.LEU_233_FISSION, RadSources.LEU_233_FISSION, RadSources.LEU_233_FISSION, RadSources.LEU_233_FISSION, RadSources.LEU_233_FISSION, RadSources.HEU_233_FISSION, RadSources.HEU_233_FISSION, RadSources.HEU_233_FISSION, RadSources.HEU_233_FISSION, RadSources.HEU_233_FISSION, RadSources.LEU_235_FISSION, RadSources.LEU_235_FISSION, RadSources.LEU_235_FISSION, RadSources.LEU_235_FISSION, RadSources.LEU_235_FISSION, RadSources.HEU_235_FISSION, RadSources.HEU_235_FISSION, RadSources.HEU_235_FISSION, RadSources.HEU_235_FISSION, RadSources.HEU_235_FISSION}, Lang.localise("gui.nc.config.fission.fission_uranium_radiation.comment"), 0D, 1000D);
		propertyFissionUraniumRadiation.setLanguageKey("gui.nc.config.fission.fission_uranium_radiation");
		
		Property propertyFissionNeptuniumFuelTime = config.get(CATEGORY_FISSION, "fission_neptunium_fuel_time", new int[] {1972, 1972, 2462, 1574, 2462, 1972, 1972, 2462, 1574, 2462}, Lang.localise("gui.nc.config.fission.fission_neptunium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionNeptuniumSelfPriming = config.get(CATEGORY_FISSION, "fission_neptunium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_neptunium_self_priming.comment"));
		propertyFissionNeptuniumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_neptunium_self_priming");
		Property propertyFissionNeptuniumRadiation = config.get(CATEGORY_FISSION, "fission_neptunium_radiation", new double[] {RadSources.LEN_236_FISSION, RadSources.LEN_236_FISSION, RadSources.LEN_236_FISSION, RadSources.LEN_236_FISSION, RadSources.LEN_236_FISSION, RadSources.HEN_236_FISSION, RadSources.HEN_236_FISSION, RadSources.HEN_236_FISSION, RadSources.HEN_236_FISSION, RadSources.HEN_236_FISSION}, Lang.localise("gui.nc.config.fission.fission_neptunium_radiation.comment"), 0D, 1000D);
		propertyFissionNeptuniumRadiation.setLanguageKey("gui.nc.config.fission.fission_neptunium_radiation");
		
		Property propertyFissionPlutoniumFuelTime = config.get(CATEGORY_FISSION, "fission_plutonium_fuel_time", new int[] {4572, 4572, 5760, 3646, 5760, 4572, 4572, 5760, 3646, 5760, 3164, 3164, 3946, 2526, 3946, 3164, 3164, 3946, 2526, 3946}, Lang.localise("gui.nc.config.fission.fission_plutonium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionPlutoniumSelfPriming = config.get(CATEGORY_FISSION, "fission_plutonium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_plutonium_self_priming.comment"));
		propertyFissionPlutoniumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_plutonium_self_priming");
		Property propertyFissionPlutoniumRadiation = config.get(CATEGORY_FISSION, "fission_plutonium_radiation", new double[] {RadSources.LEP_239_FISSION, RadSources.LEP_239_FISSION, RadSources.LEP_239_FISSION, RadSources.LEP_239_FISSION, RadSources.LEP_239_FISSION, RadSources.HEP_239_FISSION, RadSources.HEP_239_FISSION, RadSources.HEP_239_FISSION, RadSources.HEP_239_FISSION, RadSources.HEP_239_FISSION, RadSources.LEP_241_FISSION, RadSources.LEP_241_FISSION, RadSources.LEP_241_FISSION, RadSources.LEP_241_FISSION, RadSources.LEP_241_FISSION, RadSources.HEP_241_FISSION, RadSources.HEP_241_FISSION, RadSources.HEP_241_FISSION, RadSources.HEP_241_FISSION, RadSources.HEP_241_FISSION}, Lang.localise("gui.nc.config.fission.fission_plutonium_radiation.comment"), 0D, 1000D);
		...
		Property propertyFissionMixedSelfPriming = config.get(CATEGORY_FISSION, "fission_mixed_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_mixed_self_priming.comment"));
		propertyFissionMixedSelfPriming.setLanguageKey("gui.nc.config.fission.fission_mixed_self_priming");
		Property propertyFissionMixedRadiation = config.get(CATEGORY_FISSION, "fission_mixed_radiation", new double[] {RadSources.MIX_239_FISSION, RadSources.MIX_239_FISSION, RadSources.MIX_239_FISSION, RadSources.MIX_239_FISSION, RadSources.MIX_239_FISSION, RadSources.MIX_241_FISSION, RadSources.MIX_241_FISSION, RadSources.MIX_241_FISSION, RadSources.MIX_241_FISSION, RadSources.MIX_241_FISSION}, Lang.localise("gui.nc.config.fission.fission_mixed_radiation.comment"), 0D, 1000D);
		propertyFissionMixedRadiation.setLanguageKey("gui.nc.config.fission.fission_mixed_radiation");
		
		Property propertyFissionAmericiumFuelTime = config.get(CATEGORY_FISSION, "fission_americium_fuel_time", new int[] {1476, 1476, 1846, 1180, 1846, 1476, 1476, 1846, 1180, 1846}, Lang.localise("gui.nc.config.fission.fission_americium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionAmericiumSelfPriming = config.get(CATEGORY_FISSION, "fission_americium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_americium_self_priming.comment"));
		propertyFissionAmericiumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_americium_self_priming");
		Property propertyFissionAmericiumRadiation = config.get(CATEGORY_FISSION, "fission_americium_radiation", new double[] {RadSources.LEA_242_FISSION, RadSources.LEA_242_FISSION, RadSources.LEA_242_FISSION, RadSources.LEA_242_FISSION, RadSources.LEA_242_FISSION, RadSources.HEA_242_FISSION, RadSources.HEA_242_FISSION, RadSources.HEA_242_FISSION, RadSources.HEA_242_FISSION, RadSources.HEA_242_FISSION}, Lang.localise("gui.nc.config.fission.fission_americium_radiation.comment"), 0D, 1000D);
		propertyFissionAmericiumRadiation.setLanguageKey("gui.nc.config.fission.fission_americium_radiation");
		
		Property propertyFissionCuriumFuelTime = config.get(CATEGORY_FISSION, "fission_curium_fuel_time", new int[] {1500, 1500, 1870, 1200, 1870, 1500, 1500, 1870, 1200, 1870, 2420, 2420, 3032, 1932, 3032, 2420, 2420, 3032, 1932, 3032, 2150, 2150, 2692, 1714, 2692, 2150, 2150, 2692, 1714, 2692}, Lang.localise("gui.nc.config.fission.fission_curium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionCuriumSelfPriming = config.get(CATEGORY_FISSION, "fission_curium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_curium_self_priming.comment"));
		propertyFissionCuriumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_curium_self_priming");
		Property propertyFissionCuriumRadiation = config.get(CATEGORY_FISSION, "fission_curium_radiation", new double[] {RadSources.LECm_243_FISSION, RadSources.LECm_243_FISSION, RadSources.LECm_243_FISSION, RadSources.LECm_243_FISSION, RadSources.LECm_243_FISSION, RadSources.HECm_243_FISSION, RadSources.HECm_243_FISSION, RadSources.HECm_243_FISSION, RadSources.HECm_243_FISSION, RadSources.HECm_243_FISSION, RadSources.LECm_245_FISSION, RadSources.LECm_245_FISSION, RadSources.LECm_245_FISSION, RadSources.LECm_245_FISSION, RadSources.LECm_245_FISSION, RadSources.HECm_245_FISSION, RadSources.HECm_245_FISSION, RadSources.HECm_245_FISSION, RadSources.HECm_245_FISSION, RadSources.HECm_245_FISSION, RadSources.LECm_247_FISSION, RadSources.LECm_247_FISSION, RadSources.LECm_247_FISSION, RadSources.LECm_247_FISSION, RadSources.LECm_247_FISSION, RadSources.HECm_247_FISSION, RadSources.HECm_247_FISSION, RadSources.HECm_247_FISSION, RadSources.HECm_247_FISSION, RadSources.HECm_247_FISSION}, Lang.localise("gui.nc.config.fission.fission_curium_radiation.comment"), 0D, 1000D);
		propertyFissionCuriumRadiation.setLanguageKey("gui.nc.config.fission.fission_curium_radiation");
		
		Property propertyFissionBerkeliumFuelTime = config.get(CATEGORY_FISSION, "fission_berkelium_fuel_time", new int[] {2166, 2166, 2716, 1734, 2716, 2166, 2166, 2716, 1734, 2716}, Lang.localise("gui.nc.config.fission.fission_berkelium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionBerkeliumSelfPriming = config.get(CATEGORY_FISSION, "fission_berkelium_self_priming", new boolean[] {false, false, false, false, false, false, false, false, false, false}, Lang.localise("gui.nc.config.fission.fission_berkelium_self_priming.comment"));
		propertyFissionBerkeliumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_berkelium_self_priming");
		Property propertyFissionBerkeliumRadiation = config.get(CATEGORY_FISSION, "fission_berkelium_radiation", new double[] {RadSources.LEB_248_FISSION, RadSources.LEB_248_FISSION, RadSources.LEB_248_FISSION, RadSources.LEB_248_FISSION, RadSources.LEB_248_FISSION, RadSources.HEB_248_FISSION, RadSources.HEB_248_FISSION, RadSources.HEB_248_FISSION, RadSources.HEB_248_FISSION, RadSources.HEB_248_FISSION}, Lang.localise("gui.nc.config.fission.fission_berkelium_radiation.comment"), 0D, 1000D);
		propertyFissionBerkeliumRadiation.setLanguageKey("gui.nc.config.fission.fission_berkelium_radiation");
		
		Property propertyFissionCaliforniumFuelTime = config.get(CATEGORY_FISSION, "fission_californium_fuel_time", new int[] {1066, 1066, 1334, 852, 1334, 1066, 1066, 1334, 852, 1334, 2000, 2000, 2504, 1600, 2504, 2000, 2000, 2504, 1600, 2504}, Lang.localise("gui.nc.config.fission.fission_californium_fuel_time.comment"), 1, Integer.MAX_VALUE);
		...
		Property propertyFissionCaliforniumSelfPriming = config.get(CATEGORY_FISSION, "fission_californium_self_priming", new boolean[] {true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}, Lang.localise("gui.nc.config.fission.fission_californium_self_priming.comment"));
		propertyFissionCaliforniumSelfPriming.setLanguageKey("gui.nc.config.fission.fission_californium_self_priming");
		Property propertyFissionCaliforniumRadiation = config.get(CATEGORY_FISSION, "fission_californium_radiation", new double[] {RadSources.LECf_249_FISSION, RadSources.LECf_249_FISSION, RadSources.LECf_249_FISSION, RadSources.LECf_249_FISSION, RadSources.LECf_249_FISSION, RadSources.HECf_249_FISSION, RadSources.HECf_249_FISSION, RadSources.HECf_249_FISSION, RadSources.HECf_249_FISSION, RadSources.HECf_249_FISSION, RadSources.LECf_251_FISSION, RadSources.LECf_251_FISSION, RadSources.LECf_251_FISSION, RadSources.LECf_251_FISSION, RadSources.LECf_251_FISSION, RadSources.HECf_251_FISSION, RadSources.HECf_251_FISSION, RadSources.HECf_251_FISSION, RadSources.HECf_251_FISSION, RadSources.HECf_251_FISSION}, Lang.localise("gui.nc.config.fission.fission_californium_radiation.comment"), 0D, 1000D);
		propertyFissionCaliforniumRadiation.setLanguageKey("gui.nc.config.fission.fission_californium_radiation");
		
		Property propertyFusionBasePower = config.get(CATEGORY_FUSION, "fusion_base_power", 1D, Lang.localise("gui.nc.config.fusion.fusion_base_power.comment"), 0D, 255D);
		propertyFusionBasePower.setLanguageKey("gui.nc.config.fusion.fusion_base_power");
		Property propertyFusionFuelUse = config.get(CATEGORY_FUSION, "fusion_fuel_use", 1D, Lang.localise("gui.nc.config.fusion.fusion_fuel_use.comment"), 0.001D, 255D);
		propertyFusionFuelUse.setLanguageKey("gui.nc.config.fusion.fusion_fuel_use");
		Property propertyFusionHeatGeneration = config.get(CATEGORY_FUSION, "fusion_heat_generation", 1D, Lang.localise("gui.nc.config.fusion.fusion_heat_generation.comment"), 0D, 255D);
		propertyFusionHeatGeneration.setLanguageKey("gui.nc.config.fusion.fusion_heat_generation");
		Property propertyFusionHeatingMultiplier = config.get(CATEGORY_FUSION, "fusion_heating_multiplier", 1D, Lang.localise("gui.nc.config.fusion.fusion_heating_multiplier.comment"), 0D, 255D);
		propertyFusionHeatingMultiplier.setLanguageKey("gui.nc.config.fusion.fusion_heating_multiplier");
		Property propertyFusionOverheat = config.get(CATEGORY_FUSION, "fusion_overheat", true, Lang.localise("gui.nc.config.fusion.fusion_overheat.comment"));
		propertyFusionOverheat.setLanguageKey("gui.nc.config.fusion.fusion_overheat");
		Property propertyFusionMeltdownRadiationMultiplier = config.get(CATEGORY_FUSION, "fusion_meltdown_radiation_multiplier", 1D, Lang.localise("gui.nc.config.fusion.fusion_meltdown_radiation_multiplier.comment"), 0D, 255D);
		propertyFusionMeltdownRadiationMultiplier.setLanguageKey("gui.nc.config.fusion.fusion_meltdown_radiation_multiplier");
		Property propertyFusionMinSize = config.get(CATEGORY_FUSION, "fusion_min_size", 1, Lang.localise("gui.nc.config.fusion.fusion_min_size.comment"), 1, 255);
		propertyFusionMinSize.setLanguageKey("gui.nc.config.fusion.fusion_min_size");
		Property propertyFusionMaxSize = config.get(CATEGORY_FUSION, "fusion_max_size", 24, Lang.localise("gui.nc.config.fusion.fusion_max_size.comment"), 1, 255);
		...
		Property propertyFusionPower = config.get(CATEGORY_FUSION, "fusion_power", new double[] {442D, 1123D, 0.3D, 3036D, 351D, 1330D, 444D, 507D, 1726D, 2252D, 1716D, 859D, 261D, 901D, 1099D, 915D, 435D, 7D, 1315D, 1151D, 727D, 140D, 1068D, 552D, 157D, 229D, 0.45D, 0.05D}, Lang.localise("gui.nc.config.fusion.fusion_power.comment"), 0D, 32767D);
		propertyFusionPower.setLanguageKey("gui.nc.config.fusion.fusion_power");
		Property propertyFusionHeatVariable = config.get(CATEGORY_FUSION, "fusion_heat_variable", new double[] {3635D, 1022D, 4964D, 2740D, 5972D, 4161D, 13432D, 949D, 670D, 2160D, 3954D, 4131D, 13853D, 736D, 2137D, 4079D, 4522D, 27254D, 5420D, 7800D, 7937D, 24266D, 11268D, 11927D, 30399D, 13630D, 166414D, 293984D}, Lang.localise("gui.nc.config.fusion.fusion_heat_variable.comment"), 500D, 20000D);
		propertyFusionHeatVariable.setLanguageKey("gui.nc.config.fusion.fusion_heat_variable");
		Property propertyFusionRadiation = config.get(CATEGORY_FUSION, "fusion_radiation", new double[] {RadSources.FUSION/64D, RadSources.FUSION/64D, (RadSources.FUSION + RadSources.TRITIUM + RadSources.NEUTRON)/64D, RadSources.FUSION/64D, (RadSources.FUSION + RadSources.TRITIUM)/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, (RadSources.FUSION + RadSources.TRITIUM/2D + RadSources.NEUTRON/2D)/64D, (RadSources.FUSION + RadSources.TRITIUM + RadSources.NEUTRON)/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.TRITIUM + 2*RadSources.NEUTRON)/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.NEUTRON)/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, RadSources.FUSION/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.NEUTRON)/64D, (RadSources.FUSION + 2*RadSources.NEUTRON)/64D}, Lang.localise("gui.nc.config.fusion.fusion_radiation.comment"), 0D, 1000D);
		propertyFusionRadiation.setLanguageKey("gui.nc.config.fusion.fusion_radiation");
		...
		Property propertyTurbineMinSize = config.get(CATEGORY_TURBINE, "turbine_min_size", 1, Lang.localise("gui.nc.config.turbine.turbine_min_size.comment"), 1, 255);
		...
		Property propertyTurbineStatorExpansion = config.get(CATEGORY_TURBINE, "turbine_stator_expansion", 0.75D, Lang.localise("gui.nc.config.turbine.turbine_stator_expansion.comment"), 0.01D, 1D);
		...
		Property propertyTurbineThroughputEfficiencyLeniency = config.get(CATEGORY_TURBINE, "turbine_throughput_efficiency_leniency", 1D, Lang.localise("gui.nc.config.turbine.turbine_throughput_efficiency_leniency.comment"), 0D, 255D);
		propertyTurbineThroughputEfficiencyLeniency.setLanguageKey("gui.nc.config.turbine.turbine_throughput_efficiency_leniency");
		Property propertyTurbineTensionThroughputFactor = config.get(CATEGORY_TURBINE, "turbine_tension_throughput_factor", 2D, Lang.localise("gui.nc.config.turbine.turbine_tension_throughput_factor.comment"), 1D, 255D);
		propertyTurbineTensionThroughputFactor.setLanguageKey("gui.nc.config.turbine.turbine_tension_throughput_factor");
		...
		propertyBatteryCapacity.setLanguageKey("gui.nc.config.energy_storage.battery_capacity");
		
		Property propertyToolMiningLevel = config.get(CATEGORY_TOOLS, "tool_mining_level", new int[] {2, 2, 3, 3, 3, 3, 4, 4}, Lang.localise("gui.nc.config.tools.tool_mining_level.comment"), 0, 15);
		propertyToolMiningLevel.setLanguageKey("gui.nc.config.tools.tool_mining_level");
		Property propertyToolDurability = config.get(CATEGORY_TOOLS, "tool_durability", new int[] {547, 547*5, 929, 929*5, 1245, 1245*5, 1928, 1928*5}, Lang.localise("gui.nc.config.tools.tool_durability.comment"), 1, 32767);
		propertyToolDurability.setLanguageKey("gui.nc.config.tools.tool_durability");
		Property propertyToolSpeed = config.get(CATEGORY_TOOLS, "tool_speed", new double[] {8D, 8D, 10D, 10D, 11D, 11D, 12D, 12D}, Lang.localise("gui.nc.config.tools.tool_speed.comment"), 1D, 255D);
		propertyToolSpeed.setLanguageKey("gui.nc.config.tools.tool_speed");
		Property propertyToolAttackDamage = config.get(CATEGORY_TOOLS, "tool_attack_damage", new double[] {2.5D, 2.5D, 3D, 3D, 3D, 3D, 3.5D, 3.5D}, Lang.localise("gui.nc.config.tools.tool_attack_damage.comment"), 0D, 255D);
		propertyToolAttackDamage.setLanguageKey("gui.nc.config.tools.tool_attack_damage");
		Property propertyToolEnchantability = config.get(CATEGORY_TOOLS, "tool_enchantability", new int[] {6, 6, 15, 15, 12, 12, 20, 20}, Lang.localise("gui.nc.config.tools.tool_enchantability.comment"), 1, 255);
		propertyToolEnchantability.setLanguageKey("gui.nc.config.tools.tool_enchantability");
		Property propertyToolHandleModifier = config.get(CATEGORY_TOOLS, "tool_handle_modifier", new double[] {0.85D, 1.1D, 1D, 0.75D}, Lang.localise("gui.nc.config.tools.tool_handle_modifier.comment"), 0.01D, 10D);
		propertyToolHandleModifier.setLanguageKey("gui.nc.config.tools.tool_handle_modifier");
		Property propertyToolTiCRegister = config.get(CATEGORY_TOOLS, "tool_tic_register", new boolean[] {true, true, true, true, true, true, true, true}, Lang.localise("gui.nc.config.tools.tool_tic_register.comment"));
		propertyToolTiCRegister.setLanguageKey("gui.nc.config.tools.tool_tic_register");
		
		Property propertyArmorDurability = config.get(CATEGORY_ARMOR, "armor_durability", new int[] {22, 30, 34, 42, 0}, Lang.localise("gui.nc.config.armor.armor_durability.comment"), 1, 127);
		propertyArmorDurability.setLanguageKey("gui.nc.config.armor.armor_durability");
		Property propertyArmorBoron = config.get(CATEGORY_ARMOR, "armor_boron", new int[] {2, 5, 7, 3}, Lang.localise("gui.nc.config.armor.armor_boron.comment"), 1, 25);
		propertyArmorBoron.setLanguageKey("gui.nc.config.armor.armor_boron");
		Property propertyArmorTough = config.get(CATEGORY_ARMOR, "armor_tough", new int[] {3, 6, 7, 3}, Lang.localise("gui.nc.config.armor.armor_tough.comment"), 1, 25);
		propertyArmorTough.setLanguageKey("gui.nc.config.armor.armor_tough");
		Property propertyArmorHardCarbon = config.get(CATEGORY_ARMOR, "armor_hard_carbon", new int[] {3, 5, 7, 3}, Lang.localise("gui.nc.config.armor.armor_hard_carbon.comment"), 1, 25);
		propertyArmorHardCarbon.setLanguageKey("gui.nc.config.armor.armor_hard_carbon");
		Property propertyArmorBoronNitride = config.get(CATEGORY_ARMOR, "armor_boron_nitride", new int[] {3, 6, 8, 3}, Lang.localise("gui.nc.config.armor.armor_boron_nitride.comment"), 1, 25);
		propertyArmorBoronNitride.setLanguageKey("gui.nc.config.armor.armor_boron_nitride");
		Property propertyArmorHazmat = config.get(CATEGORY_ARMOR, "armor_hazmat", new int[] {3, 6, 7, 3}, Lang.localise("gui.nc.config.armor.armor_hazmat.comment"), 1, 25);
		propertyArmorHazmat.setLanguageKey("gui.nc.config.armor.armor_hazmat");
		Property propertyArmorEnchantability = config.get(CATEGORY_ARMOR, "armor_enchantability", new int[] {6, 15, 12, 20, 5}, Lang.localise("gui.nc.config.armor.armor_enchantability.comment"), 1, 255);
		propertyArmorEnchantability.setLanguageKey("gui.nc.config.armor.armor_enchantability");
		Property propertyArmorToughness = config.get(CATEGORY_ARMOR, "armor_toughness", new double[] {1D, 2D, 1D, 2D, 0D}, Lang.localise("gui.nc.config.armor.armor_toughness.comment"), 0D, 8D);
		propertyArmorToughness.setLanguageKey("gui.nc.config.armor.armor_toughness");
		Property propertyArmorConarmRegister = config.get(CATEGORY_ARMOR, "armor_conarm_register", new boolean[] {true, true, true, true, true, true, true, true}, Lang.localise("gui.nc.config.armor.armor_conarm_register.comment"));
		propertyArmorConarmRegister.setLanguageKey("gui.nc.config.armor.armor_conarm_register");
		
		Property propertyEntityRegister = config.get(CATEGORY_ENTITIES, "entity_register", new boolean[] {true}, Lang.localise("gui.nc.config.entities.entity_register.comment"));
		propertyEntityRegister.setLanguageKey("gui.nc.config.entities.entity_register");
		Property propertyEntityTrackingRange = config.get(CATEGORY_ENTITIES, "entity_tracking_range", 64, Lang.localise("gui.nc.config.entities.entity_tracking_range.comment"), 1, 255);
		propertyEntityTrackingRange.setLanguageKey("gui.nc.config.entities.entity_tracking_range");
		
		Property propertyRadiationEnabled = config.get(CATEGORY_RADIATION, "radiation_enabled", true, Lang.localise("gui.nc.config.radiation.radiation_enabled.comment"));
		propertyRadiationEnabled.setLanguageKey("gui.nc.config.radiation.radiation_enabled");
		
		Property propertyRadiationWorldChunksPerTick = config.get(CATEGORY_RADIATION, "radiation_world_chunks_per_tick", 5, Lang.localise("gui.nc.config.radiation.radiation_world_chunks_per_tick.comment"), 1, 400);
		propertyRadiationWorldChunksPerTick.setLanguageKey("gui.nc.config.radiation.radiation_world_chunks_per_tick");
		Property propertyRadiationPlayerTickRate = config.get(CATEGORY_RADIATION, "radiation_player_tick_rate", 5, Lang.localise("gui.nc.config.radiation.radiation_player_tick_rate.comment"), 1, 400);
		propertyRadiationPlayerTickRate.setLanguageKey("gui.nc.config.radiation.radiation_player_tick_rate");
		
		Property propertyRadiationWorlds = config.get(CATEGORY_RADIATION, "radiation_worlds", new String[] {"4598_2.25"}, Lang.localise("gui.nc.config.radiation.radiation_worlds.comment"));
		propertyRadiationWorlds.setLanguageKey("gui.nc.config.radiation.radiation_worlds");
		Property propertyRadiationBiomes = config.get(CATEGORY_RADIATION, "radiation_biomes", new String[] {"nuclearcraft:nuclear_wasteland_0.25"}, Lang.localise("gui.nc.config.radiation.radiation_biomes.comment"));
		propertyRadiationBiomes.setLanguageKey("gui.nc.config.radiation.radiation_biomes");
		Property propertyRadiationStructures = config.get(CATEGORY_RADIATION, "radiation_structures", new String[] {"Fortress_0.0025", "Mineshaft_0.00005", "Stronghold_0.001"}, Lang.localise("gui.nc.config.radiation.radiation_structures.comment"));
		propertyRadiationStructures.setLanguageKey("gui.nc.config.radiation.radiation_structures");
		Property propertyRadiationWorldLimit = config.get(CATEGORY_RADIATION, "radiation_world_limits", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_world_limits.comment"));
		propertyRadiationWorldLimit.setLanguageKey("gui.nc.config.radiation.radiation_world_limits");
		Property propertyRadiationBiomeLimit = config.get(CATEGORY_RADIATION, "radiation_biome_limits", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_biome_limits.comment"));
		propertyRadiationBiomeLimit.setLanguageKey("gui.nc.config.radiation.radiation_biome_limits");
		Property propertyRadiationFromBiomesDimsBlacklist = config.get(CATEGORY_RADIATION, "radiation_from_biomes_dims_blacklist", new int[] {144}, Lang.localise("gui.nc.config.radiation.radiation_from_biomes_dims_blacklist.comment"));
		propertyRadiationFromBiomesDimsBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_from_biomes_dims_blacklist");
		
		Property propertyRadiationOres = config.get(CATEGORY_RADIATION, "radiation_ores", new String[] {"depletedFuelIC2U_" + (RadSources.URANIUM_238*4D + RadSources.PLUTONIUM_239/9D), "depletedFuelIC2MOX_" + (RadSources.PLUTONIUM_239*28D/9D)}, Lang.localise("gui.nc.config.radiation.radiation_ores.comment"));
		propertyRadiationOres.setLanguageKey("gui.nc.config.radiation.radiation_ores");
		Property propertyRadiationItems = config.get(CATEGORY_RADIATION, "radiation_items", new String[] {"ic2:nuclear:0_0.000000000048108553", "ic2:nuclear:1_" + RadSources.URANIUM_235, "ic2:nuclear:2_" + RadSources.URANIUM_238, "ic2:nuclear:3_" + RadSources.PLUTONIUM_239, "ic2:nuclear:4_0.000000833741517857143", "ic2:nuclear:5_" + (RadSources.URANIUM_235/9D), "ic2:nuclear:6_" + (RadSources.URANIUM_238/9D), "ic2:nuclear:7_" + (RadSources.PLUTONIUM_239/9D), "ic2:nuclear:8_0.000000000048108553", "ic2:nuclear:9_0.000000833741517857143", "ic2:nuclear:10_" + (RadSources.PLUTONIUM_238*3D), "ic2:nuclear:11_" + (RadSources.URANIUM_238*4D + RadSources.PLUTONIUM_239/9D), "ic2:nuclear:12_" + ((RadSources.URANIUM_238*4D + RadSources.PLUTONIUM_239/9D)*2D), "ic2:nuclear:13_" + ((RadSources.URANIUM_238*4D + RadSources.PLUTONIUM_239/9D)*4D), "ic2:nuclear:14_" + (RadSources.PLUTONIUM_239*28D/9D), "ic2:nuclear:15_" + (RadSources.PLUTONIUM_239*2D*28D/9D), "ic2:nuclear:16_" + (RadSources.PLUTONIUM_239*4D*28D/9D)}, Lang.localise("gui.nc.config.radiation.radiation_items.comment"));
		propertyRadiationItems.setLanguageKey("gui.nc.config.radiation.radiation_items");
		Property propertyRadiationBlocks = config.get(CATEGORY_RADIATION, "radiation_blocks", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_blocks.comment"));
		propertyRadiationBlocks.setLanguageKey("gui.nc.config.radiation.radiation_blocks");
		Property propertyRadiationFluids = config.get(CATEGORY_RADIATION, "radiation_fluids", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_fluids.comment"));
		propertyRadiationFluids.setLanguageKey("gui.nc.config.radiation.radiation_fluids");
		Property propertyRadiationFoods = config.get(CATEGORY_RADIATION, "radiation_foods", new String[] {"minecraft:golden_apple:0_-20_0.1", "minecraft:golden_apple:1_-100_0.5", "minecraft:golden_carrot:0_-4_0", "minecraft:spider_eye:0_0_0.5", "minecraft:poisonous_potato:0_0_0.5", "minecraft:fish:3_0_2", "minecraft:rabbit_stew:0_0_0.1", "minecraft:chorus_fruit:0_0_-0.25", "minecraft:beetroot:0_0_0.25", "minecraft:beetroot_soup:0_0_1.5", "quark:golden_frog_leg:0_-4_0"}, Lang.localise("gui.nc.config.radiation.radiation_foods.comment"));
		propertyRadiationFoods.setLanguageKey("gui.nc.config.radiation.radiation_foods");
		Property propertyRadiationOresBlacklist = config.get(CATEGORY_RADIATION, "radiation_ores_blacklist", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_ores_blacklist.comment"));
		propertyRadiationOresBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_ores_blacklist");
		Property propertyRadiationItemsBlacklist = config.get(CATEGORY_RADIATION, "radiation_items_blacklist", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_items_blacklist.comment"));
		propertyRadiationItemsBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_items_blacklist");
		Property propertyRadiationBlocksBlacklist = config.get(CATEGORY_RADIATION, "radiation_blocks_blacklist", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_blocks_blacklist.comment"));
		propertyRadiationBlocksBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_blocks_blacklist");
		Property propertyRadiationFluidsBlacklist = config.get(CATEGORY_RADIATION, "radiation_fluids_blacklist", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_fluids_blacklist.comment"));
		propertyRadiationFluidsBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_fluids_blacklist");
		
		Property propertyRadiationMaxPlayerRads = config.get(CATEGORY_RADIATION, "max_player_rads", 1000D, Lang.localise("gui.nc.config.radiation.max_player_rads.comment"), 1D, 1000000000D);
		...
		propertyRadiationSpreadRate.setLanguageKey("gui.nc.config.radiation.radiation_spread_rate");
		Property propertyRadiationSpreadGradient = config.get(CATEGORY_RADIATION, "radiation_spread_gradient", 0.5D, Lang.localise("gui.nc.config.radiation.radiation_spread_gradient.comment"), 0D, 1000000000D);
		propertyRadiationSpreadGradient.setLanguageKey("gui.nc.config.radiation.radiation_spread_gradient");
		Property propertyRadiationDecayRate = config.get(CATEGORY_RADIATION, "radiation_decay_rate", 0.001D, Lang.localise("gui.nc.config.radiation.radiation_decay_rate.comment"), 0D, 1D);
		propertyRadiationDecayRate.setLanguageKey("gui.nc.config.radiation.radiation_decay_rate");
		Property propertyRadiationLowestRate = config.get(CATEGORY_RADIATION, "radiation_lowest_rate", 0.000000000000001D, Lang.localise("gui.nc.config.radiation.radiation_lowest_rate.comment"), 0.000000000000000001D, 1D);
		propertyRadiationLowestRate.setLanguageKey("gui.nc.config.radiation.radiation_lowest_rate");
		...
		propertyRadiationRainMult.setLanguageKey("gui.nc.config.radiation.radiation_rain_mult");
		Property propertyRadiationSwimMult = config.get(CATEGORY_RADIATION, "radiation_swim_mult", 2D, Lang.localise("gui.nc.config.radiation.radiation_swim_mult.comment"), 0.000001D, 1000000D);
		propertyRadiationSwimMult.setLanguageKey("gui.nc.config.radiation.radiation_swim_mult");
		
		Property propertyRadiationRadawayAmount = config.get(CATEGORY_RADIATION, "radiation_radaway_amount", 300D, Lang.localise("gui.nc.config.radiation.radiation_radaway_amount.comment"), 0.001D, 1000000000D);
		propertyRadiationRadawayAmount.setLanguageKey("gui.nc.config.radiation.radiation_radaway_amount");
		Property propertyRadiationRadawaySlowAmount = config.get(CATEGORY_RADIATION, "radiation_radaway_slow_amount", 300D, Lang.localise("gui.nc.config.radiation.radiation_radaway_slow_amount.comment"), 0.001D, 1000000000D);
		propertyRadiationRadawaySlowAmount.setLanguageKey("gui.nc.config.radiation.radiation_radaway_slow_amount");
		Property propertyRadiationRadawayRate = config.get(CATEGORY_RADIATION, "radiation_radaway_rate", 5D, Lang.localise("gui.nc.config.radiation.radiation_radaway_rate.comment"), 0.001D, 1000000000D);
		propertyRadiationRadawayRate.setLanguageKey("gui.nc.config.radiation.radiation_radaway_rate");
		Property propertyRadiationRadawaySlowRate = config.get(CATEGORY_RADIATION, "radiation_radaway_slow_rate", 0.025D, Lang.localise("gui.nc.config.radiation.radiation_radaway_slow_rate.comment"), 0.00001D, 10000000D);
		propertyRadiationRadawaySlowRate.setLanguageKey("gui.nc.config.radiation.radiation_radaway_slow_rate");
		Property propertyRadiationPoisonTime = config.get(CATEGORY_RADIATION, "radiation_poison_time", 60D, Lang.localise("gui.nc.config.radiation.radiation_poison_time.comment"), 1D, 1000000D);
		propertyRadiationPoisonTime.setLanguageKey("gui.nc.config.radiation.radiation_poison_time");
		Property propertyRadiationRadawayCooldown = config.get(CATEGORY_RADIATION, "radiation_radaway_cooldown", 0D, Lang.localise("gui.nc.config.radiation.radiation_radaway_cooldown.comment"), 0D, 100000D);
		propertyRadiationRadawayCooldown.setLanguageKey("gui.nc.config.radiation.radiation_radaway_cooldown");
		Property propertyRadiationRadXAmount = config.get(CATEGORY_RADIATION, "radiation_rad_x_amount", 25D, Lang.localise("gui.nc.config.radiation.radiation_rad_x_amount.comment"), 0.001D, 1000000000D);
		propertyRadiationRadXAmount.setLanguageKey("gui.nc.config.radiation.radiation_rad_x_amount");
		Property propertyRadiationRadXLifetime = config.get(CATEGORY_RADIATION, "radiation_rad_x_lifetime", 12000D, Lang.localise("gui.nc.config.radiation.radiation_rad_x_lifetime.comment"), 20D, 1000000000D);
		propertyRadiationRadXLifetime.setLanguageKey("gui.nc.config.radiation.radiation_rad_x_lifetime");
		Property propertyRadiationRadXCooldown = config.get(CATEGORY_RADIATION, "radiation_rad_x_cooldown", 0D, Lang.localise("gui.nc.config.radiation.radiation_rad_x_cooldown.comment"), 0D, 100000D);
		propertyRadiationRadXCooldown.setLanguageKey("gui.nc.config.radiation.radiation_rad_x_cooldown");
		Property propertyRadiationShieldingLevel = config.get(CATEGORY_RADIATION, "radiation_shielding_level", new double[] {0.01D, 0.1D, 1D}, Lang.localise("gui.nc.config.radiation.radiation_shielding_level.comment"), 0.000000000000000001D, 1000D);
		propertyRadiationShieldingLevel.setLanguageKey("gui.nc.config.radiation.radiation_shielding_level");
		Property propertyRadiationTileShielding = config.get(CATEGORY_RADIATION, "radiation_tile_shielding", true, Lang.localise("gui.nc.config.radiation.radiation_tile_shielding.comment"));
		propertyRadiationTileShielding.setLanguageKey("gui.nc.config.radiation.radiation_tile_shielding");
		Property propertyRadiationScrubberRate = config.get(CATEGORY_RADIATION, "radiation_scrubber_fraction", 0.125D, Lang.localise("gui.nc.config.radiation.radiation_scrubber_fraction.comment"), 0.001D, 1D);
		...
		Property propertyRadiationShieldingDefaultRecipes = config.get(CATEGORY_RADIATION, "radiation_shielding_default_recipes", true, Lang.localise("gui.nc.config.radiation.radiation_shielding_default_recipes.comment"));
		propertyRadiationShieldingDefaultRecipes.setLanguageKey("gui.nc.config.radiation.radiation_shielding_default_recipes");
		Property propertyRadiationShieldingItemBlacklist = config.get(CATEGORY_RADIATION, "radiation_shielding_item_blacklist", new String[] {"nuclearcraft:helm_hazmat", "nuclearcraft:chest_hazmat", "nuclearcraft:legs_hazmat", "nuclearcraft:boots_hazmat", "ic2:hazmat_helmet", "ic2:hazmat_chestplate", "ic2:hazmat_leggings", "ic2:rubber_boots", "extraplanets:tier1_space_suit_helmet", "extraplanets:tier1_space_suit_chest", "extraplanets:tier1_space_suit_jetpack_chest", "extraplanets:tier1_space_suit_leggings", "extraplanets:tier1_space_suit_boots", "extraplanets:tier1_space_suit_gravity_boots", "extraplanets:tier2_space_suit_helmet", "extraplanets:tier2_space_suit_chest", "extraplanets:tier2_space_suit_jetpack_chest", "extraplanets:tier2_space_suit_leggings", "extraplanets:tier2_space_suit_boots", "extraplanets:tier2_space_suit_gravity_boots", "extraplanets:tier3_space_suit_helmet", "extraplanets:tier3_space_suit_chest", "extraplanets:tier3_space_suit_jetpack_chest", "extraplanets:tier3_space_suit_leggings", "extraplanets:tier3_space_suit_boots", "extraplanets:tier3_space_suit_gravity_boots", "extraplanets:tier4_space_suit_helmet", "extraplanets:tier4_space_suit_chest", "extraplanets:tier4_space_suit_jetpack_chest", "extraplanets:tier4_space_suit_leggings", "extraplanets:tier4_space_suit_boots", "extraplanets:tier4_space_suit_gravity_boots"}, Lang.localise("gui.nc.config.radiation.radiation_shielding_item_blacklist.comment"));
		propertyRadiationShieldingItemBlacklist.setLanguageKey("gui.nc.config.radiation.radiation_shielding_item_blacklist");
		Property propertyRadiationShieldingCustomStacks = config.get(CATEGORY_RADIATION, "radiation_shielding_custom_stacks", new String[] {}, Lang.localise("gui.nc.config.radiation.radiation_shielding_custom_stacks.comment"));
		propertyRadiationShieldingCustomStacks.setLanguageKey("gui.nc.config.radiation.radiation_shielding_custom_stacks");
		Property propertyRadiationShieldingDefaultLevels = config.get(CATEGORY_RADIATION, "radiation_shielding_default_levels", new String[] {"nuclearcraft:helm_hazmat_2.0", "nuclearcraft:chest_hazmat_3.0", "nuclearcraft:legs_hazmat_2.0", "nuclearcraft:boots_hazmat_2.0", "ic2:hazmat_helmet_2.0", "ic2:hazmat_chestplate_3.0", "ic2:hazmat_leggings_2.0", "ic2:rubber_boots_2.0", "ic2:quantum_helmet_2.0", "ic2:quantum_chestplate_3.0", "ic2:quantum_leggings_2.0", "ic2:quantum_boots_2.0", "gravisuite:gravichestplate_3.0", "ic2:itemarmorquantumhelmet_2.0", "ic2:itemarmorquantumchestplate_3.0", "ic2:itemarmorquantumlegs_2.0", "ic2:itemarmorquantumboots_2.0", "gravisuit:gravisuit_3.0", "gravisuit:nucleargravisuit_3.0", "extraplanets:tier1_space_suit_helmet_1.0", "extraplanets:tier1_space_suit_chest_1.5", "extraplanets:tier1_space_suit_jetpack_chest_1.5", "extraplanets:tier1_space_suit_leggings_1.0", "extraplanets:tier1_space_suit_boots_1.0", "extraplanets:tier1_space_suit_gravity_boots_1.0", "extraplanets:tier2_space_suit_helmet_1.3", "extraplanets:tier2_space_suit_chest_1.95", "extraplanets:tier2_space_suit_jetpack_chest_1.95", "extraplanets:tier2_space_suit_leggings_1.3", "extraplanets:tier2_space_suit_boots_1.3", "extraplanets:tier2_space_suit_gravity_boots_1.3", "extraplanets:tier3_space_suit_helmet_1.6", "extraplanets:tier3_space_suit_chest_2.4", "extraplanets:tier3_space_suit_jetpack_chest_2.4", "extraplanets:tier3_space_suit_leggings_1.6", "extraplanets:tier3_space_suit_boots_1.6", "extraplanets:tier3_space_suit_gravity_boots_1.6", "extraplanets:tier4_space_suit_helmet_2.0", "extraplanets:tier4_space_suit_chest_3.0", "extraplanets:tier4_space_suit_jetpack_chest_3.0", "extraplanets:tier4_space_suit_leggings_2.0", "extraplanets:tier4_space_suit_boots_2.0", "extraplanets:tier4_space_suit_gravity_boots_2.0"}, Lang.localise("gui.nc.config.radiation.radiation_shielding_default_levels.comment"));
		propertyRadiationShieldingDefaultLevels.setLanguageKey("gui.nc.config.radiation.radiation_shielding_default_levels");
		
		Property propertyRadiationHardcoreStacks = config.get(CATEGORY_RADIATION, "radiation_hardcore_stacks", true, Lang.localise("gui.nc.config.radiation.radiation_hardcore_stacks.comment"));
		propertyRadiationHardcoreStacks.setLanguageKey("gui.nc.config.radiation.radiation_hardcore_stacks");
		Property propertyRadiationHardcoreContainers = config.get(CATEGORY_RADIATION, "radiation_hardcore_containers", 0D, Lang.localise("gui.nc.config.radiation.radiation_hardcore_containers.comment"), 0D, 1D);
		propertyRadiationHardcoreContainers.setLanguageKey("gui.nc.config.radiation.radiation_hardcore_containers");
		Property propertyRadiationDroppedItems = config.get(CATEGORY_RADIATION, "radiation_dropped_items", true, Lang.localise("gui.nc.config.radiation.radiation_dropped_items.comment"));
		propertyRadiationDroppedItems.setLanguageKey("gui.nc.config.radiation.radiation_dropped_items");
		Property propertyRadiationDeathPersist = config.get(CATEGORY_RADIATION, "radiation_death_persist", true, Lang.localise("gui.nc.config.radiation.radiation_death_persist.comment"));
		propertyRadiationDeathPersist.setLanguageKey("gui.nc.config.radiation.radiation_death_persist");
		Property propertyRadiationDeathPersistFraction = config.get(CATEGORY_RADIATION, "radiation_death_persist_fraction", 0.75D, Lang.localise("gui.nc.config.radiation.radiation_death_persist_fraction.comment"), 0D, 1D);
		propertyRadiationDeathPersistFraction.setLanguageKey("gui.nc.config.radiation.radiation_death_persist_fraction");
		Property propertyRadiationDeathImmunityTime = config.get(CATEGORY_RADIATION, "radiation_death_immunity_time", 90D, Lang.localise("gui.nc.config.radiation.radiation_death_immunity_time.comment"), 0D, 3600D);
		propertyRadiationDeathImmunityTime.setLanguageKey("gui.nc.config.radiation.radiation_death_immunity_time");
		
		Property propertyRadiationPlayerDebuffLists = config.get(CATEGORY_RADIATION, "radiation_player_debuff_lists", new String[] {"40.0_minecraft:weakness@1", "55.0_minecraft:weakness@1,minecraft:mining_fatigue@1", "70.0_minecraft:weakness@2,minecraft:mining_fatigue@1,minecraft:hunger@1", "80.0_minecraft:weakness@2,minecraft:mining_fatigue@2,minecraft:hunger@1,minecraft:poison@1", "90.0_minecraft:weakness@3,minecraft:mining_fatigue@3,minecraft:hunger@2,minecraft:poison@1,minecraft:wither@1"}, Lang.localise("gui.nc.config.radiation.radiation_player_debuff_lists.comment"));
		propertyRadiationPlayerDebuffLists.setLanguageKey("gui.nc.config.radiation.radiation_player_debuff_lists");
		Property propertyRadiationPassiveDebuffLists = config.get(CATEGORY_RADIATION, "radiation_passive_debuff_lists", new String[] {"40.0_minecraft:weakness@1", "55.0_minecraft:weakness@1,minecraft:mining_fatigue@1", "70.0_minecraft:weakness@2,minecraft:mining_fatigue@1,minecraft:hunger@1", "80.0_minecraft:weakness@2,minecraft:mining_fatigue@2,minecraft:hunger@1,minecraft:poison@1", "90.0_minecraft:weakness@3,minecraft:mining_fatigue@3,minecraft:hunger@2,minecraft:poison@1,minecraft:wither@1"}, Lang.localise("gui.nc.config.radiation.radiation_passive_debuff_lists.comment"));
		propertyRadiationPassiveDebuffLists.setLanguageKey("gui.nc.config.radiation.radiation_passive_debuff_lists");
		Property propertyRadiationMobBuffLists = config.get(CATEGORY_RADIATION, "radiation_mob_buff_lists", new String[] {"40.0_minecraft:speed@1", "55.0_minecraft:speed@1,minecraft:strength@1", "70.0_minecraft:speed@1,minecraft:strength@1,minecraft:resistance@1", "80.0_minecraft:speed@1,minecraft:strength@1,minecraft:resistance@1,minecraft:absorption@1", "90.0_minecraft:speed@1,minecraft:strength@1,minecraft:resistance@1,minecraft:absorption@1,minecraft:regeneration@1"}, Lang.localise("gui.nc.config.radiation.radiation_mob_buff_lists.comment"));
		propertyRadiationMobBuffLists.setLanguageKey("gui.nc.config.radiation.radiation_mob_buff_lists");
		
		Property propertyRadiationHorseArmor = config.get(CATEGORY_RADIATION, "radiation_horse_armor", false, Lang.localise("gui.nc.config.radiation.radiation_horse_armor.comment"));
		propertyRadiationHorseArmor.setLanguageKey("gui.nc.config.radiation.radiation_horse_armor");
		
		Property propertyRadiationHUDSize = config.get(CATEGORY_RADIATION, "radiation_hud_size", 1D, Lang.localise("gui.nc.config.radiation.radiation_hud_size.comment"), 0.1D, 10D);
		propertyRadiationHUDSize.setLanguageKey("gui.nc.config.radiation.radiation_hud_size");
		Property propertyRadiationHUDPosition = config.get(CATEGORY_RADIATION, "radiation_hud_position", 225D, Lang.localise("gui.nc.config.radiation.radiation_hud_position.comment"), 0D, 360D);
		propertyRadiationHUDPosition.setLanguageKey("gui.nc.config.radiation.radiation_hud_position");
		Property propertyRadiationHUDPositionCartesian = config.get(CATEGORY_RADIATION, "radiation_hud_position_cartesian", new double[] {}, Lang.localise("gui.nc.config.radiation.radiation_hud_position_cartesian.comment"), 0D, 1D);
		propertyRadiationHUDPositionCartesian.setLanguageKey("gui.nc.config.radiation.radiation_hud_position_cartesian");
		Property propertyRadiationHUDTextOutline = config.get(CATEGORY_RADIATION, "radiation_hud_text_outline", false, Lang.localise("gui.nc.config.radiation.radiation_hud_text_outline.comment"));
		propertyRadiationHUDTextOutline.setLanguageKey("gui.nc.config.radiation.radiation_hud_text_outline");
		Property propertyRadiationRequireCounter = config.get(CATEGORY_RADIATION, "radiation_require_counter", true, Lang.localise("gui.nc.config.radiation.radiation_require_counter.comment"));
		propertyRadiationRequireCounter.setLanguageKey("gui.nc.config.radiation.radiation_require_counter");
		Property propertyRadiationChunkBoundaries = config.get(CATEGORY_RADIATION, "radiation_chunk_boundaries", true, Lang.localise("gui.nc.config.radiation.radiation_chunk_boundaries.comment"));
		propertyRadiationChunkBoundaries.setLanguageKey("gui.nc.config.radiation.radiation_chunk_boundaries");
		Property propertyRadiationUnitPrefixes = config.get(CATEGORY_RADIATION, "radiation_unit_prefixes", 0, Lang.localise("gui.nc.config.radiation.radiation_unit_prefixes.comment"), 0, 15);
		propertyRadiationUnitPrefixes.setLanguageKey("gui.nc.config.radiation.radiation_unit_prefixes");
		
		Property propertyRadiationBadgeDurability = config.get(CATEGORY_RADIATION, "radiation_badge_durability", 250D, Lang.localise("gui.nc.config.radiation.radiation_badge_durability.comment"), 0.000000000000000001D, 1000D);
		propertyRadiationBadgeDurability.setLanguageKey("gui.nc.config.radiation.radiation_badge_durability");
		Property propertyRadiationBadgeInfoRate = config.get(CATEGORY_RADIATION, "radiation_badge_info_rate", 0.1D, Lang.localise("gui.nc.config.radiation.radiation_badge_info_rate.comment"), 0.000000000000000001D, 1D);
		propertyRadiationBadgeInfoRate.setLanguageKey("gui.nc.config.radiation.radiation_badge_info_rate");
		
		Property propertySingleCreativeTab = config.get(CATEGORY_OTHER, "single_creative_tab", false, Lang.localise("gui.nc.config.other.single_creative_tab.comment"));
		propertySingleCreativeTab.setLanguageKey("gui.nc.config.other.single_creative_tab");
		
		Property propertyRegisterProcessor = config.get(CATEGORY_OTHER, "register_processor", new boolean[] {true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true}, Lang.localise("gui.nc.config.other.register_processor.comment"));
		propertyRegisterProcessor.setLanguageKey("gui.nc.config.other.register_processor");
		Property propertyRegisterPassive = config.get(CATEGORY_OTHER, "register_passive", new boolean[] {true, true, true}, Lang.localise("gui.nc.config.other.register_passive.comment"));
		propertyRegisterPassive.setLanguageKey("gui.nc.config.other.register_passive");
		Property propertyRegisterTool = config.get(CATEGORY_OTHER, "register_tool", new boolean[] {true, true, true, true}, Lang.localise("gui.nc.config.other.register_tool.comment"));
		propertyRegisterTool.setLanguageKey("gui.nc.config.other.register_tool");
		Property propertyRegisterArmor = config.get(CATEGORY_OTHER, "register_armor", new boolean[] {true, true, true, true}, Lang.localise("gui.nc.config.other.register_armor.comment"));
		propertyRegisterArmor.setLanguageKey("gui.nc.config.other.register_armor");
		
		Property propertyCtrlInfo = config.get(CATEGORY_OTHER, "ctrl_info", false, Lang.localise("gui.nc.config.other.ctrl_info.comment"));
		propertyCtrlInfo.setLanguageKey("gui.nc.config.other.ctrl_info");
		
		Property propertyJEIChanceItemsIncludeNull = config.get(CATEGORY_OTHER, "jei_chance_items_include_null", false, Lang.localise("gui.nc.config.other.jei_chance_items_include_null.comment"));
		propertyJEIChanceItemsIncludeNull.setLanguageKey("gui.nc.config.other.jei_chance_items_include_null");
		
		Property propertyRareDrops = config.get(CATEGORY_OTHER, "rare_drops", false, Lang.localise("gui.nc.config.other.rare_drops.comment"));
		propertyRareDrops.setLanguageKey("gui.nc.config.other.rare_drops");
		Property propertyDungeonLoot = config.get(CATEGORY_OTHER, "dungeon_loot", true, Lang.localise("gui.nc.config.other.dungeon_loot.comment"));
		propertyDungeonLoot.setLanguageKey("gui.nc.config.other.dungeon_loot");
		
		Property propertyWastelandBiome = config.get(CATEGORY_OTHER, "wasteland_biome", true, Lang.localise("gui.nc.config.other.wasteland_biome.comment"));
		propertyWastelandBiome.setLanguageKey("gui.nc.config.other.wasteland_biome");
		Property propertyWastelandBiomeWeight = config.get(CATEGORY_OTHER, "wasteland_biome_weight", 5, Lang.localise("gui.nc.config.other.wasteland_biome_weight.comment"), 0, 255);
		propertyWastelandBiomeWeight.setLanguageKey("gui.nc.config.other.wasteland_biome_weight");
		
		Property propertyWastelandDimensionGen = config.get(CATEGORY_OTHER, "wasteland_dimension_gen", true, Lang.localise("gui.nc.config.other.wasteland_dimension_gen.comment"));
		propertyWastelandDimensionGen.setLanguageKey("gui.nc.config.other.wasteland_dimension_gen");
		Property propertyWastelandDimension = config.get(CATEGORY_OTHER, "wasteland_dimension", 4598, Lang.localise("gui.nc.config.other.wasteland_dimension.comment"), Integer.MIN_VALUE, Integer.MAX_VALUE);
		propertyWastelandDimension.setLanguageKey("gui.nc.config.other.wasteland_dimension");
		
		Property propertyMushroomSpreadRate = config.get(CATEGORY_OTHER, "mushroom_spread_rate", 16, Lang.localise("gui.nc.config.other.mushroom_spread_rate.comment"), 0, 511);
		propertyMushroomSpreadRate.setLanguageKey("gui.nc.config.other.mushroom_spread_rate");
		Property propertyMushroomGen = config.get(CATEGORY_OTHER, "mushroom_gen", true, Lang.localise("gui.nc.config.other.mushroom_gen.comment"));
		propertyMushroomGen.setLanguageKey("gui.nc.config.other.mushroom_gen");
		Property propertyMushroomGenSize = config.get(CATEGORY_OTHER, "mushroom_gen_size", 64, Lang.localise("gui.nc.config.other.mushroom_gen_size.comment"), 0, 511);
		propertyMushroomGenSize.setLanguageKey("gui.nc.config.other.mushroom_gen_size");
		Property propertyMushroomGenRate = config.get(CATEGORY_OTHER, "mushroom_gen_rate", 40, Lang.localise("gui.nc.config.other.mushroom_gen_rate.comment"), 0, 511);
		propertyMushroomGenRate.setLanguageKey("gui.nc.config.other.mushroom_gen_rate");
		
		Property propertyRegisterFluidBlocks = config.get(CATEGORY_OTHER, "register_fluid_blocks", false, Lang.localise("gui.nc.config.other.register_fluid_blocks.comment"));
		propertyRegisterFluidBlocks.setLanguageKey("gui.nc.config.other.register_fluid_blocks");
		Property propertyRegisterCoFHFluids = config.get(CATEGORY_OTHER, "register_cofh_fluids", false, Lang.localise("gui.nc.config.other.register_cofh_fluids.comment"));
		propertyRegisterCoFHFluids.setLanguageKey("gui.nc.config.other.register_cofh_fluids");
