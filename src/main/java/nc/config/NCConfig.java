...
public class NCConfig {
    ...
    private static void outputNCPF(){
        ...
        ncpf.addFissionCasing("nuclearcraft:fission_casing", "Reactor Casing", "overhaul/casing", true);
        ncpf.addFissionCasing("nuclearcraft:fission_glass", "Reactor Glass", "overhaul/glass", false);
        ncpf.addFissionSource("nuclearcraft:fission_source:0", "Ra-Be Neutron Source", "overhaul/ra-be", (float) fission_source_efficiency[0]);
        ncpf.addFissionSource("nuclearcraft:fission_source:1", "Po-Be Neutron Source", "overhaul/po-be", (float) fission_source_efficiency[1]);
        ncpf.addFissionSource("nuclearcraft:fission_source:2", "Cf-252 Neutron Source", "overhaul/cf-252", (float) fission_source_efficiency[2]);
        ncpf.addFissionIrradiator("nuclearcraft:fission_irradiator", "Neutron Irradiator", "overhaul/irradiator", "nuclearcraft:fission_irradiator_port", "Neutron Irradiator Port (Input)", "overhaul/irradiator_port_input", "Neutron Irradiator Port (Output)", "overhaul/irradiator_port_output");
        ncpf.addFissionConductor("nuclearcraft:fission_conductor", "Conductor", "overhaul/conductor");
        ncpf.addFissionModerator("nuclearcraft:ingot_block:8", "Graphite Moderator", "overhaul/graphite", fission_moderator_flux_factor[0], (float)fission_moderator_efficiency[0]);
        ncpf.addFissionModerator("nuclearcraft:ingot_block:9", "Beryllium Moderator", "overhaul/beryllium", fission_moderator_flux_factor[1], (float)fission_moderator_efficiency[1]);
        ncpf.addFissionModerator("nuclearcraft:heavy_water_moderator", "Heavy Water Moderator", "overhaul/heavy water", fission_moderator_flux_factor[2], (float)fission_moderator_efficiency[2]);
        ncpf.addFissionReflector("nuclearcraft:fission_reflector:0", "Beryllium-Carbon Reflector", "overhaul/beryllium-carbon", (float)fission_reflector_efficiency[0], (float)fission_reflector_reflectivity[0]);
        ncpf.addFissionReflector("nuclearcraft:fission_reflector:1", "Lead-Steel Reflector", "overhaul/lead-steel", (float)fission_reflector_efficiency[1], (float)fission_reflector_reflectivity[1]);
        ncpf.addFissionNeutronShield("nuclearcraft:fission_shield:0", "Boron-Silver Neutron Shield", "overhaul/boron-silver", "overhaul/boron-silver_closed", (int)fission_shield_heat_per_flux[0], (float)fission_shield_efficiency[0]);
        ncpf.addFissionIrradiatorRecipe("nuclearcraft:dust:3", "Thorium Dust", "overhaul/item/thorium_dust", "nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", (float)fission_irradiator_efficiency[0], (float)fission_irradiator_heat_per_flux[0]);
        ncpf.addFissionIrradiatorRecipe("nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", "nuclearcraft:fission_dust:4", "Protactinium-233 Dust", "overhaul/item/protactinium_dust", (float)fission_irradiator_efficiency[1], (float)fission_irradiator_heat_per_flux[1]);
        ncpf.addFissionIrradiatorRecipe("nuclearcraft:fission_dust:0", "Bismuth Dust", "overhaul/item/bismuth_dust", "nuclearcraft:fission_dust:2", "Polonium Dust", "overhaul/item/polonium_dust", (float)fission_irradiator_efficiency[2], (float)fission_irradiator_heat_per_flux[2]);
//</editor-fold>
        //<editor-fold defaultstate="collapsed" desc="Fission SFR">
        ncpf.addSFRController("nuclearcraft:solid_fission_controller", "Solid Fission Controller", "overhaul/controller");
        ncpf.addSFRVent("nuclearcraft:fission_vent", "Vent (Input)", "overhaul/vent", "Vent (Output)", "overhaul/vent_output");
        ...
        double fuelTimeMult = fission_fuel_time_multiplier;
        ...
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:0", "Water Heat Sink", "overhaul/water", fission_sink_cooling_rate[0], fission_sink_rule[0]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:1", "Iron Heat Sink", "overhaul/iron", fission_sink_cooling_rate[1], fission_sink_rule[1]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:2", "Redstone Heat Sink", "overhaul/redstone", fission_sink_cooling_rate[2], fission_sink_rule[2]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:3", "Quartz Heat Sink", "overhaul/quartz", fission_sink_cooling_rate[3], fission_sink_rule[3]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:4", "Obsidian Heat Sink", "overhaul/obsidian", fission_sink_cooling_rate[4], fission_sink_rule[4]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:5", "Nether Brick Heat Sink", "overhaul/nether brick", fission_sink_cooling_rate[5], fission_sink_rule[5]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:6", "Glowstone Heat Sink", "overhaul/glowstone", fission_sink_cooling_rate[6], fission_sink_rule[6]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:7", "Lapis Heat Sink", "overhaul/lapis", fission_sink_cooling_rate[7], fission_sink_rule[7]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:8", "Gold Heat Sink", "overhaul/gold", fission_sink_cooling_rate[8], fission_sink_rule[8]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:9", "Prismarine Heat Sink", "overhaul/prismarine", fission_sink_cooling_rate[9], fission_sink_rule[9]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:10", "Slime Heat Sink", "overhaul/slime", fission_sink_cooling_rate[10], fission_sink_rule[10]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:11", "End Stone Heat Sink", "overhaul/end stone", fission_sink_cooling_rate[11], fission_sink_rule[11]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:12", "Purpur Heat Sink", "overhaul/purpur", fission_sink_cooling_rate[12], fission_sink_rule[12]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:13", "Diamond Heat Sink", "overhaul/diamond", fission_sink_cooling_rate[13], fission_sink_rule[13]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:14", "Emerald Heat Sink", "overhaul/emerald", fission_sink_cooling_rate[14], fission_sink_rule[14]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink:15", "Copper Heat Sink", "overhaul/copper", fission_sink_cooling_rate[15], fission_sink_rule[15]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:0", "Tin Heat Sink", "overhaul/tin", fission_sink_cooling_rate[16], fission_sink_rule[16]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:1", "Lead Heat Sink", "overhaul/lead", fission_sink_cooling_rate[17], fission_sink_rule[17]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:2", "Boron Heat Sink", "overhaul/boron", fission_sink_cooling_rate[18], fission_sink_rule[18]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:3", "Lithium Heat Sink", "overhaul/lithium", fission_sink_cooling_rate[19], fission_sink_rule[19]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:4", "Magnesium Heat Sink", "overhaul/magnesium", fission_sink_cooling_rate[20], fission_sink_rule[20]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:5", "Manganese Heat Sink", "overhaul/manganese", fission_sink_cooling_rate[21], fission_sink_rule[21]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:6", "Aluminum Heat Sink", "overhaul/aluminum", fission_sink_cooling_rate[22], fission_sink_rule[22]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:7", "Silver Heat Sink", "overhaul/silver", fission_sink_cooling_rate[23], fission_sink_rule[23]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:8", "Fluorite Heat Sink", "overhaul/fluorite", fission_sink_cooling_rate[24], fission_sink_rule[24]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:9", "Villiaumite Heat Sink", "overhaul/villiaumite", fission_sink_cooling_rate[25], fission_sink_rule[25]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:10", "Carobbiite Heat Sink", "overhaul/carobbiite", fission_sink_cooling_rate[26], fission_sink_rule[26]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:11", "Arsenic Heat Sink", "overhaul/arsenic", fission_sink_cooling_rate[27], fission_sink_rule[27]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:12", "Liquid Nitrogen Heat Sink", "overhaul/nitrogen", fission_sink_cooling_rate[28], fission_sink_rule[28]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:13", "Liquid Helium Heat Sink", "overhaul/helium", fission_sink_cooling_rate[29], fission_sink_rule[29]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:14", "Enderium Heat Sink", "overhaul/enderium", fission_sink_cooling_rate[30], fission_sink_rule[30]);
        ncpf.addSFRHeatsink("nuclearcraft:solid_fission_sink2:15", "Cryotheum Heat Sink", "overhaul/cryotheum", fission_sink_cooling_rate[31], fission_sink_rule[31]);
        ncpf.addSFRCell("nuclearcraft:solid_fission_cell", "Fuel Cell", "overhaul/cell", "nuclearcraft:fission_cell_port", "Fuel Cell Port (Input)", "overhaul/cell_port_input", "Fuel Cell Port (Output)", "overhaul/cell_port_output");
        ncpf.addSFRCoolantRecipe("water", "Water", "fluids/water", "high_pressure_steam", "High Pressure Steam", "fluids/hps", 64, 4);
        ncpf.addSFRCoolantRecipe("preheated_water", "Preheated Water", "fluids/preheated_water", "high_pressure_steam", "High Pressure Steam", "fluids/hps", 32, 4);
