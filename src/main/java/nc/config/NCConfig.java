...
import nc.ncpf.texture.ResourceLocationTextureProvider;
...
public class NCConfig {
	...
	private static void syncConfig(boolean loadFromFile, boolean setFromConfig) {
		...
		propertyFissionDecayLifetimes.setLanguageKey("gui.nc.config.fission_decay_lifetimes");
		Property propertyFissionDecayEquilibriumFactors = config.get(CATEGORY_FISSION, "fission_decay_equilibrium_factors", new double[] {1D, 5D, 1D}, Lang.localise("gui.nc.config.fission_decay_equilibrium_factors.comment"), 0D, 255D);
		propertyFissionDecayEquilibriumFactors.setLanguageKey("gui.nc.config.fission_decay_equilibrium_factors");
		Property propertyFissionDecayDaughterMultipliers = config.get(CATEGORY_FISSION, "fission_decay_daughter_multipliers", new double[] {5D, 5D}, Lang.localise("gui.nc.config.fission_decay_daughter_multipliers.comment"), 0D, 255D);
		...
		Property propertyHeatExchangerMaxSize = config.get(CATEGORY_HEAT_EXCHANGER, "heat_exchanger_max_size", 24, Lang.localise("gui.nc.config.heat_exchanger.heat_exchanger_max_size.comment"), 2, 255);
		...
		Property propertyHeatExchangerCoolantMult = config.get(CATEGORY_HEAT_EXCHANGER, "heat_exchanger_coolant_mult", 5D, Lang.localise("gui.nc.config.heat_exchanger.heat_exchanger_coolant_mult.comment"), Double.MIN_VALUE, Integer.MAX_VALUE);
		...
		Property propertyTurbineMaxSize = config.get(CATEGORY_TURBINE, "turbine_max_size", 24, Lang.localise("gui.nc.config.turbine_max_size.comment"), 3, 255);
		...
		propertyOrderFission.add(propertyFissionHeaterRule.getName());
		...
		propertyOrderTurbine.add(propertyTurbineCoilRule.getName());
		...
		propertyOrderMisc.add(propertyHWYLAEnabled.getName());
		...
		if (setFromConfig) {
			...
			fission_heater_rule = propertyFissionHeaterRule.getStringList();
			...
			turbine_coil_rule = propertyTurbineCoilRule.getStringList();
			...
			hwyla_enabled = propertyHWYLAEnabled.getBoolean();
		}
		...
		propertyFissionHeaterRule.set(fission_heater_rule);
		...
		propertyTurbineCoilRule.set(turbine_coil_rule);
    ...
    private static void outputNCPF(){
        try{
            ...
            //<editor-fold defaultstate="collapsed" desc="Fission">
            ncpf.addFissionCasing(NCBlocks.fission_casing.getRegistryName().toString(), NCBlocks.fission_casing.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.fission_casing.getRegistryName()), true);
            ncpf.addFissionCasing(NCBlocks.fission_glass.getRegistryName().toString(), NCBlocks.fission_glass.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.fission_glass.getRegistryName()), false);
            ncpf.addFissionSource(NCBlocks.fission_source.getRegistryName().toString()+":0", new ItemStack(NCBlocks.fission_source, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.fission_source.getRegistryName()), (float) fission_source_efficiency[0]);
            ncpf.addFissionSource(NCBlocks.fission_source.getRegistryName().toString()+":1", new ItemStack(NCBlocks.fission_source, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.fission_source.getRegistryName()), (float) fission_source_efficiency[1]);
            ncpf.addFissionSource(NCBlocks.fission_source.getRegistryName().toString()+":2", new ItemStack(NCBlocks.fission_source, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.fission_source.getRegistryName()), (float) fission_source_efficiency[2]);
            ncpf.addFissionIrradiator(NCBlocks.fission_irradiator.getRegistryName().toString(), NCBlocks.fission_irradiator.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.fission_irradiator.getRegistryName()), NCBlocks.fission_irradiator_port.getLocalizedName().toString(), NCBlocks.fission_irradiator_port.getLocalizedName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_irradiator_port.getRegistryName()), NCBlocks.fission_irradiator_port.getLocalizedName()+"(Output)", new ResourceLocationTextureProvider(NCBlocks.fission_irradiator_port.getRegistryName()));
            ncpf.addFissionConductor(NCBlocks.fission_conductor.getRegistryName().toString(), NCBlocks.fission_conductor.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.fission_conductor.getRegistryName()));
            for(BasicRecipe recipe : NCRecipes.fission_moderator.getRecipeList()){
                ItemStack input = recipe.getItemIngredients().get(0).getStack();
                ncpf.addFissionModerator(input.getItem().getRegistryName().toString()+(input.getItem().getHasSubtypes()?":"+input.getMetadata():""), input.getDisplayName(), new ResourceLocationTextureProvider(input.getItem().getRegistryName()), recipe.getFissionModeratorFluxFactor(), (float)recipe.getFissionModeratorEfficiency());
            }
            for(BasicRecipe recipe : NCRecipes.fission_reflector.getRecipeList()){
                ItemStack input = recipe.getItemIngredients().get(0).getStack();
                ncpf.addFissionReflector(input.getItem().getRegistryName().toString()+(input.getItem().getHasSubtypes()?":"+input.getMetadata():""), input.getDisplayName(), new ResourceLocationTextureProvider(input.getItem().getRegistryName()), (float)recipe.getFissionReflectorEfficiency(), (float)recipe.getFissionReflectorReflectivity());
            }
            ncpf.addFissionNeutronShield(NCBlocks.fission_shield.getRegistryName().toString()+":0", NCBlocks.fission_shield.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.fission_shield.getRegistryName()), new ResourceLocationTextureProvider(NCBlocks.fission_shield.getRegistryName()), (int)fission_shield_heat_per_flux[0], (float)fission_shield_efficiency[0]);
            for(BasicRecipe recipe : NCRecipes.fission_irradiator.getRecipeList()){
                ItemStack input = recipe.getItemIngredients().get(0).getStack();
                ItemStack output = recipe.getItemProducts().get(0).getStack();
                ncpf.addFissionIrradiatorRecipe(input.getItem().getRegistryName().toString()+(input.getItem().getHasSubtypes()?":"+input.getMetadata():""), input.getDisplayName(), new ResourceLocationTextureProvider(input.getItem().getRegistryName()), output.getItem().getRegistryName().toString()+(output.getItem().getHasSubtypes()?":"+output.getMetadata():""), output.getDisplayName(), new ResourceLocationTextureProvider(output.getItem().getRegistryName()), (float)recipe.getIrradiatorProcessEfficiency(), (float)recipe.getIrradiatorHeatPerFlux());
            }
    //</editor-fold>
            ...
            ncpf.addSFRController(NCBlocks.solid_fission_controller.getRegistryName().toString(), NCBlocks.solid_fission_controller.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_controller.getRegistryName()));
            ncpf.addSFRVent(NCBlocks.fission_vent.getRegistryName().toString(), NCBlocks.fission_vent.getLocalizedName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_vent.getRegistryName()), NCBlocks.fission_vent.getLocalizedName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_vent.getRegistryName()));
            ...
            sfrBlockMap.put("water_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":0", new ItemStack(NCBlocks.solid_fission_sink, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[0], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("water_sink"), sfrBlockMap);}));
            sfrBlockMap.put("iron_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":1", new ItemStack(NCBlocks.solid_fission_sink, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[1], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("iron_sink"), sfrBlockMap);}));
            sfrBlockMap.put("redstone_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":2", new ItemStack(NCBlocks.solid_fission_sink, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[2], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("redstone_sink"), sfrBlockMap);}));
            sfrBlockMap.put("quartz_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":3", new ItemStack(NCBlocks.solid_fission_sink, 1, 3).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[3], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("quartz_sink"), sfrBlockMap);}));
            sfrBlockMap.put("obsidian_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":4", new ItemStack(NCBlocks.solid_fission_sink, 1, 4).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[4], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("obsidian_sink"), sfrBlockMap);}));
            sfrBlockMap.put("nether_brick_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":5", new ItemStack(NCBlocks.solid_fission_sink, 1, 5).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[5], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("nether_brick_sink"), sfrBlockMap);}));
            sfrBlockMap.put("glowstone_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":6", new ItemStack(NCBlocks.solid_fission_sink, 1, 6).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[6], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("glowstone_sink"), sfrBlockMap);}));
            sfrBlockMap.put("lapis_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":7", new ItemStack(NCBlocks.solid_fission_sink, 1, 7).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[7], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("lapis_sink"), sfrBlockMap);}));
            sfrBlockMap.put("gold_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":8", new ItemStack(NCBlocks.solid_fission_sink, 1, 8).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[8], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("gold_sink"), sfrBlockMap);}));
            sfrBlockMap.put("prismarine_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":9", new ItemStack(NCBlocks.solid_fission_sink, 1, 9).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[9], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("prismarine_sink"), sfrBlockMap);}));
            sfrBlockMap.put("slime_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":10", new ItemStack(NCBlocks.solid_fission_sink, 1, 10).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[10], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("slime_sink"), sfrBlockMap);}));
            sfrBlockMap.put("end_stone_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":11", new ItemStack(NCBlocks.solid_fission_sink, 1, 11).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[11], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("end_stone_sink"), sfrBlockMap);}));
            sfrBlockMap.put("purpur_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":12", new ItemStack(NCBlocks.solid_fission_sink, 1, 12).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[12], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("purpur_sink"), sfrBlockMap);}));
            sfrBlockMap.put("diamond_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":13", new ItemStack(NCBlocks.solid_fission_sink, 1, 13).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[13], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("diamond_sink"), sfrBlockMap);}));
            sfrBlockMap.put("emerald_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":14", new ItemStack(NCBlocks.solid_fission_sink, 1, 14).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[14], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("emerald_sink"), sfrBlockMap);}));
            sfrBlockMap.put("copper_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink.getRegistryName().toString()+":15", new ItemStack(NCBlocks.solid_fission_sink, 1, 15).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink.getRegistryName()), fission_sink_cooling_rate[15], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("copper_sink"), sfrBlockMap);}));
            sfrBlockMap.put("tin_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":0", new ItemStack(NCBlocks.solid_fission_sink2, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[16], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("tin_sink"), sfrBlockMap);}));
            sfrBlockMap.put("lead_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":1", new ItemStack(NCBlocks.solid_fission_sink2, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[17], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("lead_sink"), sfrBlockMap);}));
            sfrBlockMap.put("boron_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":2", new ItemStack(NCBlocks.solid_fission_sink2, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[18], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("boron_sink"), sfrBlockMap);}));
            sfrBlockMap.put("lithium_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":3", new ItemStack(NCBlocks.solid_fission_sink2, 1, 3).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[19], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("lithium_sink"), sfrBlockMap);}));
            sfrBlockMap.put("magnesium_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":4", new ItemStack(NCBlocks.solid_fission_sink2, 1, 4).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[20], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("magnesium_sink"), sfrBlockMap);}));
            sfrBlockMap.put("manganese_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":5", new ItemStack(NCBlocks.solid_fission_sink2, 1, 5).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[21], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("manganese_sink"), sfrBlockMap);}));
            sfrBlockMap.put("aluminum_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":6", new ItemStack(NCBlocks.solid_fission_sink2, 1, 6).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[22], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("aluminum_sink"), sfrBlockMap);}));
            sfrBlockMap.put("silver_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":7", new ItemStack(NCBlocks.solid_fission_sink2, 1, 7).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[23], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("silver_sink"), sfrBlockMap);}));
            sfrBlockMap.put("fluorite_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":8", new ItemStack(NCBlocks.solid_fission_sink2, 1, 8).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[24], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("fluorite_sink"), sfrBlockMap);}));
            sfrBlockMap.put("villiaumite_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":9", new ItemStack(NCBlocks.solid_fission_sink2, 1, 9).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[25], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("villiaumite_sink"), sfrBlockMap);}));
            sfrBlockMap.put("carobbiite_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":10", new ItemStack(NCBlocks.solid_fission_sink2, 1, 10).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[26], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("carobbiite_sink"), sfrBlockMap);}));
            sfrBlockMap.put("arsenic_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":11", new ItemStack(NCBlocks.solid_fission_sink2, 1, 11).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[27], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("arsenic_sink"), sfrBlockMap);}));
            sfrBlockMap.put("liquid_nitrogen_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":12", new ItemStack(NCBlocks.solid_fission_sink2, 1, 12).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[28], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("liquid_nitrogen_sink"), sfrBlockMap);}));
            sfrBlockMap.put("liquid_helium_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":13", new ItemStack(NCBlocks.solid_fission_sink2, 1, 13).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[29], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("liquid_helium_sink"), sfrBlockMap);}));
            sfrBlockMap.put("enderium_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":14", new ItemStack(NCBlocks.solid_fission_sink2, 1, 14).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[30], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("enderium_sink"), sfrBlockMap);}));
            sfrBlockMap.put("cryotheum_sink", ncpf.addSFRHeatsink(NCBlocks.solid_fission_sink2.getRegistryName().toString()+":15", new ItemStack(NCBlocks.solid_fission_sink2, 1, 15).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_sink2.getRegistryName()), fission_sink_cooling_rate[31], ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get("cryotheum_sink"), sfrBlockMap);}));
            ncpf.addSFRCell(NCBlocks.solid_fission_cell.getRegistryName().toString(), NCBlocks.solid_fission_cell.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.solid_fission_cell.getRegistryName()), NCBlocks.fission_cell_port.getRegistryName().toString(), NCBlocks.fission_cell_port.getLocalizedName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_cell_port.getRegistryName()), NCBlocks.fission_cell_port.getLocalizedName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_cell_port.getRegistryName()));
            for(BasicRecipe recipe : NCRecipes.fission_heating.getRecipeList()){
                ...
                ncpf.addSFRCoolantRecipe(input.getFluid().getName(), input.getLocalizedName(), new ResourceLocationTextureProvider(input.getFluid().getStill()), output.getFluid().getName(), output.getLocalizedName(), new ResourceLocationTextureProvider(output.getFluid().getStill()), recipe.getFissionHeatingHeatPerInputMB(), output.amount/(float)input.amount);
            }
            for(BasicRecipe recipe : NCRecipes.solid_fission.getRecipeList()){
                ItemStack input = recipe.getItemIngredients().get(0).getStack();
                ItemStack output = recipe.getItemProducts().get(0).getStack();
                ncpf.addSFRFuel(input.getItem().getRegistryName().toString()+(input.getItem().getHasSubtypes()?":"+input.getMetadata():""), input.getDisplayName(), new ResourceLocationTextureProvider(input.getItem().getRegistryName()), output.getItem().getRegistryName().toString()+(output.getItem().getHasSubtypes()?":"+output.getMetadata():""), output.getDisplayName(), new ResourceLocationTextureProvider(output.getItem().getRegistryName()), (float)recipe.getFissionFuelEfficiency(), recipe.getFissionFuelHeat(), recipe.getFissionFuelTime(), recipe.getFissionFuelCriticality(), recipe.getFissionFuelSelfPriming());
            }
    //</editor-fold>
            ...
            ncpf.addMSRController(NCBlocks.salt_fission_controller.getRegistryName().toString(), NCBlocks.salt_fission_controller.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_controller.getRegistryName()));
            ...
            msrBlockMap.put("standard_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":0", new ItemStack(NCBlocks.salt_fission_heater, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("standard_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":0", new ItemStack(NCBlocks.fission_heater_port, 1, 0).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 0).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("iron_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":1", new ItemStack(NCBlocks.salt_fission_heater, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("iron_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":1", new ItemStack(NCBlocks.fission_heater_port, 1, 1).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 1).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("redstone_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":2", new ItemStack(NCBlocks.salt_fission_heater, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("redstone_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":2", new ItemStack(NCBlocks.fission_heater_port, 1, 2).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 2).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("quartz_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":3", new ItemStack(NCBlocks.salt_fission_heater, 1, 3).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("quartz_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":3", new ItemStack(NCBlocks.fission_heater_port, 1, 3).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 3).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("obsidian_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":4", new ItemStack(NCBlocks.salt_fission_heater, 1, 4).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("obsidian_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":4", new ItemStack(NCBlocks.fission_heater_port, 1, 4).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 4).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("nether_brick_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":5", new ItemStack(NCBlocks.salt_fission_heater, 1, 5).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("nether_brick_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":5", new ItemStack(NCBlocks.fission_heater_port, 1, 5).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 5).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("glowstone_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":6", new ItemStack(NCBlocks.salt_fission_heater, 1, 6).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("glowstone_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":6", new ItemStack(NCBlocks.fission_heater_port, 1, 6).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 6).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("lapis_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":7", new ItemStack(NCBlocks.salt_fission_heater, 1, 7).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("lapis_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":7", new ItemStack(NCBlocks.fission_heater_port, 1, 7).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 7).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("gold_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":8", new ItemStack(NCBlocks.salt_fission_heater, 1, 8).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("gold_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":8", new ItemStack(NCBlocks.fission_heater_port, 1, 8).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 8).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("prismarine_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":9", new ItemStack(NCBlocks.salt_fission_heater, 1, 9).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("prismarine_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":9", new ItemStack(NCBlocks.fission_heater_port, 1, 9).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 9).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("slime_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":10", new ItemStack(NCBlocks.salt_fission_heater, 1, 10).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("slime_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":10", new ItemStack(NCBlocks.fission_heater_port, 1, 10).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 10).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("end_stone_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":11", new ItemStack(NCBlocks.salt_fission_heater, 1, 11).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("end_stone_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":11", new ItemStack(NCBlocks.fission_heater_port, 1, 11).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 11).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("purpur_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":12", new ItemStack(NCBlocks.salt_fission_heater, 1, 12).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("purpur_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":12", new ItemStack(NCBlocks.fission_heater_port, 1, 12).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 12).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("diamond_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":13", new ItemStack(NCBlocks.salt_fission_heater, 1, 13).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("diamond_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":13", new ItemStack(NCBlocks.fission_heater_port, 1, 13).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 13).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("emerald_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":14", new ItemStack(NCBlocks.salt_fission_heater, 1, 14).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("emerald_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":14", new ItemStack(NCBlocks.fission_heater_port, 1, 14).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 14).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("copper_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater.getRegistryName().toString()+":15", new ItemStack(NCBlocks.salt_fission_heater, 1, 15).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("copper_heater"), msrBlockMap);}, NCBlocks.fission_heater_port.getRegistryName().toString()+":15", new ItemStack(NCBlocks.fission_heater_port, 1, 15).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port, 1, 15).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port.getRegistryName())));
            msrBlockMap.put("tin_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":0", new ItemStack(NCBlocks.salt_fission_heater2, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("tin_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":0", new ItemStack(NCBlocks.fission_heater_port2, 1, 0).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 0).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("lead_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":1", new ItemStack(NCBlocks.salt_fission_heater2, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("lead_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":1", new ItemStack(NCBlocks.fission_heater_port2, 1, 1).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 1).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("boron_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":2", new ItemStack(NCBlocks.salt_fission_heater2, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("boron_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":2", new ItemStack(NCBlocks.fission_heater_port2, 1, 2).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 2).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("lithium_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":3", new ItemStack(NCBlocks.salt_fission_heater2, 1, 3).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("lithium_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":3", new ItemStack(NCBlocks.fission_heater_port2, 1, 3).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 3).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("magnesium_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":4", new ItemStack(NCBlocks.salt_fission_heater2, 1, 4).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("magnesium_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":4", new ItemStack(NCBlocks.fission_heater_port2, 1, 4).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 4).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("manganese_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":5", new ItemStack(NCBlocks.salt_fission_heater2, 1, 5).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("manganese_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":5", new ItemStack(NCBlocks.fission_heater_port2, 1, 5).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 5).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("aluminum_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":6", new ItemStack(NCBlocks.salt_fission_heater2, 1, 6).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("aluminum_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":6", new ItemStack(NCBlocks.fission_heater_port2, 1, 6).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 6).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("silver_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":7", new ItemStack(NCBlocks.salt_fission_heater2, 1, 7).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("silver_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":7", new ItemStack(NCBlocks.fission_heater_port2, 1, 7).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 7).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("fluorite_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":8", new ItemStack(NCBlocks.salt_fission_heater2, 1, 8).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("fluorite_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":8", new ItemStack(NCBlocks.fission_heater_port2, 1, 8).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 8).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("villiaumite_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":9", new ItemStack(NCBlocks.salt_fission_heater2, 1, 9).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("villiaumite_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":9", new ItemStack(NCBlocks.fission_heater_port2, 1, 9).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 9).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("carobbiite_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":10", new ItemStack(NCBlocks.salt_fission_heater2, 1, 10).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("carobbiite_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":10", new ItemStack(NCBlocks.fission_heater_port2, 1, 10).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 10).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("arsenic_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":11", new ItemStack(NCBlocks.salt_fission_heater2, 1, 11).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("arsenic_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":11", new ItemStack(NCBlocks.fission_heater_port2, 1, 11).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 11).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("liquid_nitrogen_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":12", new ItemStack(NCBlocks.salt_fission_heater2, 1, 12).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("liquid_nitrogen_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":12", new ItemStack(NCBlocks.fission_heater_port2, 1, 12).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 12).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("liquid_helium_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":13", new ItemStack(NCBlocks.salt_fission_heater2, 1, 13).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("liquid_helium_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":13", new ItemStack(NCBlocks.fission_heater_port2, 1, 13).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 13).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("enderium_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":14", new ItemStack(NCBlocks.salt_fission_heater2, 1, 14).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("enderium_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":14", new ItemStack(NCBlocks.fission_heater_port2, 1, 14).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 14).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            msrBlockMap.put("cryotheum_heater", ncpf.addMSRHeater(NCBlocks.salt_fission_heater2.getRegistryName().toString()+":15", new ItemStack(NCBlocks.salt_fission_heater2, 1, 15).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_heater2.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get("cryotheum_heater"), msrBlockMap);}, NCBlocks.fission_heater_port2.getRegistryName().toString()+":15", new ItemStack(NCBlocks.fission_heater_port2, 1, 15).getDisplayName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName()), new ItemStack(NCBlocks.fission_heater_port2, 1, 15).getDisplayName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_heater_port2.getRegistryName())));
            ncpf.addMSRVessel(NCBlocks.salt_fission_vessel.getRegistryName().toString(), NCBlocks.salt_fission_vessel.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.salt_fission_vessel.getRegistryName()), NCBlocks.fission_vessel_port.getRegistryName().toString(), NCBlocks.fission_vessel_port.getLocalizedName()+" (Input)", new ResourceLocationTextureProvider(NCBlocks.fission_vessel_port.getRegistryName()), NCBlocks.fission_vessel_port.getLocalizedName()+" (Output)", new ResourceLocationTextureProvider(NCBlocks.fission_vessel_port.getRegistryName()));
            for(BasicRecipe recipe : NCRecipes.salt_fission.getRecipeList()){
                FluidStack input = recipe.getFluidIngredients().get(0).getStack();
                FluidStack output = recipe.getFluidProducts().get(0).getStack();
                ncpf.addMSRFuel(input.getFluid().getName(), input.getLocalizedName(), new ResourceLocationTextureProvider(input.getFluid().getStill()), output.getFluid().getName(), output.getLocalizedName(), new ResourceLocationTextureProvider(output.getFluid().getStill()), (float)recipe.getFissionFuelEfficiency(), recipe.getFissionFuelHeat(), (int)recipe.getSaltFissionFuelTime(), recipe.getFissionFuelCriticality(), recipe.getFissionFuelSelfPriming());
            }
    //</editor-fold>
            ...
            ncpf.addTurbineController(NCBlocks.turbine_controller.getRegistryName().toString(), NCBlocks.turbine_controller.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_controller.getRegistryName()));
            ncpf.addTurbineCasing(NCBlocks.turbine_casing.getRegistryName().toString(), NCBlocks.turbine_casing.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_casing.getRegistryName()), true);
            ncpf.addTurbineCasing(NCBlocks.turbine_glass.getRegistryName().toString(), NCBlocks.turbine_glass.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_glass.getRegistryName()), false);
            ncpf.addTurbineInlet(NCBlocks.turbine_inlet.getRegistryName().toString(), NCBlocks.turbine_inlet.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_inlet.getRegistryName()));
            ncpf.addTurbineOutlet(NCBlocks.turbine_outlet.getRegistryName().toString(), NCBlocks.turbine_outlet.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_outlet.getRegistryName()));
            ...
            ncpf.addTurbineBlade(NCBlocks.turbine_rotor_blade_steel.getRegistryName().toString(), NCBlocks.turbine_rotor_blade_steel.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_blade_steel.getRegistryName()), (float)turbine_blade_efficiency[0], (float)turbine_blade_expansion[0]);
            ncpf.addTurbineBlade(NCBlocks.turbine_rotor_blade_extreme.getRegistryName().toString(), NCBlocks.turbine_rotor_blade_extreme.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_blade_extreme.getRegistryName()), (float)turbine_blade_efficiency[1], (float)turbine_blade_expansion[1]);
            ncpf.addTurbineBlade(NCBlocks.turbine_rotor_blade_sic_sic_cmc.getRegistryName().toString(), NCBlocks.turbine_rotor_blade_sic_sic_cmc.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_blade_sic_sic_cmc.getRegistryName()), (float)turbine_blade_efficiency[2], (float)turbine_blade_expansion[2]);
            ncpf.addTurbineStator(NCBlocks.turbine_rotor_stator.getRegistryName().toString(), NCBlocks.turbine_rotor_stator.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_stator.getRegistryName()), (float)turbine_stator_expansion);
            turbineBlockMap.put("magnesium_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":0", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 0).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[0], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("magnesium_coil"), turbineBlockMap);}));
            turbineBlockMap.put("beryllium_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":1", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 1).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[1], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("beryllium_coil"), turbineBlockMap);}));
            turbineBlockMap.put("aluminum_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":2", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 2).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[2], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("aluminum_coil"), turbineBlockMap);}));
            turbineBlockMap.put("gold_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":3", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 3).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[3], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("gold_coil"), turbineBlockMap);}));
            turbineBlockMap.put("copper_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":4", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 4).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[4], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("copper_coil"), turbineBlockMap);}));
            turbineBlockMap.put("silver_coil", ncpf.addTurbineCoil(NCBlocks.turbine_dynamo_coil.getRegistryName().toString()+":5", new ItemStack(NCBlocks.turbine_dynamo_coil, 1, 5).getDisplayName(), new ResourceLocationTextureProvider(NCBlocks.turbine_dynamo_coil.getRegistryName()), (float)turbine_coil_conductivity[5], ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("silver_coil"), turbineBlockMap);}));
            turbineBlockMap.put("connector", ncpf.addTurbineConnector(NCBlocks.turbine_coil_connector.getRegistryName().toString(), NCBlocks.turbine_coil_connector.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_coil_connector.getRegistryName()), ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get("connector"), turbineBlockMap);}));
            ncpf.addTurbineBearing(NCBlocks.turbine_rotor_bearing.getRegistryName().toString(), NCBlocks.turbine_rotor_bearing.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_bearing.getRegistryName()));
            ncpf.addTurbineShaft(NCBlocks.turbine_rotor_shaft.getRegistryName().toString(), NCBlocks.turbine_rotor_shaft.getLocalizedName(), new ResourceLocationTextureProvider(NCBlocks.turbine_rotor_shaft.getRegistryName()));
            for(BasicRecipe recipe : NCRecipes.turbine.getRecipeList()){
                FluidStack input = recipe.getFluidIngredients().get(0).getStack();
                FluidStack output = recipe.getFluidProducts().get(0).getStack();
                ncpf.addTurbineRecipe(input.getFluid().getName(), input.getLocalizedName(), new ResourceLocationTextureProvider(input.getFluid().getStill()), output.getFluid().getName(), output.getLocalizedName(), new ResourceLocationTextureProvider(output.getFluid().getStill()), recipe.getTurbinePowerPerMB(), recipe.getTurbineExpansionLevel());
            }
    //</editor-fold>
            ...
            for(CTRegistration.RegistrationInfo info : CTRegistration.STICKY_INFO_LIST){
                if(info instanceof CTRegistration.FissionSinkRegistrationInfo){
                    ...
                    sfrBlockMap.put(sink.sinkID+"_sink", ncpf.addSFRHeatsink(sink.block.getRegistryName().toString(), sink.block.getLocalizedName(), new ResourceLocationTextureProvider(sink.block.getRegistryName()), sink.cooling, ()->{return ncpf.convertSFRRule(FissionPlacement.RULE_MAP.get(sink.sinkID+"_sink"), sfrBlockMap);}));
                }
                ...
                if(info instanceof CTRegistration.FissionHeaterRegistrationInfo){
                    ...
                    msrBlockMap.put(heater.heaterID+"_heater", ncpf.addMSRHeater(heater.block.getRegistryName().toString(), heater.block.getLocalizedName(), new ResourceLocationTextureProvider(heater.block.getRegistryName()), ()->{return ncpf.convertMSRRule(FissionPlacement.RULE_MAP.get(heater.heaterID+"_heater"), msrBlockMap);}, port.block.getRegistryName().toString(), port.block.getLocalizedName()+" (Input)", new ResourceLocationTextureProvider(port.block.getRegistryName()), port.block.getLocalizedName()+" (Output)", new ResourceLocationTextureProvider(port.block.getRegistryName())));
                }
                if(info instanceof CTRegistration.FissionSourceRegistrationInfo){
                    ...
                    ncpf.addFissionSource(source.block.getRegistryName().toString(), source.block.getLocalizedName(), new ResourceLocationTextureProvider(source.block.getRegistryName()), (float)source.efficiency);
                }
                if(info instanceof CTRegistration.FissionShieldRegistrationInfo){
                    ...
                    ncpf.addFissionNeutronShield(shield.block.getRegistryName().toString(), shield.block.getLocalizedName(), new ResourceLocationTextureProvider(shield.block.getRegistryName()), new ResourceLocationTextureProvider(shield.block.getRegistryName()), (int)shield.heatPerFlux, (float)shield.efficiency);
                }
                if(info instanceof CTRegistration.TurbineCoilRegistrationInfo){
                    ...
                    turbineBlockMap.put(coil.coilID+"_coil", ncpf.addTurbineCoil(coil.block.getRegistryName().toString(), coil.block.getLocalizedName(), new ResourceLocationTextureProvider(coil.block.getRegistryName()), (float)coil.conductivity, ()->{return ncpf.convertTurbineRule(TurbinePlacement.RULE_MAP.get(coil.coilID+"_coil"), turbineBlockMap);}));
                }
                if(info instanceof CTRegistration.TurbineBladeRegistrationInfo){
                    ...
                    ncpf.addTurbineBlade(blade.block.getRegistryName().toString(), blade.block.getLocalizedName(), new ResourceLocationTextureProvider(blade.block.getRegistryName()), (float)blade.efficiency, (float)blade.expansionCoefficient);
                }
                if(info instanceof CTRegistration.TurbineStatorRegistrationInfo){
                    ...
                    ncpf.addTurbineStator(stator.block.getRegistryName().toString(), stator.block.getLocalizedName(), new ResourceLocationTextureProvider(stator.block.getRegistryName()), (float)stator.expansionCoefficient);
                }
            }
            for(BasicRecipe recipe : NCRecipes.coolant_heater.getRecipeList()){
                FluidStack input = recipe.getFluidIngredients().get(0).getStack();
                FluidStack output = recipe.getFluidProducts().get(0).getStack();
                nc.ncpf.configuration.overhaul.fissionmsr.BlockRecipe br = nc.ncpf.configuration.overhaul.fissionmsr.BlockRecipe.heater(input.getFluid().getName(), input.getLocalizedName(), new ResourceLocationTextureProvider(input.getFluid().getStill()), output.getFluid().getName(), output.getLocalizedName(), new ResourceLocationTextureProvider(output.getFluid().getStill()), input.amount, output.amount, recipe.getCoolantHeaterCoolingRate());
