...
public abstract class SimplePacket<REQ extends SimplePacket<REQ, REPLY> , REPLY extends IMessage> implements IMessage, IMessageHandler<REQ, REPLY> {
	...
	public SimplePacket<REQ, REPLY> writeTileLocation(TileEntity tile) throws IOException, RuntimeException {
	...
	public SimplePacket<REQ, REPLY> writeByteArray(byte[] array) throws IOException, RuntimeException {
	...
	public SimplePacket<REQ, REPLY> writeByteArrayData(byte[] array) throws IOException {
		write.writeBytes(array);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeByte(byte b) throws IOException {
		write.writeByte(b);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeBoolean(boolean b) throws IOException {
		write.writeBoolean(b);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeString(String s) throws IOException {
		ByteBufUtils.writeUTF8String(write, s);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeShort(short s) throws IOException {
		write.writeShort(s);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeInt(int i) throws IOException {
		write.writeInt(i);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeDouble(double d) throws IOException {
		write.writeDouble(d);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeFloat(float f) throws IOException {
		write.writeFloat(f);
		return this;
	}
	
	public SimplePacket<REQ, REPLY> writeLong(long l) throws IOException {
		write.writeLong(l);
		return this;
	}
