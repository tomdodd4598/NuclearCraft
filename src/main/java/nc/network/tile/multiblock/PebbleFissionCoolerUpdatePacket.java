...
public class PebbleFissionCoolerUpdatePacket extends ProcessorUpdatePacket {
	
	public BlockPos masterPortPos;
	public List<TankInfo> filterTankInfos;
	public long clusterHeatStored, clusterHeatCapacity;
	
	public PebbleFissionCoolerUpdatePacket() {
		super();
	}
	
	public PebbleFissionCoolerUpdatePacket(BlockPos pos, boolean isProcessing, double time, double baseProcessTime, List<Tank> tanks, BlockPos masterPortPos, List<Tank> filterTanks, FissionCluster cluster) {
	...
	public static class Handler extends TileUpdatePacket.Handler<PebbleFissionCoolerUpdatePacket, ITilePacket<PebbleFissionCoolerUpdatePacket>> {}
}
