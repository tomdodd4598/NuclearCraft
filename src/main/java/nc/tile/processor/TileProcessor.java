...
public class TileProcessor {
	...
	public static class Irradiator extends TileFluidProcessor {
		...
		public Irradiator() {
			super("irradiator", 2, 2, defaultTankCapacities(16000, 2, 2), defaultTankSorptions(2, 2), Arrays.asList(RecipeHelper.validFluids(NCRecipes.Type.IRRADIATOR, Arrays.asList("neutron")).get(0), Arrays.asList("neutron"), new ArrayList<String>(), new ArrayList<String>()), NCConfig.processor_time[9], NCConfig.processor_power[9], false, NCRecipes.Type.IRRADIATOR, 10);
		}
	}
