...
public class TileProcessor {
	...
	public static class IsotopeSeparator extends TileItemProcessor {
		...
		public IsotopeSeparator() {
			super("isotope_separator", 1, 2, defaultItemSorptions(1, 2, true), NCConfig.processor_time[1], NCConfig.processor_power[1], false, NCRecipes.isotope_separator, 2, 0);
		}
	}
	...
	public static class FuelReprocessor extends TileItemProcessor {
		...
		public FuelReprocessor() {
			super("fuel_reprocessor", 1, 4, defaultItemSorptions(1, 4, true), NCConfig.processor_time[3], NCConfig.processor_power[3], false, NCRecipes.fuel_reprocessor, 4, 12);
		}
	}
	...
	public static class Irradiator extends TileFluidProcessor {
		...
		public Irradiator() {
			super("irradiator", 2, 2, defaultItemSorptions(true), defaultTankCapacities(16000, 2, 2), defaultTankSorptions(2, 2), NCRecipes.irradiator_valid_fluids, NCConfig.processor_time[9], NCConfig.processor_power[9], false, NCRecipes.irradiator, 10, 0);
		}
	}
