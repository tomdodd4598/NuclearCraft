...
public class ProcessorContainerInfoImpl {
	...
	public static class BasicProcessorContainerInfo<TILE extends TileBasicProcessor<TILE>> extends ProcessorContainerInfo<TILE, ProcessorUpdatePacket, BasicProcessorContainerInfo<TILE>> {
	...
	public static class BasicUpgradableProcessorContainerInfo<TILE extends TileBasicUpgradableProcessor<TILE>> extends UpgradableProcessorContainerInfo<TILE, ProcessorUpdatePacket, BasicUpgradableProcessorContainerInfo<TILE>> {
