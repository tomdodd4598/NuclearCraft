...
public class TileDistributorOutlet extends TileDistributorPart implements ITileInventory, ITileFluid, ITileEnergy {
	...
	public String getName() {
		return Global.MOD_ID + ".container.distributor_outlet";
	}
	...
	public ItemStack removeStackFromSlot(int slot) {
		ItemStack stack = ITileInventory.super.removeStackFromSlot(slot);
		if (!stack.isEmpty()) {
			Distributor multiblock = getMultiblock();
			if (multiblock != null) {
				multiblock.storageUpdated = true;
	...
	@Override
	public void onWrapperDrain(FluidStack drainStack, boolean doDrain) {
