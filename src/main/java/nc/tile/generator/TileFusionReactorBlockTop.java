...
public class TileFusionReactorBlockTop extends TileEntity implements IEnergyHandler, IEnergyConnection, IEnergyReceiver, IEnergyProvider, ISidedInventory, IGasHandler, ITubeConnection {
	...
	public TileFusionReactorBlockTop() {
		super();
    }
	...
	public void updateEntity() {
    	...
    	if (this.worldObj.getBlock(xCoord, yCoord, zCoord) == NCBlocks.fusionReactorBlockTop && (ppp(xCoord + 1, yCoord, zCoord) || ppp(xCoord - 1, yCoord, zCoord) || ppp(xCoord, yCoord + 1, zCoord) || ppp(xCoord, yCoord - 1, zCoord) || ppp(xCoord, yCoord, zCoord + 1) || ppp(xCoord, yCoord, zCoord - 1))) {
	...
	{
		if (worldObj.getBlock(x, y-2, z) == NCBlocks.fusionReactor) {xOffset=0;yOffset=-2;zOffset=0;}
		else if (worldObj.getBlock(x+1, y-2, z) == NCBlocks.fusionReactor) {xOffset=1;yOffset=-2;zOffset=0;}
		else if (worldObj.getBlock(x+1, y-2, z+1) == NCBlocks.fusionReactor) {xOffset=1;yOffset=-2;zOffset=1;}
		else if (worldObj.getBlock(x, y-2, z+1) == NCBlocks.fusionReactor) {xOffset=0;yOffset=-2;zOffset=1;}
		else if (worldObj.getBlock(x-1, y-2, z+1) == NCBlocks.fusionReactor) {xOffset=-1;yOffset=-2;zOffset=1;}
		else if (worldObj.getBlock(x-1, y-2, z) == NCBlocks.fusionReactor) {xOffset=-1;yOffset=-2;zOffset=0;}
		else if (worldObj.getBlock(x-1, y-2, z-1) == NCBlocks.fusionReactor) {xOffset=-1;yOffset=-2;zOffset=-1;}
		else if (worldObj.getBlock(x, y-2, z-1) == NCBlocks.fusionReactor) {xOffset=0;yOffset=-2;zOffset=-1;}
