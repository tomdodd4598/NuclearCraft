...
public class TileDecayPoolController extends TileMachinePart implements IMachineController<TileDecayPoolController> {
	
	protected final TileContainerInfo<TileDecayPoolController> info = TileInfoHandler.getTileContainerInfo("decay_pool_controller");
	
	protected boolean isRenderer = false;
	
	public TileDecayPoolController() {
	...
	@Override
	public TileContainerInfo<TileDecayPoolController> getContainerInfo() {
		return info;
	}
