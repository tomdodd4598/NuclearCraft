...
public class TileHeatExchangerOutlet extends TileHeatExchangerPart implements ITickable, ITileFluid {
	...
	public TileHeatExchangerOutlet() {
	...
	@Override
	public void update() {
		if (!world.isRemote && isMultiblockAssembled()) {
