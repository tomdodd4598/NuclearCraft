...
FissionSetup.FISSION_FUEL_INFOS.add(FissionFuelInfo("leabc_123", solidFuelPrefix, solidFuelSuffix, "LEABC123", 1000, 250, 1.5, 80, 10, 0.075, false, 0.0014, 0.0055));
//FissionSetup.FISSION_FUEL_INFOS.add(FissionFuelInfo("hexyz_789", solidFuelPrefix, solidFuelSuffix, liquidFuelPrefix, liquidFuelSuffix, "HEXYZ789", 0x59FF7A, 0x446FC4, 2000, 150, 1.2, 120, 10, 0.05, true, 0.00079, 0.028));
