...
mods.nuclearcraft.Registration.registerFissionCooler("extreme", "tritium", 1, "deuterium", 1, 130, "exactly one sic_sic_cmc cooler");
mods.nuclearcraft.Registration.registerFissionCooler("sic_sic_cmc", "helium_3", 1, "helium", 1, 135, "exactly one carbon_monoxide cooler && at most two fluoromethane coolers");
