...
Registration.registerFissionFuel("fission_fuel_addon_test", "hexyz_789", null, "HEXYZ789", 1000, 250, 1.5, 80, 10, 0.075, false, 0.00045, 0.00079, 0.028, true, true, true, true, true, true, 0x59FF7A, 0x446FC4);
