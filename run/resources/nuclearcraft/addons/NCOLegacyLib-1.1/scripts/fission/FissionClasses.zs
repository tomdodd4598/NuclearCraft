...
zenClass FissionFuelInfo {
	...
	var crit as int;
	var intrinsicFlux as int;
	var decay as double;
	var prime as bool;
	var fuelRad as double;
	var depletedRad as double;
	
	zenConstructor(name as string, solidPrefix as string[], solidSuffix as string[], ore as string, time as int, heat as int, efficiency as double, crit as int, intrinsicFlux as int, decay as double, prime as bool, fuelRad as double, depletedRad as double) {
		this.name = name;
